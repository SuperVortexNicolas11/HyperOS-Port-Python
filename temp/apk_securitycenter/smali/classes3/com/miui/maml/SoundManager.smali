...
.method public declared-synchronized playSound(Ljava/lang/String;Lcom/miui/maml/SoundManager$SoundOptions;)I
    ...
    .line 13
    :try_start_0
    iget-boolean v3, p0, Lcom/miui/maml/SoundManager;->mInitialized:Z
    ...
    .line 19
    iget-object v3, p0, Lcom/miui/maml/SoundManager;->mResourceManager:Lcom/miui/maml/ResourceManager;

    invoke-virtual {v3, p1}, Lcom/miui/maml/ResourceManager;->getFile(Ljava/lang/String;)Landroid/os/MemoryFile;
    ...
    const-string v1, "the sound does not exist: "
    ...
    const-string v3, "the sound file is larger than %d KB: %s"
    ...
    invoke-static {v3}, Lcom/miui/maml/util/HideSdkDependencyUtils;->MemoryFile_getFileDescriptor(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    .line 26
    iget-object v1, p0, Lcom/miui/maml/SoundManager;->mSoundPoolMap:Ljava/util/HashMap;
