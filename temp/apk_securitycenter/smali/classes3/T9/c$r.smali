...
.method constructor <init>(LT9/c;LU/x;)V
    ...
    .line 1
    iput-object p1, p0, LT9/c$r;->d:LT9/c;
...
.method public e()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `pre_download_task` SET `taskId` = ?,`gameName` = ?,`packageName` = ?,`effectiveStartTime` = ?,`effectiveEndTime` = ?,`isTest` = ?,`isTencentGame` = ?,`timeStamp` = ?,`cdnPeriods` = ?,`pkgVersion` = ?,`token` = ?,`extraInfo` = ?,`pkgList` = ?,`intervalFromTGPA` = ?,`status` = ?,`retryNum` = ?,`rank` = ? WHERE `taskId` = ?"
...
.method public bridge synthetic j(Ld0/h;Ljava/lang/Object;)V
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, LT9/c$r;->l(Ld0/h;LZ9/h;)V
