...
.method private addCell(Landroidx/slice/widget/GridContent$CellContent;II)V
    ...
    iget-object v1, v0, Landroidx/slice/widget/GridRowView;->mGridContent:Landroidx/slice/widget/GridContent;
    ...
    invoke-virtual {v8, v9}, Landroidx/slice/SliceItem;->hasAnyHints([Ljava/lang/String;)Z
    ...
    .line 433
    invoke-direct {v0, v3}, Landroidx/slice/widget/GridRowView;->determinePadding(Landroidx/slice/SliceItem;)I
    ...
    .line 439
    :cond_a
    invoke-direct {v0, v5, v4, v11}, Landroidx/slice/widget/GridRowView;->addTextItem(Landroidx/slice/SliceItem;Landroid/view/ViewGroup;I)Z
    ...
    invoke-virtual {v13}, Landroidx/slice/SliceItem;->getSubType()Ljava/lang/String;
    ...
    .line 455
    invoke-direct {v0, v9}, Landroidx/slice/widget/GridRowView;->determinePadding(Landroidx/slice/SliceItem;)I

    move-result v1

    const/4 v2, 0x1

    invoke-direct {v0, v13, v4, v1, v2}, Landroidx/slice/widget/GridRowView;->addPickerItem(Landroidx/slice/SliceItem;Landroid/view/ViewGroup;IZ)Z
    ...
    invoke-direct {v1, v2, v3, v5}, Landroidx/slice/widget/SliceActionView;-><init>(Landroid/content/Context;Landroidx/slice/widget/SliceStyle;Landroidx/slice/widget/RowStyle;)V
    ...
    invoke-direct {v2, v8, v3, v5}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
    ...
    .line 479
    iget v2, v0, Landroidx/slice/widget/GridRowView;->mGutter:I
    ...
    iget v3, v0, Landroidx/slice/widget/GridRowView;->mRowIndex:I

    const/4 v5, 0x1

    invoke-direct {v1, v2, v5, v5, v3}, Landroidx/slice/widget/EventInfo;-><init>(IIII)V

    const/4 v2, 0x2

    .line 485
    invoke-virtual {v1, v2, v6, v7}, Landroidx/slice/widget/EventInfo;->setPosition(III)V
    ...
    .line 488
    invoke-direct {v0, v4, v5}, Landroidx/slice/widget/GridRowView;->makeClickable(Landroid/view/View;Z)V
    ...
    invoke-direct {v1, v2, v8, v3, v4}, Landroidx/slice/widget/EventInfo;-><init>(IIII)V

    .line 493
    new-instance v2, Landroidx/slice/core/SliceActionImpl;

    invoke-direct {v2, v14}, Landroidx/slice/core/SliceActionImpl;-><init>(Landroidx/slice/SliceItem;)V

    iget-object v3, v0, Landroidx/slice/widget/SliceChildView;->mObserver:Landroidx/slice/widget/SliceView$OnSliceActionListener;

    iget v4, v0, Landroidx/slice/widget/SliceChildView;->mTintColor:I
    ...
    invoke-virtual/range {v18 .. v23}, Landroidx/slice/widget/SliceActionView;->setAction(Landroidx/slice/core/SliceActionImpl;Landroidx/slice/widget/EventInfo;Landroidx/slice/widget/SliceView$OnSliceActionListener;ILandroidx/slice/widget/SliceActionView$SliceActionLoadingListener;)V
    ...
    .line 496
    invoke-virtual {v0, v2, v6, v7}, Landroidx/slice/widget/EventInfo;->setPosition(III)V
...
.method private addPickerItem(Landroidx/slice/SliceItem;Landroid/view/ViewGroup;IZ)Z
    ...
    invoke-static {p1, v2, v3, v7}, Landroidx/slice/core/SliceQuery;->find(Landroidx/slice/SliceItem;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroidx/slice/SliceItem;
    ...
    .line 636
    new-instance v0, Landroidx/slice/widget/GridRowView$1;
    ...
    .line 670
    invoke-virtual {v8, v6, p3, v6, v6}, Landroid/widget/TextView;->setPadding(IIII)V
