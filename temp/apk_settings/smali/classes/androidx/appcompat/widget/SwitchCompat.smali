...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 258
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_android_thumb:I

    invoke-virtual {v3, p0}, Landroidx/appcompat/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    .line 262
    :cond_0
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_track:I

    invoke-virtual {v3, p0}, Landroidx/appcompat/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    .line 266
    :cond_1
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_android_textOn:I

    invoke-virtual {v3, p0}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 267
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_android_textOff:I
    ...
    .line 268
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_showText:I

    invoke-virtual {v3, p0, v2}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mShowText:Z

    .line 269
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v3, p0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbTextPadding:I

    .line 271
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_switchMinWidth:I

    invoke-virtual {v3, p0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mSwitchMinWidth:I

    .line 273
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_switchPadding:I

    invoke-virtual {v3, p0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mSwitchPadding:I

    .line 275
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_splitTrack:I

    invoke-virtual {v3, p0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mSplitTrack:Z

    .line 277
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTint:I

    invoke-virtual {v3, p0}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    .line 279
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintList:Landroid/content/res/ColorStateList;
    ...
    .line 282
    :cond_2
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTintMode:I

    const/4 p1, -0x1

    .line 283
    invoke-virtual {v3, p0, p1}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I

    move-result p0

    .line 282
    invoke-static {p0, v0}, Landroidx/appcompat/widget/DrawableUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p0

    .line 284
    iget-object p2, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;

    if-eq p2, p0, :cond_3

    .line 285
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 288
    :cond_3
    iget-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTint:Z

    if-nez p0, :cond_4

    iget-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z

    if-eqz p0, :cond_5

    .line 289
    :cond_4
    invoke-direct {v5}, Landroidx/appcompat/widget/SwitchCompat;->applyThumbTint()V

    .line 292
    :cond_5
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_trackTint:I
    ...
    .line 294
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintList:Landroid/content/res/ColorStateList;
    ...
    .line 297
    :cond_6
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_trackTintMode:I
    ...
    .line 299
    iget-object p1, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;

    if-eq p1, p0, :cond_7

    .line 300
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 303
    :cond_7
    iget-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTint:Z

    if-nez p0, :cond_8

    iget-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTintMode:Z

    if-eqz p0, :cond_9

    .line 304
    :cond_8
    invoke-direct {v5}, Landroidx/appcompat/widget/SwitchCompat;->applyTrackTint()V

    .line 307
    :cond_9
    sget p0, Landroidx/appcompat/R$styleable;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v3, p0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I
    ...
    .line 310
    invoke-virtual {v5, v6, p0}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/AppCompatTextHelper;
