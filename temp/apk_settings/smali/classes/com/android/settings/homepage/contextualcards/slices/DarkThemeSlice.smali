...
# direct methods
.method public static synthetic $r8$lambda$jn_6bgk0I8G6X7lXTMjWn5GRsuc(Lcom/android/settings/homepage/contextualcards/slices/DarkThemeSlice;Z)V
    .locals 0
...
.method public getSlice()Landroidx/slice/Slice;
    ...
    .line 103
    :cond_3
    sput-boolean v4, Lcom/android/settings/homepage/contextualcards/slices/DarkThemeSlice;->sKeepSliceShow:Z
    ...
    invoke-direct {v7, v8, v9, v1, v2}, Landroidx/slice/builders/ListBuilder;-><init>(Landroid/content/Context;Landroid/net/Uri;J)V

    .line 116
    invoke-virtual {v7, v4}, Landroidx/slice/builders/ListBuilder;->setAccentColor(I)Landroidx/slice/builders/ListBuilder;
    ...
    sget v7, Lcom/android/settings/R$string;->dark_theme_slice_title:I
    ...
    invoke-virtual {v2, v4}, Landroidx/slice/builders/ListBuilder$RowBuilder;->setTitle(Ljava/lang/CharSequence;)Landroidx/slice/builders/ListBuilder$RowBuilder;

    move-result-object v2

    .line 119
    invoke-virtual {v2, v5, v3}, Landroidx/slice/builders/ListBuilder$RowBuilder;->setTitleItem(Landroidx/core/graphics/drawable/IconCompat;I)Landroidx/slice/builders/ListBuilder$RowBuilder;

    move-result-object v2

    iget-object p0, p0, Lcom/android/settings/homepage/contextualcards/slices/DarkThemeSlice;->mContext:Landroid/content/Context;

    sget v3, Lcom/android/settings/R$string;->dark_theme_slice_subtitle:I
    ...
    .line 122
    invoke-static {v0, v2, v6}, Landroidx/slice/builders/SliceAction;->createToggle(Landroid/app/PendingIntent;Ljava/lang/CharSequence;Z)Landroidx/slice/builders/SliceAction;
    ...
    sget-object v3, Lcom/android/settings/slices/CustomSliceRegistry;->DARK_THEME_SLICE_URI:Landroid/net/Uri;

    invoke-direct {v0, p0, v3, v1, v2}, Landroidx/slice/builders/ListBuilder;-><init>(Landroid/content/Context;Landroid/net/Uri;J)V

    .line 100
    invoke-virtual {v0, v4}, Landroidx/slice/builders/ListBuilder;->setIsError(Z)Landroidx/slice/builders/ListBuilder;
