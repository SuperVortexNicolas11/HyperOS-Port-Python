...
.field public static final IS_APP_OPTIMIZATION_MODE_MUTABLE_FIELD_NUMBER:I = 0x13
...
.field private isAppOptimizationModeMutable_:Z
...
# direct methods
.method static bridge synthetic -$$Nest$msetAppOptimizationMode(Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;Lcom/android/settings/fuelgauge/batteryusage/BatteryOptimizationMode;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->setAppOptimizationMode(Lcom/android/settings/fuelgauge/batteryusage/BatteryOptimizationMode;)V
...
.method static bridge synthetic -$$Nest$msetForegroundServiceUsageTime(Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;J)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->setForegroundServiceUsageTime(J)V
...
.method static bridge synthetic -$$Nest$msetIsAppOptimizationModeMutable(Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;Z)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->setIsAppOptimizationModeMutable(Z)V
...
.method private setAppOptimizationMode(Lcom/android/settings/fuelgauge/batteryusage/BatteryOptimizationMode;)V
    .locals 1

    .line 685
    invoke-virtual {p1}, Lcom/android/settings/fuelgauge/batteryusage/BatteryOptimizationMode;->getNumber()I

    move-result p1

    iput p1, p0, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->appOptimizationMode_:I

    .line 686
    iget p1, p0, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->bitField0_:I

    const/high16 v0, 0x20000

    or-int/2addr p1, v0

    iput p1, p0, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->bitField0_:I
...
.method private setForegroundServiceUsageTime(J)V
    .locals 2
...
.method private setIsAppOptimizationModeMutable(Z)V
    .locals 2
    ...
    .line 720
    iput-boolean p1, p0, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff;->isAppOptimizationModeMutable_:Z
...
.method protected final dynamicMethod(Lcom/google/protobuf/GeneratedMessageLite$MethodToInvoke;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "isHidden_"

    const-string v9, "componentId_"

    const-string v10, "consumerType_"

    const-string v11, "consumePower_"

    const-string v12, "foregroundUsageConsumePower_"

    const-string v13, "backgroundUsageConsumePower_"

    const-string v14, "foregroundServiceUsageConsumePower_"

    const-string v15, "cachedUsageConsumePower_"

    const-string v16, "foregroundUsageTime_"

    const-string v17, "backgroundUsageTime_"

    const-string v18, "screenOnTime_"

    const-string v19, "foregroundServiceUsageTime_"

    const-string v20, "appOptimizationMode_"

    .line 1607
    invoke-static {}, Lcom/android/settings/fuelgauge/batteryusage/BatteryOptimizationMode;->internalGetVerifier()Lcom/google/protobuf/Internal$EnumVerifier;

    move-result-object v21

    const-string v22, "isAppOptimizationModeMutable_"
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff$Builder;-><init>(Lcom/android/settings/fuelgauge/batteryusage/BatteryUsageDiff-IA;)V
...
.method public getForegroundServiceUsageTime()J
    .locals 2
