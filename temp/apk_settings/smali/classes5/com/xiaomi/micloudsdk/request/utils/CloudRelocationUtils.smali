...
.method public static checkRedirect(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v2, p1}, Lcom/xiaomi/micloudsdk/exception/CloudServerException;-><init>(III)V
    ...
    invoke-direct {v0, v3, v3, p1}, Lcom/xiaomi/micloudsdk/exception/CloudServerException;-><init>(III)V
    ...
    invoke-direct {p0, v3, v2, p1}, Lcom/xiaomi/micloudsdk/exception/CloudServerException;-><init>(III)V
...
.method private static updateMiCloudHosts(Z)V
    ...
    invoke-interface {v2}, Lcom/xiaomi/micloudsdk/request/utils/RequestContext$RequestEnv;->getAccountName()Ljava/lang/String;
    ...
    :cond_7
    :try_start_7
    sget-object v3, Lcom/xiaomi/micloudsdk/request/utils/CloudRelocationUtils;->URL_RELOCATION_QUERY:Ljava/lang/String;

    .line 234
    invoke-static {v3, v0}, Lcom/xiaomi/micloudsdk/request/utils/Request;->securePost(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    .line 242
    invoke-static {v3}, Lcom/xiaomi/micloudsdk/utils/JsonUtils;->jsonToMap(Lorg/json/JSONObject;)Ljava/util/Map;

    move-result-object v3

    invoke-static {v3}, Lcom/xiaomi/micloudsdk/request/utils/CloudRelocationUtils;->updateHostCache(Ljava/util/Map;)V
    ...
    invoke-static {v3, v2}, Lmicloud/compat/independent/utils/RelocationCacheCompat;->cacheXiaomiAccountName(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_7
    .catch Lorg/json/JSONException; {:try_start_7 .. :try_end_7} :catch_5
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_7 .. :try_end_7} :catch_4
    .catch Ljavax/crypto/BadPaddingException; {:try_start_7 .. :try_end_7} :catch_3
...
.method public static updateRequestHost(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 320
    invoke-static {v2}, Lcom/xiaomi/micloudsdk/request/utils/CloudRelocationUtils;->getHostWithScheme(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, v4, v3, p1}, Ljava/net/URL;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, p1}, Lmiui/cloud/common/XLogger;->error(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
