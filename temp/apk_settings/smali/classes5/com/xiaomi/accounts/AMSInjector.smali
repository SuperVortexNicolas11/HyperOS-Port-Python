.class Lcom/xiaomi/accounts/AMSInjector;
...
.method static checkOpenDatabaseErrorThrowIfDebug(Landroid/content/Context;Ljava/io/File;Lcom/xiaomi/accounts/AccountManagerService$DatabaseHelper;)V
    .locals 3
    ...
    .line 45
    const-string v1, "open database failed, maybe corrupted, keystore changed or wrong password"

    const-string v2, "SQLCipherManager"

    invoke-static {v2, v1}, Lcom/xiaomi/accountsdk/utils/AccountLog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 46
    invoke-virtual {p2}, Lcom/xiaomi/accounts/AccountManagerService$DatabaseHelper;->close()V
...
.method static loadSQLCipherLibsOnlyOnce(Landroid/content/Context;)V
    .locals 2
...
.method static migrateToEncryptedDatabase(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Z
    .locals 2
