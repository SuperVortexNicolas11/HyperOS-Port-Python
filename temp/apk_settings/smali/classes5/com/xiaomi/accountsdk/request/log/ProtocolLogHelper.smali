...
# static fields
.field private static final HELPER_CLASS_NAME:Ljava/lang/String; = "com.xiaomi.accountsdk.request.log.ProtocolLogHelper"
...
.method static synthetic access$000(Ljava/lang/String;Ljava/util/Set;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$100(Ljava/util/Map;Ljava/util/Set;)Ljava/util/Map;
    .locals 0
...
.method static synthetic access$300(Ljava/lang/String;Ljava/util/Set;)Ljava/lang/String;
    .locals 0
...
.method private static cloneJSONStringAndMaskKeysIfNotNull(Ljava/lang/String;Ljava/util/Set;)Ljava/lang/String;
    .locals 6
    ...
    const-string v1, "analysis json failed. EMPTY JSON. "
    ...
    sget-object v1, Lcom/xiaomi/accountsdk/request/log/ProtocolLogHelper;->HELPER_CLASS_NAME:Ljava/lang/String;

    const-string v2, "analysis json failed. "

    filled-new-array {v2, p1}, [Ljava/lang/Object;

    move-result-object p1

    invoke-virtual {v0, v1, p1}, Lcom/xiaomi/accountsdk/request/log/NetworkRequestLogger;->print(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static cloneMapAndMaskKeysIfNotNull(Ljava/util/Map;Ljava/util/Set;)Ljava/util/Map;
    .locals 2
...
.method private static cloneStringAndMaskHalfContentIfNotNull(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
...
.method private static cloneUrlAndMaskKeysIfNotNull(Ljava/lang/String;Ljava/util/Set;)Ljava/lang/String;
    .locals 4
    ...
    const-string v1, "can not analysis opaque uri. "
...
.method private static removeSafePrefixIfNotNull(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
