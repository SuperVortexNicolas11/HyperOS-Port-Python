...
.method public reset(J)V
    ...
    .line 289
    iget-boolean v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mDisable:Z
    ...
    .line 292
    :cond_0
    iget-object v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mAttrs:[Ljava/lang/String;
    ...
    .line 294
    iget-object v3, p0, Lcom/miui/maml/animation/BaseAnimation;->mCurValues:[D

    invoke-virtual {p0, v2}, Lcom/miui/maml/animation/BaseAnimation;->getDelayValue(I)D
    ...
    .line 297
    :cond_1
    iget-boolean v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mInitPaused:Z
    ...
    .line 302
    :goto_1
    iget-boolean v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mHasName:Z

    if-eqz v1, :cond_3

    .line 303
    iget-object v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mCurrentFrame:Lcom/miui/maml/data/IndexedVariable;
    ...
    invoke-virtual {p0, v1}, Lcom/miui/maml/animation/BaseAnimation;->onAction(Ljava/lang/String;)V
...
.method public final tick(J)V
    ...
    .line 339
    iget-boolean v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsPaused:Z
    ...
    .line 343
    :cond_0
    iget-wide v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mResetTime:J
    ...
    .line 345
    iget-boolean v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsFirstFrame:Z

    if-eqz v1, :cond_1

    .line 346
    iput-boolean v6, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsFirstFrame:Z
    ...
    .line 349
    invoke-virtual {p0, v7, v7, v1}, Lcom/miui/maml/animation/BaseAnimation;->onTick(Lcom/miui/maml/animation/BaseAnimation$AnimationItem;Lcom/miui/maml/animation/BaseAnimation$AnimationItem;F)V
    ...
    :cond_2
    :goto_0
    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsFirstReset:Z

    if-nez v5, :cond_3

    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsLastFrame:Z

    if-eqz v5, :cond_4

    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsTimeInfinite:Z

    if-nez v5, :cond_4

    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mLoop:Z

    if-eqz v5, :cond_4

    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsLoop:Z
    ...
    .line 360
    iput-boolean v8, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsPaused:Z

    .line 361
    iget-wide v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mResetTime:J

    iget-wide v3, p0, Lcom/miui/maml/animation/BaseAnimation;->mPlayTimeRange:J

    add-long/2addr v1, v3

    iput-wide v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mPauseTime:J
    ...
    iget-wide v2, p0, Lcom/miui/maml/animation/BaseAnimation;->mEndTime:J
    ...
    .line 369
    :cond_7
    iget-wide v9, p0, Lcom/miui/maml/animation/BaseAnimation;->mPlayTimeRange:J
    ...
    iput-wide v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mResetTime:J

    .line 372
    iput-boolean v8, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsLastFrame:Z

    move-wide v1, v9

    .line 375
    :cond_8
    iget-boolean v5, p0, Lcom/miui/maml/animation/BaseAnimation;->mIsReverse:Z

    if-eqz v5, :cond_9

    .line 376
    iget-wide v9, p0, Lcom/miui/maml/animation/BaseAnimation;->mAnimStartTime:J
    ...
    .line 381
    :goto_1
    iget-wide v1, p0, Lcom/miui/maml/animation/BaseAnimation;->mRealTimeRange:J
    ...
    iget-wide v3, v7, Lcom/miui/maml/animation/BaseAnimation$AnimationItem;->mTime:J
    ...
    invoke-virtual {p0, v7, v11, v2}, Lcom/miui/maml/animation/BaseAnimation;->onTick(Lcom/miui/maml/animation/BaseAnimation$AnimationItem;Lcom/miui/maml/animation/BaseAnimation$AnimationItem;F)V
    ...
    .line 400
    invoke-virtual {p0, v7, v2, v1}, Lcom/miui/maml/animation/BaseAnimation;->onTick(Lcom/miui/maml/animation/BaseAnimation$AnimationItem;Lcom/miui/maml/animation/BaseAnimation$AnimationItem;F)V
