...
.method private getNeed2BeInstalledSplits(Ljava/util/List;)Ljava/util/List;
    ...
    .line 318
    invoke-interface {v2}, Ljava/util/Set;->toString()Ljava/lang/String;
...
.method private startDownloadSplits(Ljava/util/List;Ljava/util/List;Lcom/iqiyi/android/qigsaw/core/splitinstall/remote/SplitInstallSupervisor$Callback;)V
    ...
    .line 359
    :cond_0
    invoke-static {v2}, Lcom/iqiyi/android/qigsaw/core/splitinstall/remote/SplitInstallSupervisor;->createSessionId(Ljava/util/Collection;)I
    ...
    .line 362
    :cond_1
    iget-object v8, v0, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSupervisorImpl;->sessionManager:Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;

    invoke-interface {v8, v1}, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;->isIncompatibleWithExistingSession(Ljava/util/List;)Z
    ...
    const-string v9, "startInstall session id: "
    ...
    invoke-static {v5, v8, v9}, Lcom/iqiyi/android/qigsaw/core/common/SplitLog;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v7, v4, v1, v2, v8}, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallInternalSessionState;-><init>(ILjava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 378
    invoke-interface {v3, v4, v10}, Lcom/iqiyi/android/qigsaw/core/splitinstall/remote/SplitInstallSupervisor$Callback;->onStartInstall(ILandroid/os/Bundle;)V

    .line 379
    iget-object v10, v0, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSupervisorImpl;->sessionManager:Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;

    invoke-interface {v10, v4, v7}, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;->setSessionState(ILcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallInternalSessionState;)V

    .line 381
    aget-wide v10, v9, v6

    .line 382
    iget-object v12, v0, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSupervisorImpl;->userDownloader:Lcom/iqiyi/android/qigsaw/core/splitdownload/Downloader;

    const/4 v13, 0x1

    aget-wide v14, v9, v13

    invoke-interface {v12, v8, v14, v15}, Lcom/iqiyi/android/qigsaw/core/splitdownload/Downloader;->calculateDownloadSize(Ljava/util/List;J)J

    move-result-wide v14

    .line 383
    const-string v9, "totalBytesToDownload: %d, realTotalBytesNeedToDownload: %d "
    ...
    invoke-static {v5, v9, v12}, Lcom/iqiyi/android/qigsaw/core/common/SplitLog;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 384
    invoke-virtual {v7, v10, v11}, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallInternalSessionState;->setTotalBytesToDownload(J)V

    .line 385
    new-instance v9, Lcom/iqiyi/android/qigsaw/core/splitinstall/StartDownloadCallback;

    iget-object v10, v0, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSupervisorImpl;->splitInstaller:Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstaller;
    ...
    invoke-direct {v9, v10, v4, v11, v2}, Lcom/iqiyi/android/qigsaw/core/splitinstall/StartDownloadCallback;-><init>(Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstaller;ILcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;Ljava/util/List;)V
    ...
    .line 388
    invoke-virtual {v9}, Lcom/iqiyi/android/qigsaw/core/splitinstall/StartDownloadCallback;->onCompleted()V
    ...
    invoke-interface {v2, v4, v10}, Lcom/iqiyi/android/qigsaw/core/splitinstall/SplitInstallSessionManager;->changeSessionState(II)V
    ...
    invoke-interface {v0, v4, v8, v9}, Lcom/iqiyi/android/qigsaw/core/splitdownload/Downloader;->startDownload(ILjava/util/List;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
