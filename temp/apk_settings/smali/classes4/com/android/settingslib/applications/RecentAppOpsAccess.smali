...
.method private getAccessFromOps(JLandroid/app/AppOpsManager$PackageOps;)Lcom/android/settingslib/applications/RecentAppOpsAccess$Access;
    ...
    invoke-virtual {p3, v2, v1, p1}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    .line 268
    :goto_1
    new-instance v1, Lcom/android/settingslib/applications/RecentAppOpsAccess$Access;
...
.method public getAppList(Z)Ljava/util/List;
    ...
    invoke-virtual {v2, v1, v12, v14}, Landroid/content/pm/PackageManager;->getPermissionFlags(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)I
    ...
    invoke-static {v3, v1, v7, v13, v12}, Landroid/content/PermissionChecker;->checkPermissionForPreflight(Landroid/content/Context;Ljava/lang/String;IILjava/lang/String;)I
