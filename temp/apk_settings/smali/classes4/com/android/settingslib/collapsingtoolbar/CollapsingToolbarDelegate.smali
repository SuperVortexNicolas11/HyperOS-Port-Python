...
# instance fields
.field private mActionButton:Lcom/google/android/material/button/MaterialButton;
...
.field private mIsExpressiveTheme:Z
...
.method public constructor <init>(Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate$HostCallback;)V
    ...
    .line 97
    invoke-direct {p0, p1, v0}, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;-><init>(Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate$HostCallback;Z)V
...
.method private initSupportActionBar(Landroid/view/LayoutInflater;)V
    ...
    .line 199
    iget-boolean p0, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mIsExpressiveTheme:Z

    if-eqz p0, :cond_1

    .line 200
    sget p0, Lcom/android/settingslib/collapsingtoolbar/R$drawable;->settingslib_expressive_icon_back:I

    invoke-virtual {p1, p0}, Landroidx/appcompat/app/ActionBar;->setHomeAsUpIndicator(I)V
...
.method onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/app/Activity;)Landroid/view/View;
    ...
    .line 117
    iget-boolean v0, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mUseCollapsingToolbar:Z
    ...
    iput-boolean v3, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mIsExpressiveTheme:Z
    ...
    .line 123
    sget v3, Lcom/android/settingslib/collapsingtoolbar/R$layout;->settingslib_expressive_collapsing_toolbar_base_layout:I

    goto :goto_1

    .line 124
    :cond_1
    sget v3, Lcom/android/settingslib/collapsingtoolbar/R$layout;->collapsing_toolbar_base_layout:I

    goto :goto_1

    .line 126
    :cond_2
    sget v3, Lcom/android/settingslib/collapsingtoolbar/R$layout;->non_collapsing_toolbar_base_layout:I
    ...
    iput-object v4, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mCoordinatorLayout:Landroidx/coordinatorlayout/widget/CoordinatorLayout;

    .line 133
    :cond_3
    sget v4, Lcom/android/settingslib/collapsingtoolbar/R$id;->collapsing_toolbar:I
    ...
    iput-object v4, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mCollapsingToolbarLayout:Lcom/google/android/material/appbar/CollapsingToolbarLayout;

    .line 134
    sget v4, Lcom/android/settingslib/collapsingtoolbar/R$id;->app_bar:I
    ...
    iput-object v4, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mAppBarLayout:Lcom/google/android/material/appbar/AppBarLayout;
    ...
    .line 161
    sget p2, Lcom/android/settingslib/collapsingtoolbar/R$id;->action_button:I
    ...
    iput-object p2, p0, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate;->mActionButton:Lcom/google/android/material/button/MaterialButton;

    .line 162
    instance-of p2, p3, Landroidx/appcompat/app/AppCompatActivity;
    ...
    invoke-interface {p2, p1}, Lcom/android/settingslib/collapsingtoolbar/CollapsingToolbarDelegate$HostCallback;->setActionBar(Landroid/widget/Toolbar;)Landroid/app/ActionBar;
