...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt;->permissionsChangedFlow(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)Lkotlinx/coroutines/flow/Flow;
.end annotation
...
# direct methods
.method public static synthetic $r8$lambda$G0OnUqdCniOKvHYtO8U5EDLjceg(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0, p1}, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1;->invokeSuspend$lambda$0(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)Lkotlin/Unit;
...
.method constructor <init>(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final invokeSuspend$lambda$0(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)Lkotlin/Unit;
    .locals 0

    .line 44
    invoke-virtual {p0, p1}, Landroid/content/pm/PackageManager;->removeOnPermissionsChangeListener(Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1;->invoke(Lkotlinx/coroutines/channels/ProducerScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1;->$app:Landroid/content/pm/ApplicationInfo;

    invoke-static {v3}, Lcom/android/settingslib/spaprivileged/model/app/ApplicationInfosKt;->getUserHandle(Landroid/content/pm/ApplicationInfo;)Landroid/os/UserHandle;

    move-result-object v3

    invoke-static {v1, v3}, Lcom/android/settingslib/spaprivileged/framework/common/ContextsKt;->asUser(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    .line 37
    new-instance v3, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1$onPermissionsChangedListener$1;
    ...
    invoke-direct {v3, v4, p1}, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1$onPermissionsChangedListener$1;-><init>(Landroid/content/pm/ApplicationInfo;Lkotlinx/coroutines/channels/ProducerScope;)V
    ...
    .line 43
    new-instance v4, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1$$ExternalSyntheticLambda0;

    invoke-direct {v4, v1, v3}, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1$$ExternalSyntheticLambda0;-><init>(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)V

    iput v2, p0, Lcom/android/settingslib/spaprivileged/model/app/PermissionsChangedFlowKt$permissionsChangedFlow$1;->label:I
