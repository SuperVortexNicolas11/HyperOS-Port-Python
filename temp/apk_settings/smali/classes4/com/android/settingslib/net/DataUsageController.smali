...
.method private getUsageLevel(Landroid/net/NetworkTemplate;JJ)J
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/settingslib/net/DataUsageController;->mNetworkStatsManager:Landroid/app/usage/NetworkStatsManager;
...
.method public getDataUsageInfo(Landroid/net/NetworkTemplate;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    .line 113
    const-string p0, "no entry data"

    invoke-direct {v5, p0}, Lcom/android/settingslib/net/DataUsageController;->warn(Ljava/lang/String;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    .line 115
    :cond_2
    new-instance v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;

    invoke-direct {v1}, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;-><init>()V

    .line 116
    iput-wide v2, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->startDate:J

    .line 117
    iput-wide p0, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->usageLevel:J

    .line 118
    invoke-direct {v5, v2, v3, v6, v7}, Lcom/android/settingslib/net/DataUsageController;->formatDateRange(JJ)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->period:Ljava/lang/String;

    .line 119
    iput-wide v2, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->cycleStart:J

    .line 120
    iput-wide v6, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->cycleEnd:J
    ...
    :goto_2
    iput-wide p0, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->limitLevel:J

    .line 124
    iget-wide p0, v0, Landroid/net/NetworkPolicy;->warningBytes:J
    ...
    :cond_4
    iput-wide v8, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J

    goto :goto_3

    .line 126
    :cond_5
    invoke-virtual {v5}, Lcom/android/settingslib/net/DataUsageController;->getDefaultWarningLevel()J

    move-result-wide p0

    iput-wide p0, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J
...
.method public getDefaultWarningLevel()J
    ...
    const v0, 0x10e0186    # @android:integer/lock_pattern_line_fade_out_duration
