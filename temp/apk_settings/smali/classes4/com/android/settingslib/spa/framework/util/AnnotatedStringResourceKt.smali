...
.method private static final addStyleSpan(Landroidx/compose/ui/text/AnnotatedString$Builder;Landroid/text/style/StyleSpan;II)V
    ...
    .line 86
    invoke-virtual {v0, v5, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V
    ...
    .line 80
    invoke-virtual {v0, v6, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V
    ...
    .line 74
    invoke-virtual {v0, v7, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V
    ...
    .line 68
    invoke-virtual {v0, v8, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V
...
.method private static final addUrlSpan-XO-JAsU(Landroidx/compose/ui/text/AnnotatedString$Builder;Landroid/text/style/URLSpan;JII)V
    ...
    .line 102
    new-instance v2, Landroidx/compose/ui/text/TextLinkStyles;
    ...
    .line 102
    invoke-direct/range {v2 .. v8}, Landroidx/compose/ui/text/TextLinkStyles;-><init>(Landroidx/compose/ui/text/SpanStyle;Landroidx/compose/ui/text/SpanStyle;Landroidx/compose/ui/text/SpanStyle;Landroidx/compose/ui/text/SpanStyle;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 100
    invoke-direct/range {v0 .. v5}, Landroidx/compose/ui/text/LinkAnnotation$Url;-><init>(Ljava/lang/String;Landroidx/compose/ui/text/TextLinkStyles;Landroidx/compose/ui/text/LinkInteractionListener;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 106
    invoke-virtual {v0, v3, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addLink(Landroidx/compose/ui/text/LinkAnnotation$Url;II)V
...
.method public static final annotatedStringResource(ILandroidx/compose/runtime/Composer;I)Landroidx/compose/ui/text/AnnotatedString;
    ...
    .line 44
    invoke-static {p0, v1, v2}, Lcom/android/settingslib/spa/framework/util/AnnotatedStringResourceKt;->spannableStringToAnnotatedString-4WTKRHQ(Ljava/lang/CharSequence;J)Landroidx/compose/ui/text/AnnotatedString;
...
.method private static final spannableStringToAnnotatedString-4WTKRHQ(Ljava/lang/CharSequence;J)Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-direct {v3, v4, v1, v2}, Landroidx/compose/ui/text/AnnotatedString$Builder;-><init>(IILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 56
    instance-of v4, v2, Landroid/text/style/StyleSpan;

    if-eqz v4, :cond_0

    check-cast v2, Landroid/text/style/StyleSpan;

    invoke-static {v3, v2, v7, v8}, Lcom/android/settingslib/spa/framework/util/AnnotatedStringResourceKt;->addStyleSpan(Landroidx/compose/ui/text/AnnotatedString$Builder;Landroid/text/style/StyleSpan;II)V
    ...
    invoke-static/range {v3 .. v8}, Lcom/android/settingslib/spa/framework/util/AnnotatedStringResourceKt;->addUrlSpan-XO-JAsU(Landroidx/compose/ui/text/AnnotatedString$Builder;Landroid/text/style/URLSpan;JII)V
    ...
    invoke-virtual {v3, v9, v7, v8}, Landroidx/compose/ui/text/AnnotatedString$Builder;->addStyle(Landroidx/compose/ui/text/SpanStyle;II)V
