...
.method public createAnimation(Landroid/view/View;JJFZLandroid/view/animation/Interpolator;Ljava/lang/Runnable;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    .line 199
    new-instance p6, Landroid/view/RenderNodeAnimator;

    const/16 p7, 0xb

    invoke-direct {p6, p7, v3}, Landroid/view/RenderNodeAnimator;-><init>(IF)V

    .line 201
    invoke-virtual {p6, p1}, Landroid/view/RenderNodeAnimator;->setTarget(Landroid/view/View;)V
    ...
    .line 206
    :goto_2
    invoke-virtual {p6, p8}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    .line 207
    invoke-virtual {p6, p4, p5}, Landroid/animation/Animator;->setDuration(J)Landroid/animation/Animator;

    .line 208
    invoke-virtual {p6, p2, p3}, Landroid/animation/Animator;->setStartDelay(J)V
    ...
    .line 210
    invoke-virtual {p1, v0, p7}, Landroid/view/View;->setLayerType(ILandroid/graphics/Paint;)V

    .line 211
    new-instance p7, Lcom/android/settingslib/animation/AppearAnimationUtils$1;

    invoke-direct {p7, p0, p1}, Lcom/android/settingslib/animation/AppearAnimationUtils$1;-><init>(Lcom/android/settingslib/animation/AppearAnimationUtils;Landroid/view/View;)V

    invoke-virtual {p6, p7}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 218
    :cond_3
    new-instance p7, Lcom/android/settingslib/animation/AppearAnimationUtils$2;

    invoke-direct {p7, p0, p1, v3, p9}, Lcom/android/settingslib/animation/AppearAnimationUtils$2;-><init>(Lcom/android/settingslib/animation/AppearAnimationUtils;Landroid/view/View;FLjava/lang/Runnable;)V
