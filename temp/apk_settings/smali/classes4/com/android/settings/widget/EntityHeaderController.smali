...
.method private bindButton(Landroid/widget/ImageButton;I)V
    ...
    :cond_2
    const p2, 0x1080599    # @android:drawable/ic_signal_cellular_0_4_bar
...
.method public doneWithoutCardStyle(Landroid/content/Context;)Lcom/android/settingslib/widget/LayoutPreference;
    .locals 2

    .line 232
    new-instance v0, Lcom/android/settings/widget/LayoutWithoutCardStylePreference;

    invoke-virtual {p0}, Lcom/android/settings/widget/EntityHeaderController;->done()Landroid/view/View;

    move-result-object v1

    invoke-direct {v0, p1, v1}, Lcom/android/settings/widget/LayoutWithoutCardStylePreference;-><init>(Landroid/content/Context;Landroid/view/View;)V
