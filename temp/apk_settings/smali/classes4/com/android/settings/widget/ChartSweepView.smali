...
# direct methods
.method static bridge synthetic -$$Nest$mdispatchRequestEdit(Lcom/android/settings/widget/ChartSweepView;)V
    .locals 0
...
.method private buildClampRect(Landroid/graphics/Rect;JJF)Landroid/graphics/Rect;
    ...
    instance-of v1, v0, Lcom/android/settings/widget/InvertedChartAxis;
    ...
    invoke-interface {v1, v3, v4}, Lcom/android/settings/widget/ChartAxis;->convertToPoint(J)F
...
.method private computeClampRect(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 596
    invoke-direct {v0}, Lcom/android/settings/widget/ChartSweepView;->getValidAfterDynamic()J

    move-result-wide v2

    invoke-direct {v0}, Lcom/android/settings/widget/ChartSweepView;->getValidBeforeDynamic()J

    move-result-wide v4

    iget v6, v0, Lcom/android/settings/widget/ChartSweepView;->mNeighborMargin:F
...
.method public invalidateLabelOffset()V
    ...
    iget v1, p0, Lcom/android/settings/widget/ChartSweepView;->mLabelMinSize:I
    ...
    .line 325
    iput v2, p0, Lcom/android/settings/widget/ChartSweepView;->mLabelOffset:F
