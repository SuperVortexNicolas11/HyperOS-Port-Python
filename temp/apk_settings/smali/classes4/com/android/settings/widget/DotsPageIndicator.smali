...
.method private createMoveSelectedAnimator(FIII)Landroid/animation/ValueAnimator;
    ...
    .line 598
    new-instance v1, Lcom/android/settings/widget/DotsPageIndicator$PendingRetreatAnimator;
    ...
    invoke-direct {v3, p0, p1}, Lcom/android/settings/widget/DotsPageIndicator$RightwardStartPredicate;-><init>(Lcom/android/settings/widget/DotsPageIndicator;F)V
    ...
    invoke-direct {v3, p0, p1}, Lcom/android/settings/widget/DotsPageIndicator$LeftwardStartPredicate;-><init>(Lcom/android/settings/widget/DotsPageIndicator;F)V
    ...
    iput-object v1, v2, Lcom/android/settings/widget/DotsPageIndicator;->retreatAnimation:Lcom/android/settings/widget/DotsPageIndicator$PendingRetreatAnimator;

    .line 603
    new-instance p0, Lcom/android/settings/widget/DotsPageIndicator$3;

    invoke-direct {p0, v2}, Lcom/android/settings/widget/DotsPageIndicator$3;-><init>(Lcom/android/settings/widget/DotsPageIndicator;)V

    invoke-virtual {v0, p0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    .line 613
    new-instance p0, Lcom/android/settings/widget/DotsPageIndicator$4;

    invoke-direct {p0, v2}, Lcom/android/settings/widget/DotsPageIndicator$4;-><init>(Lcom/android/settings/widget/DotsPageIndicator;)V

    invoke-virtual {v0, p0}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 630
    iget-boolean p0, v2, Lcom/android/settings/widget/DotsPageIndicator;->selectedDotInPosition:Z

    const-wide/16 p1, 0x4

    if-eqz p0, :cond_1

    iget-wide p3, v2, Lcom/android/settings/widget/DotsPageIndicator;->animDuration:J
    ...
    .line 632
    iget-object p0, v2, Lcom/android/settings/widget/DotsPageIndicator;->interpolator:Landroid/view/animation/Interpolator;
...
.method private drawUnselected(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v1, p0, v3}, Landroid/graphics/Path;->op(Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z
    ...
    .line 369
    iget p0, v0, Lcom/android/settings/widget/DotsPageIndicator;->retreatingJoinX1:F
    ...
    .line 371
    iget-object p0, v0, Lcom/android/settings/widget/DotsPageIndicator;->combinedUnselectedPath:Landroid/graphics/Path;

    invoke-direct {v0}, Lcom/android/settings/widget/DotsPageIndicator;->getRetreatingJoinPath()Landroid/graphics/Path;

    move-result-object v1

    sget-object v2, Landroid/graphics/Path$Op;->UNION:Landroid/graphics/Path$Op;

    invoke-virtual {p0, v1, v2}, Landroid/graphics/Path;->op(Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z

    .line 374
    :cond_3
    iget-object p0, v0, Lcom/android/settings/widget/DotsPageIndicator;->combinedUnselectedPath:Landroid/graphics/Path;

    iget-object v0, v0, Lcom/android/settings/widget/DotsPageIndicator;->unselectedPaint:Landroid/graphics/Paint;
...
.method private getUnselectedPath(IFFFF)Landroid/graphics/Path;
    ...
    invoke-virtual {v2, v1, v4, v5, v7}, Landroid/graphics/Path;->addCircle(FFFLandroid/graphics/Path$Direction;)V
    ...
    invoke-virtual {v1, v2, v13, v12, v10}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FFZ)V
    ...
    .line 429
    iget-object v14, v0, Lcom/android/settings/widget/DotsPageIndicator;->unselectedDotLeftPath:Landroid/graphics/Path;
    ...
    iput v5, v0, Lcom/android/settings/widget/DotsPageIndicator;->endY2:F
    ...
    .line 437
    iput v5, v0, Lcom/android/settings/widget/DotsPageIndicator;->controlY2:F
    ...
    sget-object v15, Landroid/graphics/Path$Op;->UNION:Landroid/graphics/Path$Op;

    invoke-virtual {v1, v2, v15}, Landroid/graphics/Path;->op(Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z
    ...
    invoke-virtual {v1, v2, v13, v3, v10}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FFZ)V
    ...
    .line 491
    iget-object v15, v0, Lcom/android/settings/widget/DotsPageIndicator;->unselectedDotPath:Landroid/graphics/Path;
    ...
    .line 497
    iget v3, v0, Lcom/android/settings/widget/DotsPageIndicator;->endY1:F

    iput v3, v0, Lcom/android/settings/widget/DotsPageIndicator;->controlY1:F
    ...
    invoke-virtual {v1, v2, v3, v12, v10}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FFZ)V
    ...
    .line 516
    iput v14, v0, Lcom/android/settings/widget/DotsPageIndicator;->endX2:F
    ...
    invoke-virtual {v1, v6, v2, v3, v4}, Landroid/graphics/Path;->addCircle(FFFLandroid/graphics/Path$Direction;)V
