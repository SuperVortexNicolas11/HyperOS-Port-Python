...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lcom/android/settings/R$layout;->usage_view:I

    invoke-virtual {v0, v1, p0}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    .line 44
    sget v0, Lcom/android/settings/R$id;->usage_graph:I
    ...
    sget v1, Lcom/android/settings/R$id;->label_bottom:I
    ...
    sget v1, Lcom/android/settings/R$id;->label_middle:I
    ...
    sget v1, Lcom/android/settings/R$id;->label_top:I
    ...
    sget v4, Lcom/android/settings/R$id;->label_start:I
    ...
    sget v4, Lcom/android/settings/R$id;->label_end:I
    ...
    .line 55
    sget p2, Lcom/android/settings/R$styleable;->UsageView_sideLabels:I
    ...
    .line 58
    :cond_0
    sget p2, Lcom/android/settings/R$styleable;->UsageView_bottomLabels:I
    ...
    .line 61
    :cond_1
    sget p2, Lcom/android/settings/R$styleable;->UsageView_textColor:I
    ...
    .line 70
    :cond_3
    sget p2, Lcom/android/settings/R$styleable;->UsageView_android_gravity:I
    ...
    .line 73
    sget p2, Lcom/android/settings/R$id;->graph_label_group:I
    ...
    .line 74
    sget v1, Lcom/android/settings/R$id;->label_group:I
    ...
    .line 81
    sget p2, Lcom/android/settings/R$id;->bottom_label_group:I
    ...
    .line 82
    sget v0, Lcom/android/settings/R$id;->bottom_label_space:I
    ...
    sget v0, Lcom/android/settings/R$styleable;->UsageView_android_colorAccent:I
    ...
    :cond_8
    :goto_3
    sget p1, Lcom/android/settings/R$id;->graph_label_group:I
    ...
    .line 97
    sget p1, Lcom/android/settings/R$id;->bottom_label_group:I
...
.method public setSideLabelWeights(FF)V
    ...
    .line 130
    sget v0, Lcom/android/settings/R$id;->space1:I

    invoke-direct {p0, v0, p1}, Lcom/android/settings/widget/UsageView;->setWeight(IF)V

    .line 131
    sget p1, Lcom/android/settings/R$id;->space2:I
