...
# direct methods
.method public static synthetic $r8$lambda$83jrb-cFnybis6hpqAMnoRAaUxo(Lcom/android/settings/wifi/ConfigureAccessPointFragment;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic $r8$lambda$zYM1tZzIW1DTYQwBodamjLksSsk(Lcom/android/settings/wifi/ConfigureAccessPointFragment;Landroid/view/View;)V
    .locals 0
...
.method public onInflateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object p1, p0, Lcom/android/settings/wifi/ConfigureAccessPointFragment;->mSubmitBtn:Landroid/widget/Button;

    const p1, 0x102001a    # @android:id/button2
    ...
    iput-object p1, p0, Lcom/android/settings/wifi/ConfigureAccessPointFragment;->mCancelBtn:Landroid/widget/Button;

    .line 83
    iget-object p1, p0, Lcom/android/settings/wifi/ConfigureAccessPointFragment;->mSubmitBtn:Landroid/widget/Button;

    new-instance p2, Lcom/android/settings/wifi/ConfigureAccessPointFragment$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/android/settings/wifi/ConfigureAccessPointFragment$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/wifi/ConfigureAccessPointFragment;)V

    invoke-virtual {p1, p2}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 84
    iget-object p1, p0, Lcom/android/settings/wifi/ConfigureAccessPointFragment;->mCancelBtn:Landroid/widget/Button;

    new-instance p2, Lcom/android/settings/wifi/ConfigureAccessPointFragment$$ExternalSyntheticLambda1;

    invoke-direct {p2, p0}, Lcom/android/settings/wifi/ConfigureAccessPointFragment$$ExternalSyntheticLambda1;-><init>(Lcom/android/settings/wifi/ConfigureAccessPointFragment;)V
    ...
    iput-object v1, v2, Lcom/android/settings/wifi/ConfigureAccessPointFragment;->mUiController:Lcom/android/settings/wifi/WifiConfigController;
