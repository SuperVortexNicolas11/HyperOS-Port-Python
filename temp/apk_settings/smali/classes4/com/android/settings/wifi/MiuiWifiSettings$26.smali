.class Lcom/android/settings/wifi/MiuiWifiSettings$26;
...
.method constructor <init>(Lcom/android/settings/wifi/MiuiWifiSettings;Lcom/android/settings/wifi/MiuiWifiSettings;Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;I)V
    ...
    .line 3505
    iput-object p1, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->this$0:Lcom/android/settings/wifi/MiuiWifiSettings;

    iput-object p2, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$wifiSettings:Lcom/android/settings/wifi/MiuiWifiSettings;

    iput-object p3, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$ap:Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;

    iput p4, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$method:I
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$ap:Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;
    ...
    iget-object p0, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$ap:Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;
    ...
    .line 3516
    :cond_0
    iget-object v2, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$wifiSettings:Lcom/android/settings/wifi/MiuiWifiSettings;
    ...
    .line 3517
    iget-object v2, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->this$0:Lcom/android/settings/wifi/MiuiWifiSettings;

    invoke-static {v2}, Lcom/android/settings/wifi/MiuiWifiSettings;->access$900(Lcom/android/settings/wifi/MiuiWifiSettings;)Lcom/android/wifitrackerlib/WifiPickerTracker;
    ...
    .line 3524
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$ap:Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;

    invoke-virtual {v1}, Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;->getDeviceId()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lcom/android/settings/wifi/MiuiWifiSettings;->-$$Nest$sfputmEasyTetherConnectingDeviceId(Ljava/lang/String;)V
    ...
    .line 3528
    :try_start_2
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$wifiSettings:Lcom/android/settings/wifi/MiuiWifiSettings;
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$wifiSettings:Lcom/android/settings/wifi/MiuiWifiSettings;
    ...
    iget v2, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$method:I

    iget-object v3, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$ap:Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;

    .line 3532
    invoke-virtual {v3}, Lcom/android/bluetooth/ble/app/EasyTetherHotspotEntry;->getDeviceId()Ljava/lang/String;
    ...
    .line 3530
    invoke-virtual {v1, v4, v2, v5, v3}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 3534
    iget-object p0, p0, Lcom/android/settings/wifi/MiuiWifiSettings$26;->val$wifiSettings:Lcom/android/settings/wifi/MiuiWifiSettings;

    invoke-static {p0}, Lcom/android/settings/wifi/MiuiWifiSettings;->-$$Nest$fgetmWifiHelpWorkHandler(Lcom/android/settings/wifi/MiuiWifiSettings;)Lcom/android/settings/wifi/MiuiWifiSettings$MessageHandler;
