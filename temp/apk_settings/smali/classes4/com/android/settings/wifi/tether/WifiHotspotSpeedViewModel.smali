...
.field protected mCurrentSecurityType:I
...
# direct methods
.method public static synthetic $r8$lambda$KdaJDcCFgICUKVZtirj-wv1RQHM(Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;Ljava/lang/Integer;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->lambda$new$3(Ljava/lang/Integer;)V
...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    .line 68
    new-instance v3, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$$ExternalSyntheticLambda3;

    invoke-direct {v3, p0}, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$$ExternalSyntheticLambda3;-><init>(Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;)V

    iput-object v3, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mSecurityTypeObserver:Landroidx/lifecycle/Observer;
    ...
    invoke-virtual {v4}, Lcom/android/settings/overlay/FeatureFactory;->getWifiFeatureProvider()Lcom/android/settings/wifi/factory/WifiFeatureProvider;

    move-result-object v4

    .line 74
    invoke-virtual {v4}, Lcom/android/settings/wifi/factory/WifiFeatureProvider;->getWifiHotspotRepository()Lcom/android/settings/wifi/repository/WifiHotspotRepository;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mWifiHotspotRepository:Lcom/android/settings/wifi/repository/WifiHotspotRepository;

    .line 75
    invoke-virtual {v4}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->get6gAvailable()Landroidx/lifecycle/LiveData;

    move-result-object v5

    invoke-virtual {v5, p1}, Landroidx/lifecycle/LiveData;->observeForever(Landroidx/lifecycle/Observer;)V

    .line 76
    invoke-virtual {v4}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->get5gAvailable()Landroidx/lifecycle/LiveData;
    ...
    .line 77
    invoke-virtual {v4}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->getSpeedType()Landroidx/lifecycle/LiveData;
    ...
    .line 78
    invoke-virtual {v4}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->getSecurityType()Landroidx/lifecycle/LiveData;
    ...
    iput p1, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mCurrentSecurityType:I

    .line 80
    invoke-virtual {v4, v1}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->setAutoRefresh(Z)V
    ...
    invoke-virtual {v4}, Lcom/android/settings/wifi/repository/WifiHotspotRepository;->is6GHzBandSupported()Z
...
.method private synthetic lambda$new$3(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->onSecurityTypeChanged(I)V
...
.method protected on5gAvailableChanged(Ljava/lang/Boolean;)V
    ...
    .line 109
    :goto_1
    iget v0, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mCurrentSecurityType:I
    ...
    const-string v1, "on5gAvailableChanged(), showDualBand:"
    ...
    :cond_3
    :goto_2
    iget-object p1, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mSpeedInfo2g5g:Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;

    iput-boolean v1, p1, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;->mIsVisible:Z
...
.method protected onCleared()V
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mSpeedTypeObserver:Landroidx/lifecycle/Observer;
    ...
    iget-object p0, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mSecurityTypeObserver:Landroidx/lifecycle/Observer;
...
.method protected onSecurityTypeChanged(I)V
    ...
    iput-boolean v0, p1, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;->mIsVisible:Z

    .line 134
    iget-object p1, p1, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;->mIsChecked:Ljava/lang/Boolean;
    ...
    .line 135
    iget-object p1, p0, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel;->mSpeedInfo2g:Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v0, p1, Lcom/android/settings/wifi/tether/WifiHotspotSpeedViewModel$SpeedInfo;->mIsChecked:Ljava/lang/Boolean;
