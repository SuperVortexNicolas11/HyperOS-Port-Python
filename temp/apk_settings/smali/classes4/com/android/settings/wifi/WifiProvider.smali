...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v2, v2, v1}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
...
.method private enforcePermission(Landroid/net/Uri;)V
    .locals 2
    ...
    const-string v0, "com.xiaomi.permission.ACCESS_WIFI"
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 145
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/WifiProvider;->enforcePermission(Landroid/net/Uri;)V

    .line 148
    iget-object v0, p0, Lcom/android/settings/wifi/WifiProvider;->mHelper:Lcom/android/settings/wifi/WifiDatabaseHelper;
    ...
    .line 182
    invoke-virtual {v0, v4, p0, p3}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 158
    invoke-virtual {v0, v2, p0, p3}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v0, p2, v3, p0}, Landroid/database/sqlite/SQLiteDatabase;->insert(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
...
.method public onCreate()Z
    ...
    .line 41
    invoke-static {}, Lcom/android/settings/wifi/WifiProviderUtils;->isFileBasedEncryptionEnabled()Z
    ...
    invoke-static {v0}, Lcom/android/settings/wifi/WifiDatabaseHelper;->getInstanceForDe(Landroid/content/Context;)Lcom/android/settings/wifi/WifiDatabaseHelper;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/wifi/WifiProvider;->mHelper:Lcom/android/settings/wifi/WifiDatabaseHelper;

    goto :goto_0

    .line 44
    :cond_0
    new-instance v0, Lcom/android/settings/wifi/WifiDatabaseHelper;

    invoke-virtual {p0}, Landroid/content/ContentProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/settings/wifi/WifiDatabaseHelper;-><init>(Landroid/content/Context;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 52
    invoke-direct/range {p0 .. p1}, Lcom/android/settings/wifi/WifiProvider;->enforcePermission(Landroid/net/Uri;)V
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v5, "share_upate_time"
    ...
    invoke-virtual {p2, v5, v1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    .line 236
    invoke-virtual {v0, v4, p2, p0, p4}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {p2, v5, p0}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    .line 222
    invoke-virtual {v0, v3, p2, p0, p4}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 210
    invoke-virtual {v0, v2, p2, p0, p4}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 203
    invoke-virtual {v0, v2, p0, p3, p4}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
