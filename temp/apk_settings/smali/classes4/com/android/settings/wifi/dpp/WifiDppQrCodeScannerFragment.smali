...
.method static bridge synthetic -$$Nest$mgetWifiReachabilityStringId(Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;Landroid/net/wifi/WifiConfiguration;)I
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->getWifiReachabilityStringId(Landroid/net/wifi/WifiConfiguration;)I
...
.method public constructor <init>(Lcom/android/wifitrackerlib/WifiPickerTracker;Lcom/android/settingslib/wifi/WifiPermissionChecker;)V
    ...
    .line 398
    iput-object p2, p0, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->mWifiPermissionChecker:Lcom/android/settingslib/wifi/WifiPermissionChecker;
...
.method private getWifiReachabilityStringId(Landroid/net/wifi/WifiConfiguration;)I
    .locals 7
    ...
    .line 253
    iget-object v2, p0, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->mWifiPickerTracker:Lcom/android/wifitrackerlib/WifiPickerTracker;
    ...
    const-string v4, "WifiDppQrCodeScanner"
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->isSecurityMatched(II)Z
    ...
    .line 267
    const-string p0, "WiFi DPP detects connection security for a matching WiFi network."
    ...
    .line 272
    const-string p0, "WiFi DPP check connection no matched security"

    invoke-static {v4, p0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 273
    sget p0, Lcom/android/settings/R$string;->wifi_dpp_check_connection_no_matched_security:I

    return p0

    .line 275
    :cond_5
    const-string p0, "WiFi DPP check connection no matched SSID"

    invoke-static {v4, p0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 276
    sget p0, Lcom/android/settings/R$string;->wifi_dpp_check_connection_no_matched_ssid:I
...
.method private isNoPasswordSecurity(I)Z
    .locals 0
...
.method private synthetic lambda$onCreate$0(Lcom/android/settings/wifi/dpp/WifiDppInitiatorViewModel;Ljava/lang/Integer;)V
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment$EasyConnectEnrolleeStatusCallback;-><init>(Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment-IA;)V
...
.method private synthetic lambda$onCreate$1(Lcom/android/settings/wifi/dpp/WifiDppInitiatorViewModel;Ljava/lang/Integer;)V
    ...
    invoke-direct {p2, p0, v0}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment$EasyConnectEnrolleeStatusCallback;-><init>(Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment-IA;)V
...
.method isSecurityMatched(II)Z
    ...
    .line 290
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->isNoPasswordSecurity(I)Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-direct {p0, p2}, Lcom/android/settings/wifi/dpp/WifiDppQrCodeScannerFragment;->isNoPasswordSecurity(I)Z
