.class public Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment;
.super Lcom/android/settings/wifi/dpp/MiuiWifiDppQrCodeBaseFragment;
.source "SourceFile"


# direct methods
.method public static synthetic $r8$lambda$hEosaOV4u9O0gv_VMms7Tx9JKcU(Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment;Landroid/view/View;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment;->lambda$onViewCreated$0(Landroid/view/View;)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 50
    new-instance v0, Lcom/android/settings/wifi/dpp/MiuiWifiNetworkListFragment;

    invoke-direct {v0}, Lcom/android/settings/wifi/dpp/MiuiWifiNetworkListFragment;-><init>()V
...
.method public final onInflateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 66
    sget p0, Lcom/android/settings/R$layout;->miui_wifi_dpp_choose_saved_wifi_network_fragment:I
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/settings/wifi/dpp/MiuiWifiDppQrCodeBaseFragment;->setHeaderTitle(I[Ljava/lang/Object;)V

    .line 75
    iget-object p1, p0, Lcom/android/settings/wifi/dpp/MiuiWifiDppQrCodeBaseFragment;->mSummary:Landroid/widget/TextView;
    ...
    new-instance p2, Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/wifi/dpp/MiuiWifiDppChooseSavedWifiNetworkFragment;)V
    ...
    .line 93
    iget-object p0, p0, Lcom/android/settings/wifi/dpp/MiuiWifiDppQrCodeBaseFragment;->mRightButton:Lcom/google/android/setupcompat/template/FooterButton;
