...
# direct methods
.method static bridge synthetic -$$Nest$fgetmContext(Lcom/android/settings/wifi/WifiStatusController;)Landroid/content/Context;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmEasyTetherConnection(Lcom/android/settings/wifi/WifiStatusController;)Landroid/content/ServiceConnection;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmHandler(Lcom/android/settings/wifi/WifiStatusController;)Landroid/os/Handler;
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmEasyTetherConnection(Lcom/android/settings/wifi/WifiStatusController;Landroid/content/ServiceConnection;)V
    .locals 0

    .line 0
    iput-object p1, p0, Lcom/android/settings/wifi/WifiStatusController;->mEasyTetherConnection:Landroid/content/ServiceConnection;
...
.method static bridge synthetic -$$Nest$msetStatusText(Lcom/android/settings/wifi/WifiStatusController;)V
    .locals 0

    .line 0
    invoke-direct {p0}, Lcom/android/settings/wifi/WifiStatusController;->setStatusText()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/TextView;)V
    ...
    .line 217
    iget-object p1, p0, Lcom/android/settings/wifi/WifiStatusController;->mContext:Landroid/content/Context;
...
.method private getWifiState()Ljava/lang/String;
    ...
    .line 129
    iget-boolean v4, p0, Lcom/android/settings/wifi/WifiStatusController;->mVerbose:Z
    ...
    const-string v5, "wifiInfo.getBSSID() "
    ...
    const-string v5, " easyTetherConnectedBssid "
    ...
    const-string v5, " easyTetherConnectedSsid "
    ...
    .line 140
    :cond_9
    iget-object p0, p0, Lcom/android/settings/wifi/WifiStatusController;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 143
    const-string p0, "Determined by matching scan results."
...
.method private isActivityEmbedded()Z
    ...
    .line 203
    iget-object v0, p0, Lcom/android/settings/wifi/WifiStatusController;->mActivityEmbeddingController:Landroidx/window/embedding/ActivityEmbeddingController;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WifiStatusController;->mActivityEmbeddingController:Landroidx/window/embedding/ActivityEmbeddingController;
...
.method private registerEasyTetherCoreService()V
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/WifiStatusController;->mEasyTetherConnection:Landroid/content/ServiceConnection;
    ...
    const-string v2, "bindServiceAsUser, mEasyTetherConnection = "
...
.method private setStatusText()V
    .locals 1
...
.method private unregisterEasyTetherCoreService()V
    ...
    const-string v1, "unregisterEasyTetherCoreService mEasyTetherConnection = "
    ...
    .line 336
    const-string v0, "unbindService(mEasyTetherConnection)"
    ...
    .line 342
    iput-object v0, p0, Lcom/android/settings/wifi/WifiStatusController;->mEasyTetherCoreService:Lcom/android/bluetooth/ble/app/IMiuiNearbyApiService;
...
.method private wakeUpWifiTrackerInjector()V
    ...
    .line 232
    :try_start_0
    const-class v0, Lcom/android/wifitrackerlib/WifiTrackerInjector;
...
.method public setStatusView(Landroid/widget/TextView;)V
    ...
    .line 348
    invoke-direct {p0}, Lcom/android/settings/wifi/WifiStatusController;->isActivityEmbedded()Z
