...
.method private initKeyList()V
    ...
    const-string v1, "wifi_assistant_choice_state"
    ...
    const-string v1, "wifi_assistant_mode_state"
    ...
    const-string v1, "user_network_priority_enabled"
    ...
    const-string v3, "wifi_assistant_mode_balanced"
    ...
    const-string v3, "wifi_assistant_mode_fast"
    ...
    const-string v3, "wifi_assistant_autoturnon_state"
...
.method private reportState(Ljava/lang/String;)V
    ...
    const-string v4, "link_turbo_option"

    const-string v5, "user_network_priority_mode"
    ...
    :sswitch_0
    const-string v8, "wifi_switch_state"
    ...
    :sswitch_1
    const-string v8, "wifi_assistant_mode_fast"
    ...
    :sswitch_2
    const-string v8, "mobile_data_speed_boost_custom"
    ...
    :sswitch_3
    const-string v8, "dual_band_speed_boost_state"
    ...
    :sswitch_4
    const-string v8, "wifi_assistant_autoturnon_state"
    ...
    :sswitch_5
    const-string v8, "mobile_data_speed_boost_recommend"
    ...
    :sswitch_6
    const-string v8, "mobile_data_speed_boost_auxiliary"
    ...
    :sswitch_7
    const-string v8, "dual_band_speed_boost_autoturnoff_state"
    ...
    :sswitch_8
    const-string v8, "wifi_assistant_mode_state"
    ...
    :sswitch_9
    const-string v8, "wifi_assistant_choice_state"
    ...
    :sswitch_a
    const-string v8, "mobile_data_speed_boost_full"
    ...
    :sswitch_b
    const-string v8, "wifi_assistant_mode_balanced"
    ...
    :sswitch_c
    const-string v8, "mobile_data_speed_boost_state"
    ...
    .line 135
    :pswitch_3
    iget-boolean v7, p0, Lcom/android/settings/wifi/OneTrackService;->mDualBandState:Z
    ...
    const-string v0, "wifi_slave_auto_disable"

    invoke-static {p0, v0, v7}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .line 118
    :pswitch_8
    iget-boolean v7, p0, Lcom/android/settings/wifi/OneTrackService;->mModeState:Z
    ...
    .line 142
    :pswitch_c
    iget-boolean v7, p0, Lcom/android/settings/wifi/OneTrackService;->mBoostState:Z
