...
.method public onImageAvailable(Landroid/media/ImageReader;)V
    ...
    .line 217
    :goto_2
    iget-object p1, p0, Lsrc/com/android/settings/emergency/util/CameraUtils$5;->this$0:Lsrc/com/android/settings/emergency/util/CameraUtils;

    invoke-virtual {p1}, Lsrc/com/android/settings/emergency/util/CameraUtils;->release()V
    ...
    :goto_6
    :try_start_6
    new-instance p1, Lsrc/com/android/settings/emergency/util/CameraUtils$SaveBitmapAndSendRunnable;

    iget-object p0, p0, Lsrc/com/android/settings/emergency/util/CameraUtils$5;->this$0:Lsrc/com/android/settings/emergency/util/CameraUtils;

    invoke-static {p0}, Lsrc/com/android/settings/emergency/util/CameraUtils;->-$$Nest$fgetmBitmap(Lsrc/com/android/settings/emergency/util/CameraUtils;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-virtual {p0, v0}, Lsrc/com/android/settings/emergency/util/CameraUtils;->changeBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-direct {p1, p0, v0}, Lsrc/com/android/settings/emergency/util/CameraUtils$SaveBitmapAndSendRunnable;-><init>(Lsrc/com/android/settings/emergency/util/CameraUtils;Landroid/graphics/Bitmap;)V
