.class public abstract Lcom/android/settings/supervision/SupervisionSafeSitesPreference;
...
# instance fields
.field private final dataStore:Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;


# direct methods
.method public static synthetic $r8$lambda$8t65vS9bIzEkp0LIi3BTYcth5gQ(Lcom/android/settingslib/widget/SelectorWithWidgetPreference;Landroidx/preference/Preference;)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0, p1}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->onRadioButtonClicked$lambda$0(Lcom/android/settingslib/widget/SelectorWithWidgetPreference;Landroidx/preference/Preference;)Lkotlin/Unit;
...
.method private constructor <init>(Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;)V
    .locals 0
    ...
    .line 32
    iput-object p1, p0, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->dataStore:Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;

    return-void
.end method

.method public synthetic constructor <init>(Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;-><init>(Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;)V
...
.method public bind(Landroidx/preference/Preference;Lcom/android/settingslib/metadata/PreferenceMetadata;)V
    ...
    .line 66
    iget-object p2, p0, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->dataStore:Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;
...
.method public bridge synthetic createWidget(Landroid/content/Context;)Landroidx/preference/Preference;
    ...
    .line 31
    invoke-virtual {p0, p1}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->createWidget(Landroid/content/Context;)Lcom/android/settingslib/widget/SelectorWithWidgetPreference;
...
.method public bridge synthetic getWritePermit(Landroid/content/Context;Ljava/lang/Object;II)I
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->getWritePermit(Landroid/content/Context;Ljava/lang/Boolean;II)I
...
.method public onRadioButtonClicked(Lcom/android/settingslib/widget/SelectorWithWidgetPreference;)V
    ...
    new-instance v0, Lcom/android/settings/supervision/SupervisionSafeSitesPreference$$ExternalSyntheticLambda0;

    invoke-direct {v0, p1}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference$$ExternalSyntheticLambda0;-><init>(Lcom/android/settingslib/widget/SelectorWithWidgetPreference;)V
...
.method public storage(Landroid/content/Context;)Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;
    .locals 0

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 34
    iget-object p0, p0, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->dataStore:Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;
...
.method public bridge synthetic storage(Landroid/content/Context;)Lcom/android/settingslib/datastore/KeyValueStore;
    ...
    .line 31
    invoke-virtual {p0, p1}, Lcom/android/settings/supervision/SupervisionSafeSitesPreference;->storage(Landroid/content/Context;)Lcom/android/settings/supervision/SupervisionSafeSitesDataStore;
