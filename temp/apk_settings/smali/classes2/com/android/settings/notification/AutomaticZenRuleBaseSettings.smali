...
.method protected createAutomaticZenRule(Landroid/service/notification/ZenModeConfig$ZenRule;)Landroid/app/AutomaticZenRule;
    ...
    iget p0, p1, Landroid/service/notification/ZenModeConfig$ZenRule;->zenMode:I
...
.method protected getRuleName()Ljava/lang/String;
    ...
    .line 196
    iget-object p0, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mHint:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mEditTitle:Lcom/android/settingslib/miuisettings/preference/EditTextPreference;
    ...
    .line 112
    const-string/jumbo p1, "time_turn_on"

    invoke-virtual {p0, p1}, Landroidx/preference/PreferenceFragmentCompat;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object p1

    check-cast p1, Lcom/android/settings/soundsettings/LabelPreferenceWithBg;

    iput-object p1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mTimeTurnOnPref:Lcom/android/settings/soundsettings/LabelPreferenceWithBg;
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->formatChooseTime(II)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Lcom/android/settings/soundsettings/LabelPreferenceWithBg;->setLabel(Ljava/lang/String;)V
    ...
    .line 115
    const-string/jumbo p1, "time_turn_off"
    ...
    iput-object p1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mTimeTurnOffPref:Lcom/android/settings/soundsettings/LabelPreferenceWithBg;

    .line 116
    iget v0, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mEndTime:I
    ...
    .line 118
    const-string/jumbo p1, "repeat_days"

    invoke-virtual {p0, p1}, Landroidx/preference/PreferenceFragmentCompat;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object p1

    check-cast p1, Lcom/android/settings/soundsettings/RepeatPreferenceWithBg;

    iput-object p1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mRepeatDaysPref:Lcom/android/settings/soundsettings/RepeatPreferenceWithBg;

    .line 119
    iget-object p0, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mBootDof:Lcom/android/settings/dndmode/Alarm$DaysOfWeek;

    invoke-virtual {p1, p0}, Lcom/android/settings/soundsettings/RepeatPreferenceWithBg;->setDaysOfWeek(Lcom/android/settings/dndmode/Alarm$DaysOfWeek;)V
...
.method public onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    iget v3, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mStartTime:I
    ...
    .line 178
    iget-object v1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mTimeTurnOnPref:Lcom/android/settings/soundsettings/LabelPreferenceWithBg;
    ...
    .line 179
    iput-boolean v2, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mTimeFlag:Z
    ...
    .line 182
    :cond_0
    iget-object v1, p0, Lcom/android/settings/notification/AutomaticZenRuleBaseSettings;->mTimeTurnOffPref:Lcom/android/settings/soundsettings/LabelPreferenceWithBg;
    ...
    invoke-virtual {v0, p1, p0}, Lmiuix/appcompat/app/TimePickerDialog;->updateTime(II)V
