...
.method static bridge synthetic -$$Nest$fgetmContentRestrictedUsers(Lcom/android/settings/notification/history/NotificationHistoryActivity;)Ljava/util/ArrayList;
    .locals 0

    .line 0
    iget-object p0, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mContentRestrictedUsers:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mContentRestrictedUsers:Ljava/util/ArrayList;
...
.method public static getRoundCornerDrawableRes(I)I
    .locals 2
...
.method private synthetic lambda$new$2(Ljava/util/List;)V
    ...
    sget v2, Lcom/android/settings/R$id;->apps:I
    ...
    check-cast v5, Lcom/android/settings/notification/history/NotificationHistoryPackage;
    ...
    sget v2, Lcom/android/settings/R$layout;->notification_history_app_layout:I
    ...
    .line 170
    :cond_2
    invoke-static {v0}, Lcom/android/settings/notification/history/NotificationHistoryActivity;->getRoundCornerDrawableRes(I)I
    ...
    const v0, 0x10202f9    # @android:id/flagNoEnterAction
    ...
    .line 178
    invoke-direct {p0, v0}, Lcom/android/settings/notification/history/NotificationHistoryActivity;->obtainThemeColor(I)I

    move-result v0

    const v13, 0x10104e2    # @android:attr/colorBackgroundFloating

    .line 179
    invoke-direct {p0, v13}, Lcom/android/settings/notification/history/NotificationHistoryActivity;->obtainThemeColor(I)I
    ...
    .line 180
    invoke-static {v0, v13, v14}, Landroidx/core/graphics/ColorUtils;->blendARGB(IIF)I

    move-result v13

    .line 181
    invoke-virtual {v3, v13}, Lcom/android/internal/widget/NotificationExpandButton;->setDefaultPillColor(I)V

    .line 182
    invoke-virtual {v3, v0}, Lcom/android/internal/widget/NotificationExpandButton;->setDefaultTextColor(I)V

    .line 183
    invoke-virtual {v3, v8}, Lcom/android/internal/widget/NotificationExpandButton;->setExpanded(Z)V
    ...
    .line 184
    :goto_3
    invoke-virtual {v4, v0}, Landroid/view/View;->setStateDescription(Ljava/lang/CharSequence;)V
    ...
    .line 203
    iget-object v2, v14, Lcom/android/settings/notification/history/NotificationHistoryPackage;->label:Ljava/lang/CharSequence;
    ...
    :cond_4
    iget-object v2, v14, Lcom/android/settings/notification/history/NotificationHistoryPackage;->pkgName:Ljava/lang/String;

    :goto_4
    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 204
    iget-object v2, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mUm:Landroid/os/UserManager;

    invoke-virtual {v0}, Landroid/widget/TextView;->getText()Ljava/lang/CharSequence;

    move-result-object v3

    iget v4, v14, Lcom/android/settings/notification/history/NotificationHistoryPackage;->uid:I
    ...
    .line 207
    iget-object v2, v14, Lcom/android/settings/notification/history/NotificationHistoryPackage;->icon:Landroid/graphics/drawable/Drawable;
    ...
    sget v3, Lcom/android/settings/R$string;->notification_history_count:I
    ...
    .line 213
    sget v2, Lcom/android/settings/R$id;->notification_list:I
    ...
    check-cast v3, Lcom/android/settings/notification/history/NotificationHistoryRecyclerView;
    ...
    iget-object v2, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mNm:Landroid/app/INotificationManager;

    move-object v5, v4

    new-instance v4, Lcom/android/settings/notification/history/NotificationHistoryActivity$$ExternalSyntheticLambda5;

    invoke-direct {v4, p0, v0, v12}, Lcom/android/settings/notification/history/NotificationHistoryActivity$$ExternalSyntheticLambda5;-><init>(Lcom/android/settings/notification/history/NotificationHistoryActivity;Landroid/widget/TextView;Landroid/view/View;)V

    move-object v0, v5

    iget-object v5, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mUiEventLogger:Lcom/android/internal/logging/UiEventLogger;

    iget-object v6, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mContentRestrictedUsers:Ljava/util/ArrayList;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Lcom/android/settings/notification/history/NotificationHistoryAdapter;-><init>(Landroid/content/Context;Landroid/app/INotificationManager;Lcom/android/settings/notification/history/NotificationHistoryRecyclerView;Lcom/android/settings/notification/history/NotificationHistoryAdapter$OnItemDeletedListener;Lcom/android/internal/logging/UiEventLogger;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/notification/history/NotificationHistoryAdapter;->onRebuildComplete(Ljava/util/List;)V
...
.method protected onResume()V
    ...
    .line 267
    iget-object v2, p0, Lcom/android/settings/notification/history/NotificationHistoryActivity;->mContentRestrictedUsers:Ljava/util/ArrayList;
