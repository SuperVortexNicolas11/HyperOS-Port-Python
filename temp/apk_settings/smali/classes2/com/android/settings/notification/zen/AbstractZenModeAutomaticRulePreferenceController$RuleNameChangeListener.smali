...
.method public onOk(Ljava/lang/String;Landroidx/fragment/app/Fragment;)V
    ...
    iget-object v1, v1, Lcom/android/settings/notification/zen/ZenRuleInfo;->defaultConditionId:Landroid/net/Uri;

    invoke-direct {v0, p1, v1}, Landroid/app/AutomaticZenRule$Builder;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    iget-object p1, p0, Lcom/android/settings/notification/zen/AbstractZenModeAutomaticRulePreferenceController$RuleNameChangeListener;->mRuleInfo:Lcom/android/settings/notification/zen/ZenRuleInfo;

    iget p1, p1, Lcom/android/settings/notification/zen/ZenRuleInfo;->type:I

    .line 172
    invoke-virtual {v0, p1}, Landroid/app/AutomaticZenRule$Builder;->setType(I)Landroid/app/AutomaticZenRule$Builder;

    move-result-object p1

    iget-object v0, p0, Lcom/android/settings/notification/zen/AbstractZenModeAutomaticRulePreferenceController$RuleNameChangeListener;->mRuleInfo:Lcom/android/settings/notification/zen/ZenRuleInfo;

    iget-object v0, v0, Lcom/android/settings/notification/zen/ZenRuleInfo;->serviceComponent:Landroid/content/ComponentName;

    .line 173
    invoke-virtual {p1, v0}, Landroid/app/AutomaticZenRule$Builder;->setOwner(Landroid/content/ComponentName;)Landroid/app/AutomaticZenRule$Builder;

    move-result-object p1

    iget-object v0, p0, Lcom/android/settings/notification/zen/AbstractZenModeAutomaticRulePreferenceController$RuleNameChangeListener;->mRuleInfo:Lcom/android/settings/notification/zen/ZenRuleInfo;

    iget-object v0, v0, Lcom/android/settings/notification/zen/ZenRuleInfo;->configurationActivity:Landroid/content/ComponentName;

    .line 174
    invoke-virtual {p1, v0}, Landroid/app/AutomaticZenRule$Builder;->setConfigurationActivity(Landroid/content/ComponentName;)Landroid/app/AutomaticZenRule$Builder;
    ...
    .line 175
    invoke-virtual {p1, v0}, Landroid/app/AutomaticZenRule$Builder;->setInterruptionFilter(I)Landroid/app/AutomaticZenRule$Builder;

    move-result-object p1

    iget-object v0, p0, Lcom/android/settings/notification/zen/AbstractZenModeAutomaticRulePreferenceController$RuleNameChangeListener;->mRuleInfo:Lcom/android/settings/notification/zen/ZenRuleInfo;

    iget-object v0, v0, Lcom/android/settings/notification/zen/ZenRuleInfo;->defaultTriggerDescription:Ljava/lang/String;

    .line 176
    invoke-virtual {p1, v0}, Landroid/app/AutomaticZenRule$Builder;->setTriggerDescription(Ljava/lang/String;)Landroid/app/AutomaticZenRule$Builder;

    move-result-object p1

    .line 177
    invoke-virtual {p1}, Landroid/app/AutomaticZenRule$Builder;->build()Landroid/app/AutomaticZenRule;
    ...
    iget-object v0, v0, Lcom/android/settings/notification/zen/AbstractZenModeAutomaticRulePreferenceController;->mBackend:Lcom/android/settings/notification/zen/ZenModeBackend;
