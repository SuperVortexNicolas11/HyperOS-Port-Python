...
# direct methods
.method public static synthetic $r8$lambda$2nN4wvo38BwrfBEmcH2j_QwnIjU(Landroid/companion/AssociationInfo;)Ljava/lang/String;
    .locals 1
...
.method public static synthetic $r8$lambda$_r6pmy_pzAO27wk9pCivwOG_pR4(Ljava/lang/String;)Z
    .locals 1
...
.method public static getDeviceList(Landroid/companion/ICompanionDeviceManager;Lcom/android/settingslib/bluetooth/LocalBluetoothManager;Ljava/lang/String;I)Ljava/lang/CharSequence;
    ...
    new-instance p2, Lcom/android/settings/notification/NotificationBackend$$ExternalSyntheticLambda1;

    invoke-direct {p2}, Lcom/android/settings/notification/NotificationBackend$$ExternalSyntheticLambda1;-><init>()V
...
.method public canBePromoted(Ljava/lang/String;I)Z
    ...
    invoke-interface {p0, p1, p2}, Landroid/app/INotificationManager;->appCanBePromoted(Ljava/lang/String;I)Z
...
.method public getAdjustmentDeniedPackages(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-interface {p0, p1}, Landroid/app/INotificationManager;->getAdjustmentDeniedPackages(Ljava/lang/String;)[Ljava/lang/String;
...
.method public getAllowedBundleTypes()Ljava/util/Set;
    .locals 4
    ...
    invoke-interface {v0}, Landroid/app/INotificationManager;->getAllowedAdjustmentKeyTypes()[I
...
.method public getConversationDrawable(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;Ljava/lang/String;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 632
    invoke-static {p1, p0}, Landroid/util/IconDrawableFactory;->newInstance(Landroid/content/Context;Z)Landroid/util/IconDrawableFactory;
    ...
    .line 635
    invoke-virtual {v0, p2, p3, p4, p5}, Lcom/android/settingslib/notification/ConversationIconFactory;->getConversationDrawable(Landroid/content/pm/ShortcutInfo;Ljava/lang/String;IZ)Landroid/graphics/drawable/Drawable;
...
.method public isNotificationBundlingEnabled(Landroid/content/Context;)Z
    .locals 1
...
.method public isNotificationSummarizationEnabled(Landroid/content/Context;)Z
    .locals 1
    ...
    const-string p1, "key_summarization"
...
.method public loadAppRow(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;)Lcom/android/settings/notification/NotificationBackend$AppRow;
    ...
    .line 91
    iput-boolean v1, v0, Lcom/android/settings/notification/NotificationBackend$AppRow;->showAllChannels:Z
    ...
    .line 110
    iget-object p1, v0, Lcom/android/settings/notification/NotificationBackend$AppRow;->pkg:Ljava/lang/String;

    iget p2, v0, Lcom/android/settings/notification/NotificationBackend$AppRow;->uid:I

    invoke-virtual {p0, p1, p2}, Lcom/android/settings/notification/NotificationBackend;->canBePromoted(Ljava/lang/String;I)Z

    move-result p0

    iput-boolean p0, v0, Lcom/android/settings/notification/NotificationBackend$AppRow;->canBePromoted:Z
...
.method recordCanBeBlocked(Landroid/content/pm/PackageInfo;Lcom/android/settings/notification/NotificationBackend$AppRow;)V
    ...
    new-instance p1, Lcom/android/settings/notification/NotificationBackend$$ExternalSyntheticLambda0;

    invoke-direct {p1}, Lcom/android/settings/notification/NotificationBackend$$ExternalSyntheticLambda0;-><init>()V
...
.method public setBundleTypeState(IZ)V
    .locals 0
...
.method public setNotificationBundlingEnabled(Z)V
    .locals 1
...
.method public setNotificationSummarizationEnabled(Z)V
    .locals 1

    .line 730
    const-string p0, "key_summarization"
