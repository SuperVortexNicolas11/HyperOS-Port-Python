...
# static fields
.field private static mMashupSoundUri:Ljava/lang/String;
...
.method public static getMashupSoundUri(Landroid/content/Context;)Ljava/lang/String;
    .locals 1

    .line 195
    sget-object v0, Lcom/android/settings/ringtone/RingtoneUriCompat;->mMashupSoundUri:Ljava/lang/String;
    ...
    .line 196
    sget-object p0, Lcom/android/settings/ringtone/RingtoneUriCompat;->mMashupSoundUri:Ljava/lang/String;

    return-object p0

    .line 198
    :cond_0
    const-string v0, "file:///system/media/audio/ui/MusicShake.ogg"

    invoke-static {v0, p0}, Lcom/android/settings/ringtone/RingtoneUriCompat;->getUriFromFilePath(Ljava/lang/String;Landroid/content/Context;)Landroid/net/Uri;
    ...
    sput-object p0, Lcom/android/settings/ringtone/RingtoneUriCompat;->mMashupSoundUri:Ljava/lang/String;
...
.method public static queryUriFromMediaStore(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 74
    :cond_1
    const-string p0, "has READ_AUDIO permission %s, not found audio id for uri = %s"
