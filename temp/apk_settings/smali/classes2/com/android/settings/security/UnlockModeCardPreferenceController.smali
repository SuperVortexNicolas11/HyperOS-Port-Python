...
.method private initCardList()V
    ...
    check-cast v2, Lcom/android/settings/CardInfo;

    .line 111
    invoke-virtual {v2, v1}, Lcom/android/settings/CardInfo;->setDisable(Z)V
    ...
    const-string v2, "disallow_setting_screen_password"
    ...
    .line 118
    const-string v0, "UnlockModeCardPreferenceController"

    const-string v2, "Screen password is restricted by enterprise!"
