...
# direct methods
.method public static synthetic $r8$lambda$aWkBEZIanDoMMfUVSYCTFMBmH5c(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->EntryItem$lambda$0(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$qnOBnlxbJ8OeE-MSzfkf0GOvGsM(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->EntryItem$lambda$2(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$ugBitWLNzsgW5u_dzpfO1Ww4ryE(Landroid/os/Bundle;)Lcom/android/settingslib/spa/framework/common/EntrySearchData;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->buildInjectEntry$lambda$3(Landroid/os/Bundle;)Lcom/android/settingslib/spa/framework/common/EntrySearchData;
...
.method private static final EntryItem$lambda$0(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0
...
.method private static final EntryItem$lambda$1(Landroidx/compose/runtime/State;)Ljava/lang/String;
    .locals 0
...
.method private static final EntryItem$lambda$2(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0
...
.method public static final synthetic access$EntryItem$lambda$1(Landroidx/compose/runtime/State;)Ljava/lang/String;
    .locals 0

    .line 76
    invoke-static {p0}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->EntryItem$lambda$1(Landroidx/compose/runtime/State;)Ljava/lang/String;
...
.method private static final buildInjectEntry$lambda$3(Landroid/os/Bundle;)Lcom/android/settingslib/spa/framework/common/EntrySearchData;
    .locals 0
...
.method private final generatePreferenceSummary(Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v1, "com.android.settings.spa.app.backgroundinstall.BackgroundInstalledAppsPageProvider.generatePreferenceSummary (BackgroundInstalledAppsPageProvider.kt:108)"
    ...
    .line 111
    :cond_1
    new-instance v2, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$generatePreferenceSummary$1$1;

    const/4 v1, 0x0

    invoke-direct {v2, p0, v1}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$generatePreferenceSummary$1$1;-><init>(Landroid/content/Context;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {p2, v2, p1, v0}, Landroidx/compose/runtime/SnapshotStateKt;->produceState(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
...
.method public final EntryItem(Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v4, "com.android.settings.spa.app.backgroundinstall.BackgroundInstalledAppsPageProvider.EntryItem (BackgroundInstalledAppsPageProvider.kt:89)"
    ...
    new-instance v0, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p2}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda1;-><init>(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;I)V
    ...
    .line 92
    invoke-direct {p0, p1, v0}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->generatePreferenceSummary(Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v0

    .line 93
    new-instance v1, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$EntryItem$2;

    invoke-direct {v1, p1, v0}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$EntryItem$2;-><init>(Landroidx/compose/runtime/Composer;Landroidx/compose/runtime/State;)V
    ...
    new-instance v0, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p2}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda2;-><init>(Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;I)V
...
.method public Page(Landroid/os/Bundle;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v0, "com.android.settings.spa.app.backgroundinstall.BackgroundInstalledAppsPageProvider.Page (BackgroundInstalledAppsPageProvider.kt:83)"
    ...
    .line 85
    :cond_0
    sget-boolean p0, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider;->featureIsDisabled:Z
    ...
    .line 86
    invoke-static {p3, p2, p0, p1}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProviderKt;->BackgroundInstalledAppList(Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;II)V
...
.method public final buildInjectEntry()Lcom/android/settingslib/spa/framework/common/SettingsEntryBuilder;
    ...
    new-instance v0, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lcom/android/settings/spa/app/backgroundinstall/BackgroundInstalledAppsPageProvider$$ExternalSyntheticLambda0;-><init>()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/spa/app/backgroundinstall/ComposableSingletons$BackgroundInstalledAppsPageProviderKt;->getLambda-1$packages__apps__MiuiSettingsAosp__android_common__Settings_core()Lkotlin/jvm/functions/Function3;
