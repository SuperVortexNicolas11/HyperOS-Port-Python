...
.method public getIntent()Landroid/content/Intent;
    ...
    const-string v1, "com.miui.freeform.FreeformDemoActivity"
    ...
    :sswitch_0
    const-string v7, "multi_window_cvw_title"
    ...
    :sswitch_1
    const-string v7, "freeform_guide_drop_down_to_fullscreen_title"
    ...
    :sswitch_2
    const-string v7, "freeform_guide_notification_drop_down_title"
    ...
    :sswitch_3
    const-string v7, "freeform_guide_move_to_small_freeform_window_title"
    ...
    :sswitch_4
    const-string v7, "freeform_guide_slide_to_small_freeform_title"
    ...
    :sswitch_5
    const-string v7, "kid_space_settings"
    ...
    :sswitch_6
    const-string v7, "oldman_mode_entry_name"
    ...
    :sswitch_7
    const-string v7, "freeform_guide_slide_up_to_close_title"
    ...
    :sswitch_8
    const-string v7, "freeform_guide_move_title"
    ...
    :sswitch_9
    const-string v7, "freeform_guide_to_sidehide_title"
    ...
    invoke-direct {p0, v5, v2}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 249
    const-string v0, "market://details?id=com.jeejen.family&ref=com.android.settings_search&back=true"
    ...
    invoke-virtual {v6, v4, p0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
...
.method protected getStatus()I
    ...
    :sswitch_0
    const-string/jumbo v4, "quick_reply_title"
    ...
    :sswitch_1
    const-string v4, "color_led_title"
    ...
    :sswitch_2
    const-string v4, "gd_setting_title"
    ...
    :sswitch_4
    const-string v4, "color_game_led_title"
    ...
    :sswitch_5
    const-string v4, "multi_window_cvw_title"
    ...
    :sswitch_6
    const-string v4, "oldman_mode_settings"
    ...
    :sswitch_7
    const-string/jumbo v4, "title_special_features_health_global"
    ...
    :sswitch_8
    const-string v4, "miui_bubbles_notification"
    ...
    :sswitch_9
    const-string v4, "color_lamp_incall_pulse_title"
    ...
    :sswitch_a
    const-string v4, "freeform_guide_slide_to_small_freeform_title"
    ...
    :sswitch_b
    const-string v4, "color_lamp_title"
    ...
    :sswitch_c
    const-string v4, "color_lamp_battery_title"
    ...
    :sswitch_e
    const-string v4, "oldman_mode_entry_name"
    ...
    :sswitch_f
    const-string/jumbo v4, "video_tool_box_title"
    ...
    :sswitch_10
    const-string v4, "color_lamp_notification_pulse_title"
    ...
    :sswitch_12
    const-string v4, "beauty_fc_assistant"
    ...
    :sswitch_13
    const-string v4, "freeform_guide_move_title"
    ...
    :sswitch_14
    const-string v4, "freeform_guide_to_sidehide_title"
    ...
    const-string v3, "color_lamp_turn_on"

    const/4 v4, -0x2

    invoke-static {v1, v3, v0, v4}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method public initialize()Z
    ...
    :sswitch_1
    const-string v3, "miui_special_feature"
    ...
    :sswitch_4
    const-string/jumbo v3, "pref_edge_handgrip"
    ...
    :sswitch_6
    const-string/jumbo v3, "video_tool_box_title"
    ...
    :sswitch_7
    const-string/jumbo v3, "subscreen_title"
    ...
    :sswitch_8
    const-string/jumbo v3, "slider_title"
