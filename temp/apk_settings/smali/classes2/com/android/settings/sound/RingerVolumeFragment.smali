...
.method static constructor <clinit>()V
    ...
    .line 61
    sget v0, Lcom/android/settings/R$id;->ringer_section:I

    sget v1, Lcom/android/settings/R$id;->notification_section:I

    sget v2, Lcom/android/settings/R$id;->alarm_section:I

    sget v3, Lcom/android/settings/R$id;->voice_section:I

    sget v4, Lcom/android/settings/R$id;->media_section:I

    sget v5, Lcom/android/settings/R$id;->bluetooth_section:I

    filled-new-array/range {v0 .. v5}, [I

    move-result-object v0

    sput-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->SECTION_ID:[I
    ...
    sput-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->SEEKBAR_TYPE:[I

    .line 88
    sget v1, Lcom/android/settings/R$drawable;->ic_audio_ring_notif_mute:I

    sget v2, Lcom/android/settings/R$drawable;->ic_audio_notification_mute:I

    sget v3, Lcom/android/settings/R$drawable;->ic_audio_alarm_mute:I

    sget v4, Lcom/android/settings/R$drawable;->ic_audio_phone:I

    sget v5, Lcom/android/settings/R$drawable;->ic_audio_media:I

    sget v6, Lcom/android/settings/R$drawable;->ic_audio_bt_mute:I

    filled-new-array/range {v1 .. v6}, [I

    move-result-object v0

    sput-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->SEEKBAR_MUTED_RES_ID:[I

    move v7, v4

    .line 97
    sget v4, Lcom/android/settings/R$drawable;->ic_audio_ring_notif:I

    move v8, v5

    sget v5, Lcom/android/settings/R$drawable;->ic_audio_notification:I

    sget v6, Lcom/android/settings/R$drawable;->ic_audio_alarm:I

    sget v9, Lcom/android/settings/R$drawable;->ic_audio_bt:I
...
.method public constructor <init>()V
    ...
    .line 70
    sget v0, Lcom/android/settings/R$string;->volume_ring_description:I
    ...
    sget v3, Lcom/android/settings/R$string;->volume_voice_description:I

    sget v4, Lcom/android/settings/R$string;->volume_media_description:I

    sget v5, Lcom/android/settings/R$string;->volume_bluetooth_description:I
...
.method private updateSlidersAndMutedStates(I)V
    ...
    invoke-virtual {v1, p0}, Lmiuix/androidbasewidget/widget/SeekBar;->setProgress(I)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    new-instance v2, Lcom/android/settings/sound/RingerVolumeFragment$SeekBarVolumizer;
    ...
    .line 148
    iget-object p0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mSeekBarVolumizer:[Lcom/android/settings/sound/RingerVolumeFragment$SeekBarVolumizer;
    ...
    invoke-direct {v2, v3, v4, v5, v1}, Lcom/android/settings/sound/RingerVolumeFragment$SeekBarVolumizer;-><init>(Lcom/android/settings/sound/RingerVolumeFragment;Landroid/content/Context;Lmiuix/androidbasewidget/widget/SeekBar;I)V

    aput-object v2, p0, p2

    .line 153
    :goto_1
    sget p0, Lcom/android/settings/R$id;->mute_button:I
    ...
    .line 154
    iget-object v1, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mCheckBoxes:[Landroid/widget/ImageView;

    aput-object p0, v1, p2

    .line 157
    sget p0, Lcom/android/settings/R$id;->description_text:I
    ...
    iget-object v0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->DESCPTION_ID:[I
    ...
    .line 161
    invoke-direct {v3}, Lcom/android/settings/sound/RingerVolumeFragment;->updateSlidersAndMutedStates()V

    .line 164
    iget-object p0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mRingModeChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v0, v3}, Lcom/android/settings/sound/RingerVolumeFragment$2;-><init>(Lcom/android/settings/sound/RingerVolumeFragment;)V

    iput-object v0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mRingModeChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mRingModeChangedReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1, p0, p2}, Landroid/app/Activity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;

    .line 179
    :cond_2
    iget-object p0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mVolumeChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v0, v3}, Lcom/android/settings/sound/RingerVolumeFragment$3;-><init>(Lcom/android/settings/sound/RingerVolumeFragment;)V

    iput-object v0, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mVolumeChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, v3, Lcom/android/settings/sound/RingerVolumeFragment;->mVolumeChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 200
    sget p0, Lcom/android/settings/R$id;->ringer_section:I

    .line 201
    sget v0, Lcom/android/settings/R$id;->voice_section:I
    ...
    .line 202
    sget v0, Lcom/android/settings/R$id;->bluetooth_section:I
    ...
    .line 203
    sget v0, Lcom/android/settings/R$id;->alarm_section:I
    ...
    .line 205
    :cond_4
    sget p0, Lcom/android/settings/R$id;->notification_section:I
