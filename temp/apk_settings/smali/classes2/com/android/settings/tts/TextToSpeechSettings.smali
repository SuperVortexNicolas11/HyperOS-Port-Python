...
# direct methods
.method public static synthetic $r8$lambda$GF4CoQLklxoyZqJPzYHvBkzbPUU(Lcom/android/settings/tts/TextToSpeechSettings;)V
    .locals 0
...
.method public static synthetic $r8$lambda$JH-6G_u4EffDBrS5BgaCWixF4DA(Lcom/android/settings/tts/TextToSpeechSettings;Z)V
    .locals 0
...
.method public static synthetic $r8$lambda$i76UY586dT06LYDeEH1_UDSccuM(Ljava/text/Collator;Landroid/util/Pair;Landroid/util/Pair;)I
    .locals 0
...
.method private displayNetworkAlert()V
    ...
    sget v2, Lcom/android/settingslib/R$string;->tts_engine_network_required:I
...
.method private getDefaultSampleString()Ljava/lang/String;
    ...
    sget v2, Lcom/android/settingslib/R$array;->tts_demo_strings:I
    ...
    sget v3, Lcom/android/settingslib/R$array;->tts_demo_string_langs:I
    ...
    :catch_0
    :cond_1
    sget v0, Lcom/android/settingslib/R$string;->tts_default_sample_string:I
...
.method private initLargeFontMargin(Landroid/view/View;)V
    .locals 2
    ...
    sget v1, Lcom/android/settings/R$dimen;->paper_mode_view_padding_new:I
...
.method private setLocalePreference(I)V
    ...
    sget p1, Lcom/android/settingslib/R$string;->tts_lang_not_selected:I
...
.method private setTtsUtteranceProgressListener()V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/tts/TextToSpeechSettings$TtsSettingsUtteranceProgressListener;-><init>(Lcom/android/settings/tts/TextToSpeechSettings-IA;)V
...
.method private updateDefaultLocalePref(Landroid/content/Intent;)V
    ...
    sget v6, Lcom/android/settingslib/R$string;->tts_lang_use_system:I
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object p3, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mTtsPlay:Landroid/widget/Button;

    new-array v2, v1, [Lmiuix/animation/base/AnimConfig;

    invoke-interface {p1, p3, v2}, Lmiuix/animation/ITouchStyle;->handleTouchOf(Landroid/view/View;[Lmiuix/animation/base/AnimConfig;)V

    .line 273
    iget-object p1, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mTtsPlay:Landroid/widget/Button;

    new-instance p3, Lcom/android/settings/tts/TextToSpeechSettings$1;

    invoke-direct {p3, p0}, Lcom/android/settings/tts/TextToSpeechSettings$1;-><init>(Lcom/android/settings/tts/TextToSpeechSettings;)V
    ...
    iget-object p3, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mTtsReset:Landroid/widget/Button;
    ...
    new-instance p3, Lcom/android/settings/tts/TextToSpeechSettings$2;

    invoke-direct {p3, p0}, Lcom/android/settings/tts/TextToSpeechSettings$2;-><init>(Lcom/android/settings/tts/TextToSpeechSettings;)V
    ...
    invoke-direct {p1, p3, v2}, Landroid/speech/tts/TextToSpeech;-><init>(Landroid/content/Context;Landroid/speech/tts/TextToSpeech$OnInitListener;)V
    ...
    .line 293
    sget p1, Lcom/android/settings/R$id;->tts_button_lyt:I
    ...
    invoke-static {p3, p1}, Lcom/android/settings/MiuiUtils;->setupNavigationInsets(Landroid/app/Activity;Landroid/view/View;)V
    ...
    invoke-static {p3}, Lmiuix/core/util/MiuixUIUtils;->getFontLevel(Landroid/content/Context;)I
    ...
    .line 300
    iget-object v2, p0, Lcom/android/settings/tts/TextToSpeechSettings;->mTtsPlay:Landroid/widget/Button;
    ...
    .line 310
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/settings/tts/TextToSpeechSettings;->initLargeFontMargin(Landroid/view/View;)V
...
.method public onStart()V
    ...
    .line 334
    invoke-direct {p0}, Lcom/android/settings/tts/TextToSpeechSettings;->resetActionBarTitle()V
