...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/settings/network/TetheredRepository;->tetheredInterfacesFlow()Lkotlinx/coroutines/flow/Flow;
.end annotation
...
# direct methods
.method public static synthetic $r8$lambda$OUP_iI8wchPnnqj5K61du36-oDo(Lcom/android/settings/network/TetheredRepository;Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$callback$1;)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0, p1}, Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1;->invokeSuspend$lambda$0(Lcom/android/settings/network/TetheredRepository;Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$callback$1;)Lkotlin/Unit;
...
.method private static final invokeSuspend$lambda$0(Lcom/android/settings/network/TetheredRepository;Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$callback$1;)Lkotlin/Unit;
    .locals 0

    .line 66
    invoke-static {p0}, Lcom/android/settings/network/TetheredRepository;->access$getTetheringManager$p(Lcom/android/settings/network/TetheredRepository;)Landroid/net/TetheringManager;

    move-result-object p0

    invoke-virtual {p0, p1}, Landroid/net/TetheringManager;->unregisterTetheringEventCallback(Landroid/net/TetheringManager$TetheringEventCallback;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v4, Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$$ExternalSyntheticLambda0;

    invoke-direct {v4, v3, v1}, Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/network/TetheredRepository;Lcom/android/settings/network/TetheredRepository$tetheredInterfacesFlow$1$callback$1;)V
