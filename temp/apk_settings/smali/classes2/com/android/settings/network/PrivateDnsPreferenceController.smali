...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-static {v1}, Landroid/net/ConnectivitySettingsManager;->getPrivateDnsMode(Landroid/content/Context;)I

    move-result v1

    .line 143
    iget-object v2, p0, Lcom/android/settings/network/PrivateDnsPreferenceController;->mLatestLinkProperties:Landroid/net/LinkProperties;
    ...
    .line 144
    :cond_0
    invoke-virtual {v2}, Landroid/net/LinkProperties;->getValidatedPrivateDnsServers()Ljava/util/List;
    ...
    invoke-static {p0}, Landroid/net/ConnectivitySettingsManager;->getPrivateDnsHostname(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 156
    :cond_2
    sget p0, Lcom/android/settingslib/R$string;->private_dns_mode_provider_failure:I
    ...
    .line 151
    :cond_4
    sget p0, Lcom/android/settingslib/R$string;->private_dns_mode_opportunistic:I
    ...
    .line 148
    :cond_5
    sget p0, Lcom/android/settingslib/R$string;->private_dns_mode_off:I
