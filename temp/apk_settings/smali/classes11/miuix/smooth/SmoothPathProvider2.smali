...
.method public buildSmoothData(Landroid/graphics/RectF;[FFF)Lmiuix/smooth/SmoothPathProvider2$SmoothData;
    ...
    .line 63
    new-instance v4, Lmiuix/smooth/SmoothPathProvider2$SmoothData;
    ...
    .line 95
    invoke-direct {v2, v10}, Lmiuix/smooth/SmoothPathProvider2;->ensureFourCornerData(Lmiuix/smooth/SmoothPathProvider2$SmoothData;)V

    .line 96
    iget-object v2, v10, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    .line 97
    iget-object v1, v10, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    .line 98
    iget-object v1, v10, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    .line 99
    iget-object v1, v10, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;
...
.method public getSmoothPath(Landroid/graphics/Path;Lmiuix/smooth/SmoothPathProvider2$SmoothData;)Landroid/graphics/Path;
    ...
    .line 300
    :cond_1
    invoke-direct {p0, p2}, Lmiuix/smooth/SmoothPathProvider2;->isFourCornerDataValid(Lmiuix/smooth/SmoothPathProvider2$SmoothData;)Z
    ...
    iget v1, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->width:F

    iget p2, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->height:F

    invoke-direct {p0, p1, p1, v1, p2}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    .line 305
    :cond_2
    iget-object p0, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;

    iget v1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->swapAngle:F
    ...
    .line 306
    iget-object v1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->rect:Landroid/graphics/RectF;

    const-wide v2, 0x400921fb54442d18L    # Math.PI

    iget-wide v4, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->thetaForVertical:D
    ...
    iget-object v2, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;

    iget v2, v2, Lmiuix/smooth/SmoothPathProvider2$CornerData;->swapAngle:F

    .line 306
    invoke-virtual {v0, v1, p0, v2}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FF)V

    goto :goto_0

    .line 310
    :cond_3
    iget-object p0, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->bezierAnchorHorizontal:[Landroid/graphics/PointF;
    ...
    iget-wide v1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->smoothForHorizontal:D
    ...
    iget v2, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->radius:F

    iget-object p0, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;

    iget v3, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->radius:F

    iget-wide v4, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->smooth:D

    iget v6, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->ksi:F

    invoke-static/range {v1 .. v6}, Lmiuix/smooth/SmoothPathProvider2;->isWidthCollapsed(FFFDF)Z
    ...
    iget-wide v4, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->thetaForHorizontal:D
    ...
    iget-object v2, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    iget-wide v1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->smoothForVertical:D
    ...
    .line 336
    iget-object p0, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->bezierAnchorVertical:[Landroid/graphics/PointF;
    ...
    .line 341
    :cond_8
    iget v1, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->height:F

    iget-object p0, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->topRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;

    iget v2, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->radius:F

    iget-object p0, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    invoke-static/range {v1 .. v6}, Lmiuix/smooth/SmoothPathProvider2;->isHeightCollapsed(FFFDF)Z
    ...
    iget-wide v2, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->thetaForVertical:D
    ...
    iget-object v2, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomRight:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    iget-object p0, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;
    ...
    .line 374
    iget-object p1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->rect:Landroid/graphics/RectF;

    const-wide v1, 0x3ff921fb54442d18L    # 1.5707963267948966

    iget-wide v3, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->thetaForHorizontal:D
    ...
    iget-object v1, p2, Lmiuix/smooth/SmoothPathProvider2$SmoothData;->bottomLeft:Lmiuix/smooth/SmoothPathProvider2$CornerData;

    iget v1, v1, Lmiuix/smooth/SmoothPathProvider2$CornerData;->swapAngle:F

    .line 374
    invoke-virtual {v0, p1, p0, v1}, Landroid/graphics/Path;->arcTo(Landroid/graphics/RectF;FF)V
    ...
    iget-wide p1, p0, Lmiuix/smooth/SmoothPathProvider2$CornerData;->smoothForVertical:D

    cmpl-double p1, p1, v8
