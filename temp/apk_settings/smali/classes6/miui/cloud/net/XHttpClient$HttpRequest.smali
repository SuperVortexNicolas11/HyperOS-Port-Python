...
.method public doHttpRequest()V
    ...
    .line 315
    :try_start_0
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mUrl:Ljava/lang/String;
    ...
    iput v4, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->stateCode:I

    .line 317
    const-string v4, "TEST OK"

    iput-object v4, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->stateMessage:Ljava/lang/String;

    .line 318
    iget-object v4, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mHeader:Ljava/util/Map;

    iput-object v4, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->headers:Ljava/util/Map;

    .line 319
    iget-object v4, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mData:Ljava/lang/Object;

    iput-object v4, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->content:Ljava/lang/Object;
    :try_end_0
    ...
    .line 330
    :try_start_3
    invoke-direct {p0, v4}, Lmiui/cloud/net/XHttpClient$HttpRequest;->prepareConn(Ljava/net/URLConnection;)V

    .line 332
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mMethod:Ljava/lang/String;

    invoke-virtual {v4, v0}, Ljava/net/HttpURLConnection;->setRequestMethod(Ljava/lang/String;)V

    .line 333
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mHeader:Ljava/util/Map;

    invoke-direct {p0, v4, v0}, Lmiui/cloud/net/XHttpClient$HttpRequest;->setRequestHeader(Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    ...
    .line 339
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mData:Ljava/lang/Object;
    ...
    .line 342
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mSendDataProcessor:Lmiui/cloud/net/XHttpClient$ISendDataProcessor;

    iget-object v5, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mData:Ljava/lang/Object;

    .line 343
    invoke-interface {v0, v5}, Lmiui/cloud/net/XHttpClient$ISendDataProcessor;->getOutDataLength(Ljava/lang/Object;)I
    ...
    invoke-interface {v0, v6, v5}, Lmiui/cloud/net/XHttpClient$ISendDataProcessor;->processOutData(Ljava/lang/Object;Ljava/io/OutputStream;)V
    :try_end_4
    ...
    iput v5, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->stateCode:I
    ...
    iput-object v5, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->stateMessage:Ljava/lang/String;
    ...
    iput-wide v5, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->contentLength:J
    ...
    iput-object v5, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->headers:Ljava/util/Map;

    .line 364
    invoke-virtual {v4}, Ljava/net/HttpURLConnection;->getDate()J
    ...
    :goto_2
    iput-object v1, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->date:Ljava/util/Date;
    ...
    .line 370
    :try_start_6
    iget-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mReceiveDataProcessor:Lmiui/cloud/net/XHttpClient$IReceiveDataProcessor;
    ...
    invoke-static {v0}, Lmiui/cloud/net/XHttpClient;->access$100(Lmiui/cloud/net/XHttpClient;)Lmiui/cloud/net/XHttpClient$DataProcessorFactor;
    ...
    .line 372
    invoke-virtual {v0, v5, v1}, Lmiui/cloud/net/XHttpClient$DataProcessorFactor;->getReceiveDataProcessor(Ljava/util/Map;Ljava/io/InputStream;)Lmiui/cloud/net/XHttpClient$IReceiveDataProcessor;

    move-result-object v0

    iput-object v0, p0, Lmiui/cloud/net/XHttpClient$HttpRequest;->mReceiveDataProcessor:Lmiui/cloud/net/XHttpClient$IReceiveDataProcessor;
    ...
    iget-object v6, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->headers:Ljava/util/Map;

    invoke-interface {v5, v6, v1}, Lmiui/cloud/net/XHttpClient$IReceiveDataProcessor;->processInData(Ljava/util/Map;Ljava/io/InputStream;)Ljava/lang/Object;

    move-result-object v5

    iput-object v5, v0, Lmiui/cloud/net/XHttpClient$HttpResponse;->content:Ljava/lang/Object;
    :try_end_6
    ...
    iput-object v0, v4, Lmiui/cloud/net/XHttpClient$HttpResponse;->error:Ljava/lang/Exception;
    ...
    invoke-virtual {v10, v0}, Lcom/xiaomi/micloudsdk/stat/MiCloudNetEventStatInjector;->addNetSuccessEvent(Lcom/xiaomi/micloudsdk/stat/NetSuccessStatParam;)V
    ...
    invoke-virtual {v8, v0}, Lcom/xiaomi/micloudsdk/stat/MiCloudNetEventStatInjector;->addNetFailedEvent(Lcom/xiaomi/micloudsdk/stat/NetFailedStatParam;)V
    ...
    invoke-interface {v1, p0}, Lmiui/cloud/net/XHttpClient$IResponseHandler;->handleHttpResponse(Lmiui/cloud/net/XHttpClient$HttpResponse;)V
