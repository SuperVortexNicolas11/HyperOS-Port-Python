...
.method private getLabel(JII)Ljava/lang/CharSequence;
    ...
    .line 283
    invoke-virtual {v0, p1, p2}, Lcom/android/settings/datausage/lib/DataUsageFormatter;->formatDataUsageWithUnits(J)Lcom/android/settingslib/spaprivileged/framework/common/BytesFormatter$Result;
    ...
    .line 285
    invoke-virtual {p1}, Lcom/android/settingslib/spaprivileged/framework/common/BytesFormatter$Result;->getNumber()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/settingslib/spaprivileged/framework/common/BytesFormatter$Result;->getUnits()Ljava/lang/String;
...
.method private synthetic lambda$getDensedStatsData$0(Ljava/util/List;Ljava/lang/Integer;Ljava/util/List;)V
    ...
    .line 202
    invoke-virtual {v1, p2}, Lcom/android/settings/datausage/ChartDataUsagePreference$DataUsageSummaryNode;->setFromMultiNode(Z)V
...
.method private setupContentDescription(Lcom/android/settings/widget/UsageView;Ljava/util/List;)V
    ...
    invoke-static {v0, v2, v3, v7}, Landroid/text/format/DateUtils;->formatDateTime(Landroid/content/Context;JI)Ljava/lang/String;

    move-result-object v2

    .line 132
    iget-object v3, p0, Lcom/android/settings/datausage/ChartDataUsagePreference;->mResources:Landroid/content/res/Resources;

    sget v4, Lcom/android/settings/R$string;->data_usage_chart_brief_content_description:I
    ...
    .line 140
    invoke-virtual {p1, v6}, Landroid/widget/FrameLayout;->setContentDescription(Ljava/lang/CharSequence;)V
...
.method getDensedStatsData(Ljava/util/List;)Ljava/util/List;
    ...
    .line 181
    new-instance v9, Lcom/android/settings/datausage/ChartDataUsagePreference$DataUsageSummaryNode;
    ...
    invoke-direct {v2, v10, v1}, Lcom/android/settings/datausage/ChartDataUsagePreference$$ExternalSyntheticLambda2;-><init>(Lcom/android/settings/datausage/ChartDataUsagePreference;Ljava/util/List;)V
