...
.method static constructor <clinit>()V
    ...
    .line 49
    const-string v31, "LTE B40"

    const-string v32, "LTE B41"

    const-string v1, "LTE B1 Preferred"

    const-string v2, "LTE B2 Preferred"

    const-string v3, "LTE B3 Preferred"

    const-string v4, "LTE B4 Preferred"

    const-string v5, "LTE B5 Preferred"

    const-string v6, "LTE B7 Preferred"

    const-string v7, "LTE B8 Preferred"

    const-string v8, "LTE B20 Preferred"

    const-string v9, "LTE B28 Preferred"

    const-string v10, "LTE B38 Preferred"

    const-string v11, "LTE B40 Preferred"

    const-string v12, "LTE B41 Preferred"

    const-string v13, "GSM 900"

    const-string v14, "GSM 1800"

    const-string v15, "GSM 1900"

    const-string v16, "WCDMA I 2100"

    const-string v17, "WCDMA II 1900"

    const-string v18, "WCDMA IV 1700"

    const-string v19, "WCDMA V 850"

    const-string v20, "WCDMA V VIII 900"

    const-string v21, "LTE B1"

    const-string v22, "LTE B2"

    const-string v23, "LTE B3"

    const-string v24, "LTE B4"

    const-string v25, "LTE B5"

    const-string v26, "LTE B7"

    const-string v27, "LTE B8"

    const-string v28, "LTE B20"

    const-string v29, "LTE B28"

    const-string v30, "LTE B38"
...
.method private handleBandsSet()V
    ...
    .line 238
    iget-object v4, v0, Lcom/android/settings/MiuiBandMode;->mBandsToSet:Ljava/util/ArrayList;
    ...
    check-cast v11, Lcom/android/settings/MiuiBandMode$BandListItem;

    .line 239
    iget v13, v11, Lcom/android/settings/MiuiBandMode$BandListItem;->mPosition:I

    .line 240
    iget-wide v14, v11, Lcom/android/settings/MiuiBandMode$BandListItem;->mBandMode:J
    ...
    const-string v2, "handleBandsSet  position:"
    ...
    invoke-virtual {v11}, Lcom/android/settings/MiuiBandMode$BandListItem;->toString()Ljava/lang/String;
    ...
    const-string v11, "handleBandsSet LtePrefBandMode "
    ...
    .line 262
    :cond_3
    iget-object v2, v0, Lcom/android/settings/MiuiBandMode;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v2}, Lcom/android/internal/telephony/Phone;->getPhoneId()I

    move-result v2

    invoke-static {v1, v2}, Lcom/android/settings/VendorUtils;->setLteBandPref([II)Z
    ...
    .line 267
    iget-object v0, v0, Lcom/android/settings/MiuiBandMode;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v0}, Lcom/android/internal/telephony/Phone;->getPhoneId()I

    move-result v0

    invoke-static {v1, v0}, Lcom/android/settings/VendorUtils;->setXiaomiBandMode([JI)Z
    ...
    const-string v1, "handleBandsSet gwBand "
...
.method private resetBands()V
    ...
    .line 210
    :goto_0
    sget-object v5, Lcom/android/settings/MiuiBandMode;->BAND_VALUES:[J
    ...
    invoke-direct {v2, p0, v0, v4, v5}, Lcom/android/settings/MiuiBandMode$2;-><init>(Lcom/android/settings/MiuiBandMode;Z[I[J)V
