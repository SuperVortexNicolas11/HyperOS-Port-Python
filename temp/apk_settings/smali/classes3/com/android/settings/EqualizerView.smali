...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 130
    new-instance v3, Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-direct {v3, v7, v5}, Lcom/android/settings/EqualizerView$Complex;-><init>(FF)V

    .line 133
    invoke-virtual {v3, v2}, Lcom/android/settings/EqualizerView$Complex;->mul(F)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v6, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v7, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v8, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v10, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v11, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v12, v3}, Lcom/android/settings/EqualizerView$Biquad;->evaluateTransfer(Lcom/android/settings/EqualizerView$Complex;)Lcom/android/settings/EqualizerView$Complex;
    ...
    invoke-virtual {v6}, Lcom/android/settings/EqualizerView$Complex;->rho()F
    ...
    invoke-virtual {v8}, Lcom/android/settings/EqualizerView$Complex;->rho()F
    ...
    invoke-virtual {v11}, Lcom/android/settings/EqualizerView$Complex;->rho()F
    ...
    invoke-direct {v0, v5}, Lcom/android/settings/EqualizerView;->lin2dB(F)F
    ...
    iget v6, v0, Lcom/android/settings/EqualizerView;->mWidth:I

    int-to-float v7, v6

    mul-float/2addr v5, v7

    cmpl-float v7, v13, v18
    ...
    .line 148
    invoke-direct {v0, v6}, Lcom/android/settings/EqualizerView;->setPanitAlpha(F)V
    ...
    .line 155
    iget v6, v0, Lcom/android/settings/EqualizerView;->mCurveShadowColor:I
    ...
    iget v8, v0, Lcom/android/settings/EqualizerView;->mCurveShadowRadius:F
    ...
    add-float v24, v7, v13

    iget v7, v0, Landroid/view/View;->mPaddingTop:I

    int-to-float v8, v7

    add-float v25, v8, v14
