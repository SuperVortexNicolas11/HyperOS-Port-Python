...
# direct methods
.method public static synthetic $r8$lambda$0tPIH103nHhODyF7JAwZb0vN7Sg(Lcom/android/settings/dashboard/DashboardFragment;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/dashboard/DashboardFragment;->lambda$refreshDashboardTiles$11(Lcom/android/settings/dashboard/DynamicDataObserver;)V

    return-void
.end method

.method public static synthetic $r8$lambda$6_mjvaB8SreP6z5AICVHD2eqlpw(Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/core/BasePreferenceController;)V
    .locals 1
...
.method public static synthetic $r8$lambda$FoNN9XT4zSi949kcei6NmpgdpGI(Lcom/android/settings/core/BasePreferenceController;)V
    .locals 1
...
.method public static synthetic $r8$lambda$J0cjhaqraLkSazAuZFx17OX4Fhc(Ljava/lang/Class;Lcom/android/settingslib/core/AbstractPreferenceController;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$P132F5LiEB8I4lgw8ljcpGi1OyA(Lcom/android/settingslib/drawer/Tile;)I
    .locals 1
...
.method public static synthetic $r8$lambda$RHkhmI0Nx6gjZ6g75t06V83Dlh4(Lcom/android/settings/dashboard/DashboardFragment;Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/settings/dashboard/DashboardFragment;->lambda$unregisterDynamicDataObservers$14(Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V

    return-void
.end method

.method public static synthetic $r8$lambda$bl5y84BjkU1V5p_2MS5gk70M2Zs(Lcom/android/settings/dashboard/DashboardFragment;Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0
...
.method public static synthetic $r8$lambda$ctoZwg-IKe2TeCBEvUw2Aaf_RrY(Lcom/android/settings/dashboard/DashboardFragment;Ljava/util/List;Ljava/util/concurrent/CountDownLatch;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/settings/dashboard/DashboardFragment;->lambda$refreshDashboardTiles$12(Ljava/util/List;Ljava/util/concurrent/CountDownLatch;)V

    return-void
.end method

.method public static synthetic $r8$lambda$dDe5dPF5HTZIK0vhaEhF0LjjiOk(Lcom/android/settings/dashboard/DashboardFragment;Lcom/android/settingslib/core/AbstractPreferenceController;)Landroidx/preference/Preference;
    .locals 0
...
.method public static synthetic $r8$lambda$lYnA8H4BHWUMp5SXnB4s-pNegho(Lcom/android/settings/dashboard/DashboardFragment;Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/settings/dashboard/DashboardFragment;->lambda$registerDynamicDataObservers$13(Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
...
.method public static synthetic $r8$lambda$q1bEt3s_brmPK9xPCGGJJv8OeVk(Lcom/android/settings/dashboard/DashboardFragment;Ljava/util/List;Ljava/util/List;Lcom/android/settingslib/core/AbstractPreferenceController;)V
    .locals 0
...
.method public static synthetic $r8$lambda$tXE0JOu6lKx-SbUGiwcAsg1HE-w(Landroidx/preference/PreferenceScreen;Lcom/android/settingslib/core/AbstractPreferenceController;)V
    .locals 0
...
.method public static synthetic $r8$lambda$uYFPetWJqb7YyU-u_s-9fy2heL8(Lcom/android/settings/dashboard/DashboardFragment;Landroidx/preference/Preference;)V
    .locals 0
...
.method public static synthetic $r8$lambda$zp4hot2XxC1suWOgUr-tgLk5Gm4(ILcom/android/settingslib/core/AbstractPreferenceController;)V
    .locals 1
...
.method private displayResourceTiles()V
    ...
    .line 411
    invoke-interface {v0}, Lcom/android/settingslib/metadata/PreferenceScreenMetadata;->hasCompleteHierarchy()Z
    ...
    .line 412
    invoke-direct {p0}, Lcom/android/settings/dashboard/DashboardFragment;->removeControllersForHybridMode()V
    ...
    .line 426
    :goto_0
    invoke-virtual {p0, v1}, Lcom/android/settings/dashboard/DashboardFragment;->displayResourceTilesToScreen(Landroidx/preference/PreferenceScreen;)V
...
.method private synthetic lambda$checkUiBlocker$4(Ljava/util/List;)V
    ...
    .line 179
    new-instance p0, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda16;

    invoke-direct {p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda16;-><init>()V
...
.method private synthetic lambda$refreshDashboardTiles$11(Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0
...
.method private synthetic lambda$refreshDashboardTiles$12(Ljava/util/List;Ljava/util/concurrent/CountDownLatch;)V
    .locals 1

    .line 713
    new-instance v0, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda17;

    invoke-direct {v0, p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda17;-><init>(Lcom/android/settings/dashboard/DashboardFragment;)V
...
.method private synthetic lambda$registerDynamicDataObservers$13(Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 0
...
.method private synthetic lambda$unregisterDynamicDataObservers$14(Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    .locals 2
    ...
    const-string v0, "Cannot unregister observer: "
...
.method private refreshDashboardTiles(Ljava/lang/String;)V
    ...
    .line 612
    new-instance v4, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda3;

    invoke-direct {v4}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda3;-><init>()V
    ...
    .line 625
    :cond_3
    invoke-virtual {v9}, Lcom/android/settingslib/drawer/Tile;->getMetaData()Landroid/os/Bundle;
    ...
    .line 629
    const-class v4, Lcom/android/settings/security/SecuritySettings;
    ...
    .line 630
    const-string/jumbo v4, "security_status"

    invoke-virtual {v9, v4}, Lcom/android/settingslib/drawer/Tile;->setGroupKey(Ljava/lang/String;)V

    .line 635
    :cond_4
    const-class v4, Lcom/android/settings/security/SecurityAdvancedSettings;
    ...
    .line 636
    const-string/jumbo v4, "security_advanced_category"
    ...
    .line 642
    invoke-virtual {v0, v10}, Landroidx/preference/PreferenceGroup;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
    ...
    .line 648
    invoke-virtual {v6, v9}, Lcom/android/settings/dashboard/DashboardFragment;->createPreference(Lcom/android/settingslib/drawer/Tile;)Landroidx/preference/Preference;

    move-result-object v8

    .line 649
    iget-object v4, v6, Lcom/android/settings/dashboard/DashboardFragment;->mDashboardFeatureProvider:Lcom/android/settings/dashboard/DashboardFeatureProvider;
    ...
    iget-object p0, v6, Lcom/android/settings/dashboard/DashboardFragment;->mPlaceholderPreferenceController:Lcom/android/settings/dashboard/DashboardTilePlaceholderPreferenceController;

    .line 651
    invoke-virtual {p0}, Lcom/android/settings/dashboard/DashboardTilePlaceholderPreferenceController;->getOrder()I
    ...
    .line 657
    invoke-virtual {v9}, Lcom/android/settingslib/drawer/Tile;->hasGroupKey()Z
    ...
    .line 658
    invoke-virtual {v9}, Lcom/android/settingslib/drawer/Tile;->getGroupKey()Ljava/lang/String;
    ...
    .line 662
    invoke-virtual {v4, v12}, Landroidx/preference/Preference;->setVisible(Z)V
    ...
    .line 683
    :goto_1
    invoke-virtual {v6, p0}, Lcom/android/settings/dashboard/DashboardFragment;->registerDynamicDataObservers(Ljava/util/List;)V

    .line 684
    iget-object v4, v6, Lcom/android/settings/dashboard/DashboardFragment;->mDashboardTilePrefKeys:Landroid/util/ArrayMap;

    invoke-virtual {v4, v10, p0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, v9}, Lcom/android/settings/dashboard/DashBoardTileInjector;->setTileSummary(Landroid/content/Context;Lcom/android/settingslib/drawer/Tile;)V
    ...
    .line 699
    invoke-virtual {v0, v2}, Landroidx/preference/PreferenceGroup;->removePreferenceRecursively(Ljava/lang/CharSequence;)Z
    ...
    invoke-direct {v6, v1}, Lcom/android/settings/dashboard/DashboardFragment;->unregisterDynamicDataObservers(Ljava/util/List;)V
    ...
    invoke-direct {p0, v12}, Ljava/util/concurrent/CountDownLatch;-><init>(I)V

    .line 712
    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda4;

    invoke-direct {v1, v6, v3, p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda4;-><init>(Lcom/android/settings/dashboard/DashboardFragment;Ljava/util/List;Ljava/util/concurrent/CountDownLatch;)V
    ...
    .line 717
    const-string v0, "Start waiting observers"

    invoke-static {p1, v0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 718
    invoke-direct {v6, p0}, Lcom/android/settings/dashboard/DashboardFragment;->awaitObserverLatch(Ljava/util/concurrent/CountDownLatch;)V

    .line 719
    const-string p0, "Stop waiting observers"
    ...
    invoke-direct {p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda5;-><init>()V

    invoke-interface {v3, p0}, Ljava/util/List;->forEach(Ljava/util/function/Consumer;)V
...
.method private registerDynamicDataObserver(Landroid/content/ContentResolver;Lcom/android/settings/dashboard/DynamicDataObserver;)V
    ...
    const-string v0, "Cannot register observer: "
...
.method private removeControllersForHybridMode()V
    .locals 7

    .line 437
    invoke-virtual {p0}, Lcom/android/settingslib/preference/PreferenceFragment;->getPreferenceKeysInHierarchy()Ljava/util/Set;
    ...
    const-string v6, "Remove preference controller for "
    ...
    .line 446
    iget-object v4, p0, Lcom/android/settings/dashboard/DashboardFragment;->mPreferenceControllers:Ljava/util/Map;
    ...
    .line 451
    :cond_1
    instance-of v4, v3, Landroidx/lifecycle/LifecycleObserver;
    ...
    invoke-virtual {v2, v3}, Lcom/android/settingslib/core/lifecycle/Lifecycle;->removeObserver(Landroidx/lifecycle/LifecycleObserver;)V
...
.method private unregisterDynamicDataObservers(Ljava/util/List;)V
    ...
    .line 789
    new-instance v1, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0, v0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda2;-><init>(Lcom/android/settings/dashboard/DashboardFragment;Landroid/content/ContentResolver;)V
...
.method checkUiBlocker(Ljava/util/List;)V
    ...
    invoke-direct {v2, p0, v0, v1}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda8;-><init>(Lcom/android/settings/dashboard/DashboardFragment;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda9;-><init>(Lcom/android/settings/dashboard/DashboardFragment;Ljava/util/List;)V
...
.method protected displayResourceTilesToScreen(Landroidx/preference/PreferenceScreen;)V
    ...
    invoke-direct {v0, p1}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda6;-><init>(Landroidx/preference/PreferenceScreen;)V
...
.method public onCreatePreferences(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda10;-><init>(Lcom/android/settings/dashboard/DashboardFragment;)V
    ...
    invoke-direct {v1}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda11;-><init>()V
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda12;-><init>(Lcom/android/settings/dashboard/DashboardFragment;)V
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    const-string p1, "No activity to start for "
    ...
    .line 289
    invoke-virtual {v3, p1}, Lcom/android/settingslib/core/AbstractPreferenceController;->handlePreferenceTreeClick(Landroidx/preference/Preference;)Z
...
.method public onStart()V
    ...
    invoke-direct {v2}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda0;-><init>()V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda1;-><init>(Lcom/android/settings/dashboard/DashboardFragment;Landroid/content/ContentResolver;)V
...
.method protected useGroup(Ljava/lang/Class;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    new-instance v0, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda7;

    invoke-direct {v0, p1}, Lcom/android/settings/dashboard/DashboardFragment$$ExternalSyntheticLambda7;-><init>(Ljava/lang/Class;)V
