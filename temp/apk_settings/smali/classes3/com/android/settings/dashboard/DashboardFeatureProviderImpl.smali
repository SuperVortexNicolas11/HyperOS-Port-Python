...
# static fields
.field private static final COLOR_SCHEMES:Ljava/util/Map;
...
.method public static synthetic $r8$lambda$piHfQlpd7MGydgzL5Qv44XCk9tU(Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
    .locals 0

    .line 0
    invoke-direct/range {p0 .. p5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->lambda$bindIcon$11(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
...
.method static constructor <clinit>()V
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_blue_variant_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_blue_variant_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_blue_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_blue_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_pink_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_pink_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_orange_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_orange_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_yellow_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_yellow_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_green_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_green_bg:I
    ...
    sget v0, Lcom/android/settings/R$color;->homepage_grey_fg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_grey_bg:I
    ...
    sget v1, Lcom/android/settings/R$color;->homepage_cyan_fg:I
    ...
    sget v3, Lcom/android/settings/R$color;->homepage_cyan_bg:I
    ...
    sget v3, Lcom/android/settings/R$color;->homepage_red_fg:I
    ...
    sget v5, Lcom/android/settings/R$color;->homepage_red_bg:I
    ...
    sget v5, Lcom/android/settings/R$color;->homepage_purple_fg:I
    ...
    sget v7, Lcom/android/settings/R$color;->homepage_purple_bg:I
    ...
    const-string/jumbo v17, "red"

    const-string/jumbo v19, "purple"
    ...
    sput-object v0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->COLOR_SCHEMES:Ljava/util/Map;
...
.method private getExpressiveHomepageIcon(Lcom/android/settingslib/drawer/Tile;Landroid/graphics/drawable/Drawable;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    .locals 2

    .line 508
    invoke-virtual {p1}, Lcom/android/settingslib/drawer/Tile;->getGroupKey()Ljava/lang/String;

    move-result-object v0

    const-string/jumbo v1, "top_level_account_category"
    ...
    sget p2, Lcom/android/settings/R$dimen;->dashboard_tile_image_size:I
    ...
    .line 518
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->getSchemedColors(Lcom/android/settingslib/drawer/Tile;)Landroid/util/Pair;
    ...
    invoke-direct {p0, p2, p3, p1}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->getRoundedIcon(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method private getRoundedIcon(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    .line 529
    new-instance p2, Lcom/android/settingslib/widget/AdaptiveIcon;

    iget-object v0, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->mContext:Landroid/content/Context;

    invoke-direct {p2, v0, p1}, Lcom/android/settingslib/widget/AdaptiveIcon;-><init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p2, p0}, Lcom/android/settingslib/widget/AdaptiveIcon;->setBackgroundColor(I)V
...
.method private synthetic lambda$bindIcon$11(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
    .locals 0

    .line 458
    invoke-direct/range {p0 .. p5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->setPreferenceIcon(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
...
.method private synthetic lambda$bindIcon$12(Lcom/android/settingslib/drawer/Tile;Landroidx/preference/Preference;Z)V
    ...
    invoke-static {p1, v3, v4}, Lcom/android/settingslib/drawer/TileUtils;->getCompleteUri(Lcom/android/settingslib/drawer/Tile;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v4, v0, v3, v1}, Lcom/android/settingslib/drawer/TileUtils;->getIconFromUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Ljava/util/Map;)Landroid/util/Pair;
    ...
    invoke-static {v4, v3, v1}, Lcom/android/settingslib/drawer/TileUtils;->getRawIconFromUri(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Map;)Landroid/graphics/drawable/Icon;
    ...
    .line 457
    new-instance v4, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl$$ExternalSyntheticLambda1;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl$$ExternalSyntheticLambda1;-><init>(Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
...
.method private synthetic lambda$bindPreferenceToTileAndGetObservers$1(Lcom/android/settings/dashboard/DashboardFragment;Ljava/lang/String;Landroidx/fragment/app/FragmentActivity;Lcom/android/settingslib/drawer/Tile;Landroid/content/Intent;ILandroidx/preference/Preference;)Z
    ...
    .line 228
    :goto_1
    invoke-direct/range {p0 .. p6}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->launchIntentOrSelectProfile(Landroidx/fragment/app/FragmentActivity;Lcom/android/settingslib/drawer/Tile;Landroid/content/Intent;ILcom/android/settings/homepage/TopLevelHighlightMixin;Z)V
...
.method private launchIntentOrSelectProfile(Landroidx/fragment/app/FragmentActivity;Lcom/android/settingslib/drawer/Tile;Landroid/content/Intent;ILcom/android/settings/homepage/TopLevelHighlightMixin;Z)V
    ...
    invoke-static/range {p1 .. p6}, Lcom/android/settings/dashboard/profileselector/ProfileSelectDialog;->show(Landroidx/fragment/app/FragmentManager;Lcom/android/settingslib/drawer/Tile;ILandroid/content/DialogInterface$OnShowListener;Landroid/content/DialogInterface$OnDismissListener;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p0, p3, p2}, Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;->logStartedIntent(Landroid/content/Intent;I)Z
...
.method private setPreferenceIcon(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLjava/lang/String;Landroid/graphics/drawable/Icon;)V
    ...
    .line 485
    invoke-direct {p0, p2, p5, p4}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->getExpressiveHomepageIcon(Lcom/android/settingslib/drawer/Tile;Landroid/graphics/drawable/Drawable;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 489
    :cond_1
    invoke-virtual {p2}, Lcom/android/settingslib/drawer/Tile;->getGroupKey()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/settings/Utils;->getHomepageIconColor(Landroid/content/Context;)I

    move-result v0

    invoke-virtual {p5, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V
...
.method public bindPreferenceToTileAndGetObservers(Landroidx/fragment/app/FragmentActivity;Lcom/android/settings/dashboard/DashboardFragment;ZLandroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 166
    invoke-virtual {v1, v5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->getDashboardKeyForTile(Lcom/android/settingslib/drawer/Tile;)Ljava/lang/String;
    ...
    .line 169
    invoke-direct {v1, v8, v5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->bindTitleAndGetObserver(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;)Lcom/android/settings/dashboard/DynamicDataObserver;
    ...
    .line 173
    :cond_2
    invoke-direct {v1, v8, v5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->bindSummaryAndGetObserver(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;)Lcom/android/settings/dashboard/DynamicDataObserver;
    ...
    .line 177
    :cond_3
    invoke-direct {v1, v8, v5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->bindSwitchAndGetObserver(Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;)Lcom/android/settings/dashboard/DynamicDataObserver;
    ...
    .line 184
    :cond_4
    invoke-virtual {v5}, Lcom/android/settingslib/drawer/Tile;->hasPendingIntent()Z
    ...
    invoke-direct {v0, v1, v4, v5, v2}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl$$ExternalSyntheticLambda2;-><init>(Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;Landroidx/fragment/app/FragmentActivity;Lcom/android/settingslib/drawer/Tile;Lcom/android/settings/dashboard/DashboardFragment;)V
    ...
    .line 191
    instance-of v0, v5, Lcom/android/settingslib/drawer/ActivityTile;
    ...
    .line 193
    invoke-virtual {v5}, Lcom/android/settingslib/drawer/Tile;->getMetaData()Landroid/os/Bundle;
    ...
    .line 198
    const-string v12, "com.android.settings.intent.action"
    ...
    .line 201
    invoke-virtual {v8, v6}, Landroidx/preference/Preference;->setFragment(Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/drawer/Tile;->getIntent()Landroid/content/Intent;
    ...
    .line 204
    const-string v12, ":settings:source_metrics"
    ...
    .line 210
    :cond_8
    instance-of v12, v2, Lcom/android/settings/homepage/TopLevelSettings;

    if-eqz v12, :cond_9

    .line 211
    iget-object v12, v1, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->mContext:Landroid/content/Context;

    new-instance v13, Landroid/content/ComponentName;

    .line 213
    invoke-virtual {v5}, Lcom/android/settingslib/drawer/Tile;->getPackageName()Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v5}, Lcom/android/settingslib/drawer/Tile;->getComponentName()Ljava/lang/String;
    ...
    .line 211
    invoke-static {v12, v13, v0, v14}, Lcom/android/settings/activityembedding/ActivityEmbeddingRulesController;->registerTwoPanePairRuleForSettingsHome(Landroid/content/Context;Landroid/content/ComponentName;Ljava/lang/String;Z)V

    .line 217
    :cond_9
    new-instance v0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl$$ExternalSyntheticLambda3;
...
.method getSchemedColors(Lcom/android/settingslib/drawer/Tile;)Landroid/util/Pair;
    .locals 2
    ...
    invoke-virtual {p1, p0}, Lcom/android/settingslib/drawer/Tile;->getIconColorScheme(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 542
    :cond_0
    sget-object p1, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->COLOR_SCHEMES:Ljava/util/Map;
    ...
    const-string v1, "Invalid color scheme: "
