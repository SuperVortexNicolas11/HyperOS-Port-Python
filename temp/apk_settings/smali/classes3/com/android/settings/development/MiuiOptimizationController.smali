...
.method private revokeHuanjiRuntimePermission()V
    ...
    .line 286
    invoke-virtual {p0, v3, v0, v4}, Landroid/content/pm/PackageManager;->revokeRuntimePermission(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)V

    .line 288
    invoke-virtual {p0, v1, v0, v4}, Landroid/content/pm/PackageManager;->revokeRuntimePermission(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private writeMiuiOptimizationOptions(Ljava/lang/Object;)V
    ...
    sget v2, Lcom/android/settings/R$string;->open_miui_optimization_title:I

    goto :goto_1

    .line 141
    :cond_3
    sget v2, Lcom/android/settings/R$string;->close_miui_optimization_title:I
    ...
    sget v2, Lcom/android/settings/R$string;->open_optimization_option:I

    goto :goto_2

    .line 143
    :cond_4
    sget v2, Lcom/android/settings/R$string;->close_optimization_option:I

    :goto_2
    new-instance v3, Lcom/android/settings/development/MiuiOptimizationController$2;

    invoke-direct {v3, p0, p1}, Lcom/android/settings/development/MiuiOptimizationController$2;-><init>(Lcom/android/settings/development/MiuiOptimizationController;Ljava/lang/Boolean;)V
    ...
    sget v2, Lcom/android/settings/R$string;->optimization_cancel:I

    new-instance v3, Lcom/android/settings/development/MiuiOptimizationController$1;

    invoke-direct {v3, p0, p1}, Lcom/android/settings/development/MiuiOptimizationController$1;-><init>(Lcom/android/settings/development/MiuiOptimizationController;Ljava/lang/Boolean;)V
    ...
    .line 158
    new-instance v1, Lcom/android/settings/development/MiuiOptimizationController$3;

    invoke-direct {v1, p0, p1}, Lcom/android/settings/development/MiuiOptimizationController$3;-><init>(Lcom/android/settings/development/MiuiOptimizationController;Ljava/lang/Boolean;)V
