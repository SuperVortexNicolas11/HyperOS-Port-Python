...
# direct methods
.method public static synthetic $r8$lambda$RFb5s9-kHpWtMGD46IHeJyUjt6g(Lcom/android/settings/development/storage/LeaseInfoListView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic $r8$lambda$Rti1i7vEpI5Lx5mBNAKgm6jLk6A(Lcom/android/settings/development/storage/LeaseInfoListView;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method private getFooterView()Landroid/widget/Button;
    ...
    .line 113
    sget v1, Lcom/android/settingslib/R$string;->delete_blob_text:I
...
.method private getHeaderView()Landroid/widget/LinearLayout;
    ...
    .line 96
    sget v1, Lcom/android/settings/R$id;->blob_label:I
    ...
    .line 97
    sget v2, Lcom/android/settings/R$id;->blob_id:I
    ...
    .line 98
    sget v3, Lcom/android/settings/R$id;->blob_expiry:I
    ...
    .line 99
    sget v4, Lcom/android/settings/R$id;->blob_size:I
    ...
    .line 101
    iget-object v5, p0, Lcom/android/settings/development/storage/LeaseInfoListView;->mBlobInfo:Landroid/app/blob/BlobInfo;

    invoke-virtual {v5}, Landroid/app/blob/BlobInfo;->getLabel()Ljava/lang/CharSequence;
    ...
    .line 103
    sget v1, Lcom/android/settingslib/R$string;->blob_id_text:I

    iget-object v5, p0, Lcom/android/settings/development/storage/LeaseInfoListView;->mBlobInfo:Landroid/app/blob/BlobInfo;

    invoke-virtual {v5}, Landroid/app/blob/BlobInfo;->getId()J
    ...
    invoke-virtual {p0, v1, v5}, Landroid/app/ListActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method private synthetic lambda$getButtonOnClickListener$0(Landroid/view/View;)V
    ...
    sget v0, Lcom/android/settingslib/R$string;->delete_blob_confirmation_text:I
