.class public Lcom/android/settings/display/GuidePopupWindowNew;
.super Lmiuix/popupwidget/widget/ArrowPopupWindow;
.source "SourceFile"


# instance fields
.field private mDefaultMaxWidth:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 91
    iput p1, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewWidth:I

    const/16 p1, 0x120

    .line 96
    iput p1, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMaxWidth:I

    const/16 p1, 0x8c

    .line 97
    iput p1, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMinWidth:I

    .line 399
    new-instance p1, Lcom/android/settings/display/GuidePopupWindowNew$2;

    invoke-direct {p1, p0}, Lcom/android/settings/display/GuidePopupWindowNew$2;-><init>(Lcom/android/settings/display/GuidePopupWindowNew;)V

    iput-object p1, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDismissRunnable:Ljava/lang/Runnable;
...
.method private addGuideTextView(Ljava/lang/String;)V
    ...
    .line 220
    iget v6, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMinWidth:I
    ...
    iget v7, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMinWidth:I

    int-to-float v7, v7

    invoke-static {v6, v7}, Lcom/android/settings/display/GuidePopupWindowNew;->dpToPx(Landroid/content/Context;F)I
    ...
    .line 223
    :cond_2
    iget v6, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMaxWidth:I
    ...
    iget v7, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDefaultMaxWidth:I
    ...
    .line 228
    invoke-direct {p0, v5, v0}, Lcom/android/settings/display/GuidePopupWindowNew;->getTextViewHeightAndWidth(Landroid/view/View;Landroid/graphics/Point;)[I

    move-result-object v4

    .line 229
    iget v6, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewHeight:I

    aget v7, v4, v2

    add-int/2addr v6, v7

    iput v6, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewHeight:I

    .line 230
    iget v6, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewWidth:I
    ...
    iput v4, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewWidth:I

    .line 231
    iget-object v4, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mGuideView:Landroid/widget/LinearLayout;
...
.method private setAccessibilityDelegate()V
    ...
    .line 161
    iget-object v0, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mGuideView:Landroid/widget/LinearLayout;
    ...
    new-instance v1, Lcom/android/settings/display/GuidePopupWindowNew$1;

    invoke-direct {v1, p0}, Lcom/android/settings/display/GuidePopupWindowNew$1;-><init>(Lcom/android/settings/display/GuidePopupWindowNew;)V
...
.method private showWithWrapContent(Landroid/view/View;)V
    ...
    .line 299
    :pswitch_0
    iget v6, v0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewHeight:I
    ...
    .line 293
    iget v6, v0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewWidth:I
    ...
    .line 315
    iget v8, v0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewWidth:I
    ...
    iget v14, v0, Lcom/android/settings/display/GuidePopupWindowNew;->mTextViewHeight:I
    ...
    .line 330
    :cond_6
    invoke-direct {v0}, Lcom/android/settings/display/GuidePopupWindowNew;->isSideMode()Z
...
.method protected onPrepareWindow()V
    ...
    .line 149
    iput v0, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mShowDuration:I
    ...
    iput-object v0, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mGuideView:Landroid/widget/LinearLayout;
    ...
    .line 157
    invoke-direct {p0}, Lcom/android/settings/display/GuidePopupWindowNew;->setAccessibilityDelegate()V
...
.method public setGuideText(I)V
    ...
    .line 205
    invoke-virtual {p0, p1}, Lcom/android/settings/display/GuidePopupWindowNew;->setGuideText(Ljava/lang/String;)V
...
.method public setGuideText(Ljava/lang/String;)V
    ...
    .line 195
    invoke-direct {p0, p1}, Lcom/android/settings/display/GuidePopupWindowNew;->addGuideTextView(Ljava/lang/String;)V
...
.method public show(Landroid/view/View;II)V
    ...
    .line 254
    iget-boolean v0, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mUseWrapContent:Z

    if-eqz v0, :cond_0

    .line 255
    invoke-direct {p0, p1}, Lcom/android/settings/display/GuidePopupWindowNew;->showWithWrapContent(Landroid/view/View;)V
...
.method public show(Landroid/view/View;IIZ)V
    ...
    .line 369
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/settings/display/GuidePopupWindowNew;->show(Landroid/view/View;II)V
    ...
    iget-object p3, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mDismissRunnable:Ljava/lang/Runnable;

    iget p0, p0, Lcom/android/settings/display/GuidePopupWindowNew;->mShowDuration:I
...
.method public show(Landroid/view/View;Z)V
    ...
    .line 354
    invoke-virtual {p0, p1, v0, v0, p2}, Lcom/android/settings/display/GuidePopupWindowNew;->show(Landroid/view/View;IIZ)V
