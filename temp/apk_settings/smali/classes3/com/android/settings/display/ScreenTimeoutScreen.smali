.class public final Lcom/android/settings/display/ScreenTimeoutScreen;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/display/ScreenTimeoutScreen$Companion;
    }
.end annotation


# static fields
.field public static final Companion:Lcom/android/settings/display/ScreenTimeoutScreen$Companion;


# direct methods
.method public static synthetic $r8$lambda$ARKkpMW54UPHwHkuvtRAPXwD6Ck(Lcom/android/settingslib/metadata/PreferenceHierarchy;)Lkotlin/Unit;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/android/settings/display/ScreenTimeoutScreen;->getPreferenceHierarchy$lambda$0(Lcom/android/settingslib/metadata/PreferenceHierarchy;)Lkotlin/Unit;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/android/settings/display/ScreenTimeoutScreen$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/android/settings/display/ScreenTimeoutScreen$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/android/settings/display/ScreenTimeoutScreen;->Companion:Lcom/android/settings/display/ScreenTimeoutScreen$Companion;
...
.method private static final getPreferenceHierarchy$lambda$0(Lcom/android/settingslib/metadata/PreferenceHierarchy;)Lkotlin/Unit;
    ...
    .line 46
    new-instance v0, Lcom/android/settings/display/AdaptiveSleepPreference;

    invoke-direct {v0}, Lcom/android/settings/display/AdaptiveSleepPreference;-><init>()V
...
.method public fragmentClass()Ljava/lang/Class;
    ...
    .line 41
    const-class p0, Lcom/android/settings/display/ScreenTimeoutSettings;
...
.method public getLaunchIntent(Landroid/content/Context;Lcom/android/settingslib/metadata/PreferenceMetadata;)Landroid/content/Intent;
    ...
    :goto_0
    const-class p2, Lcom/android/settings/Settings$ScreenTimeoutActivity;
...
.method public getPreferenceHierarchy(Landroid/content/Context;)Lcom/android/settingslib/metadata/PreferenceHierarchy;
    ...
    .line 46
    new-instance v0, Lcom/android/settings/display/ScreenTimeoutScreen$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lcom/android/settings/display/ScreenTimeoutScreen$$ExternalSyntheticLambda0;-><init>()V
