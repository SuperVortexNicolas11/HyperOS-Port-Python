...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "NON_MANUAL_SHUTDOWN_FLAG"
    ...
    .line 66
    :cond_0
    iget-object v8, p0, Lcom/android/settings/display/ScreenEnhanceEngineMemcActivity$ScreenEnhanceEngineMemcFragment$1;->this$0:Lcom/android/settings/display/ScreenEnhanceEngineMemcActivity$ScreenEnhanceEngineMemcFragment;

    invoke-static {v8}, Lcom/android/settings/display/ScreenEnhanceEngineMemcActivity$ScreenEnhanceEngineMemcFragment;->-$$Nest$fgetcontext(Lcom/android/settings/display/ScreenEnhanceEngineMemcActivity$ScreenEnhanceEngineMemcFragment;)Landroid/content/Context;

    move-result-object v8

    invoke-static {v8, v5, v7}, Lcom/android/settings/MiuiUtils;->setExtremeAudioAndVideoStatus(Landroid/content/Context;Ljava/lang/String;Z)Z

    .line 67
    const-string/jumbo v8, "set NON_MANUAL_SHUTDOWN_FLAG true"
    ...
    invoke-static {v8, v6, v3}, Lcom/android/settings/utils/MiuiSharedPreferencesUtils;->setBooleanPreference(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-static {p1, v6, v7}, Lcom/android/settings/utils/MiuiSharedPreferencesUtils;->getBooleanPreference(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-static {p1, v5, v3}, Lcom/android/settings/MiuiUtils;->setExtremeAudioAndVideoStatus(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-static {p0, v6, v7}, Lcom/android/settings/utils/MiuiSharedPreferencesUtils;->setBooleanPreference(Landroid/content/Context;Ljava/lang/String;Z)V
