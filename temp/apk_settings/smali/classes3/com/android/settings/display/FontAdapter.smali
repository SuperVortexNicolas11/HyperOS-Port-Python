...
# direct methods
.method public static synthetic $r8$lambda$tc-_2bXIWVDL308liItW3HtQ3mc(Landroid/widget/TextView;Landroid/graphics/Typeface;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    .line 60
    const-string v16, "/system/fonts/NotoSansKannada-VF.ttf"

    const-string v17, "/system/fonts/NotoSansMalayalam-VF.ttf"

    const-string v1, "/system/fonts/Roboto-Regular.ttf"

    const-string v2, "/system/fonts/NotoSansCJK-Regular.ttc"

    const-string v3, "/system/fonts/NotoNaskhArabic-Regular.ttf"

    const-string v4, "/system/fonts/NotoSansDevanagari-VF.ttf"

    const-string v5, "/system/fonts/NotoSansKhmerUI-Regular.ttf"

    const-string v6, "/system/fonts/NotoSansLao-Regular.ttf"

    const-string v7, "/system/fonts/NotoSansMyanmar-Regular.otf"

    const-string v8, "/system/fonts/NotoSansThai-Regular.ttf"

    const-string v9, "/system/fonts/NotoSerifTibetan-VF.ttf"

    const-string v10, "/system/fonts/NotoSansBengali-VF.ttf"

    const-string v11, "/system/fonts/NotoSansGujarati-Regular.ttf"

    const-string v12, "/system/fonts/NotoSansGurmukhi-VF.ttf"

    const-string v13, "/system/fonts/NotoSansOriya-Regular.ttf"

    const-string v14, "/system/fonts/NotoSansTamil-VF.ttf"

    const-string v15, "/system/fonts/NotoSansTelugu-VF.ttf"
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lcom/android/settings/display/FontAdapter$FontViewHolder;
    ...
    invoke-static {p2}, Lcom/android/settings/MiuiUtils;->isUserSetUpFlow(Landroid/content/Context;)Z
...
.method public setDataList(Ljava/util/List;)V
    ...
    invoke-direct {v0, v1, v2, v2, v3}, Lcom/android/settings/display/LocalFontModel;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 85
    :goto_0
    iget-object p1, p0, Lcom/android/settings/display/FontAdapter;->mList:Ljava/util/List;
    ...
    .line 91
    invoke-virtual {p1}, Lcom/android/settings/display/LocalFontModel;->getFontAssert()Ljava/io/File;
    ...
    .line 93
    :try_start_0
    invoke-direct {p0, p1}, Lcom/android/settings/display/FontAdapter;->tryGetFontAssertFile(Lcom/android/settings/display/LocalFontModel;)Ljava/io/File;

    move-result-object v0

    .line 94
    invoke-virtual {p1, v0}, Lcom/android/settings/display/LocalFontModel;->setFontAssert(Ljava/io/File;)V
    ...
    invoke-direct {v1, v0}, Landroid/graphics/fonts/Font$Builder;-><init>(Ljava/io/File;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/display/FontAdapter;->createFontFamily(Ljava/lang/String;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 103
    invoke-virtual {v2, v1}, Landroid/graphics/Typeface$CustomFallbackBuilder;->addCustomFallback(Landroid/graphics/fonts/FontFamily;)Landroid/graphics/Typeface$CustomFallbackBuilder;
    ...
    :cond_0
    :goto_1
    invoke-virtual {p1, v1}, Lcom/android/settings/display/LocalFontModel;->setTypeface(Landroid/graphics/Typeface;)V
    ...
    .line 110
    :goto_2
    sget-object v1, Lcom/android/settings/display/FontAdapter;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/settings/display/LocalFontModel;->toString()Ljava/lang/String;
