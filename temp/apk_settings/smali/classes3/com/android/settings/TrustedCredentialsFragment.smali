...
.field private final mProfileChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method static bridge synthetic -$$Nest$misBroadcastValidForAction(Lcom/android/settings/TrustedCredentialsFragment;Landroid/content/Intent;)Z
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/settings/TrustedCredentialsFragment;->isBroadcastValidForAction(Landroid/content/Intent;)Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/TrustedCredentialsFragment;->mProfileChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method private createChildView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;I)V
    ...
    iget-object v2, p0, Lcom/android/settings/TrustedCredentialsFragment;->mUserManager:Landroid/os/UserManager;

    invoke-static {v1, v2}, Lcom/android/settings/Utils;->shouldHideUser(Landroid/os/UserHandle;Landroid/os/UserManager;)Z
...
.method private isBroadcastValidForAction(Landroid/content/Intent;)Z
    .locals 3
    ...
    const-string/jumbo p1, "received action "
    ...
    .line 144
    const-string p1, "android.intent.action.PROFILE_AVAILABLE"
    ...
    const-string p1, "android.intent.action.PROFILE_UNAVAILABLE"
    ...
    const-string p1, "android.intent.action.PROFILE_ACCESSIBLE"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 187
    iget-object p0, p0, Lcom/android/settings/TrustedCredentialsFragment;->mProfileChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/TrustedCredentialsFragment;->mProfileChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method public onInflateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, p0, v2, v3}, Lcom/android/settings/TrustedCredentialsFragment$GroupAdapter;-><init>(Lcom/android/settings/TrustedCredentialsFragment;Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/TrustedCredentialsFragment-IA;)V
...
.method public removeOrInstallCert(Lcom/android/settings/TrustedCredentialsFragment$CertHolder;)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/android/settings/TrustedCredentialsFragment$AliasOperation;-><init>(Lcom/android/settings/TrustedCredentialsFragment;Lcom/android/settings/TrustedCredentialsFragment$CertHolder;Lcom/android/settings/TrustedCredentialsFragment-IA;)V
