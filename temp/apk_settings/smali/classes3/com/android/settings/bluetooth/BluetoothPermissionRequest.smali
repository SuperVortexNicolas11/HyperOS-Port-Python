...
.method private checkUserChoice()Z
    ...
    const-string v1, "checkUserChoice(): Unknown RequestType "
    ...
    .line 260
    invoke-direct {p0, v4}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const v4, 0x1080080    # @android:drawable/stat_sys_data_bluetooth
    ...
    .line 78
    const-string p0, "Blocking notification for managed profile."
    ...
    iput-object v7, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    const-string/jumbo v8, "onReceive request type: "
    ...
    invoke-virtual {p2, v6, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    .line 167
    sget v6, Lcom/android/settings/R$string;->bluetooth_connect_access_notification_content:I
    ...
    .line 161
    sget v6, Lcom/android/settings/R$string;->bluetooth_sim_card_access_notification_content:I
    ...
    .line 155
    sget v6, Lcom/android/settings/R$string;->bluetooth_message_access_notification_content:I
    ...
    .line 150
    sget v6, Lcom/android/settings/R$string;->bluetooth_phonebook_access_notification_content:I
    ...
    .line 192
    invoke-static {p1, v1, v2, v5}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 196
    invoke-virtual {p1, v7}, Landroid/app/Notification$Builder;->setLocalOnly(Z)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v3, p0, v4, p1}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    invoke-virtual {p1, p0, v4}, Landroid/app/NotificationManager;->cancel(Ljava/lang/String;I)V
