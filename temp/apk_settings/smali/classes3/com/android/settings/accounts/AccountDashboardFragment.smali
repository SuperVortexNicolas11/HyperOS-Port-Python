...
.method static buildAutofillPreferenceControllers(Landroid/content/Context;Ljava/util/List;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p0, p2, p3}, Lcom/android/settings/applications/credentials/DefaultCombinedPreferenceController;-><init>(Landroid/content/Context;ZZ)V

    invoke-interface {p1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 123
    new-instance p2, Lcom/android/settings/applications/credentials/DefaultWorkCombinedPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/applications/credentials/DefaultWorkCombinedPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 124
    new-instance p2, Lcom/android/settings/applications/credentials/DefaultPrivateCombinedPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/applications/credentials/DefaultPrivateCombinedPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    .line 126
    :cond_0
    new-instance p2, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 127
    new-instance p2, Lcom/android/settings/applications/defaultapps/DefaultWorkAutofillPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/applications/defaultapps/DefaultWorkAutofillPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 128
    new-instance p2, Lcom/android/settings/applications/defaultapps/DefaultPrivateAutofillPreferenceController;

    invoke-direct {p2, p0}, Lcom/android/settings/applications/defaultapps/DefaultPrivateAutofillPreferenceController;-><init>(Landroid/content/Context;)V
...
.method protected createPreferenceControllers(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 103
    invoke-static {p1, v0, v1, v1}, Lcom/android/settings/accounts/AccountDashboardFragment;->buildAutofillPreferenceControllers(Landroid/content/Context;Ljava/util/List;ZZ)V
...
.method public onAttach(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/settings/applications/credentials/CredentialManagerPreferenceController;->init(Lcom/android/settings/dashboard/DashboardFragment;Landroidx/fragment/app/FragmentManager;Landroid/content/Intent;Lcom/android/settings/applications/credentials/CredentialManagerPreferenceController$Delegate;ZZ)V
    ...
    .line 96
    invoke-virtual {v1}, Lcom/android/settings/core/ObservablePreferenceFragment;->getSettingsLifecycle()Lcom/android/settingslib/core/lifecycle/Lifecycle;

    move-result-object p0

    const-class p1, Lcom/android/settings/applications/autofill/PasswordsPreferenceController;

    invoke-virtual {v1, p1}, Lcom/android/settings/dashboard/DashboardFragment;->use(Ljava/lang/Class;)Lcom/android/settingslib/core/AbstractPreferenceController;
