...
.field public static final enum NONE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;
...
.method private static synthetic $values()[Lcom/android/settings/accessibility/ScreenFlashNotificationColor;
    ...
    sget-object v1, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->BLUE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v2, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->AZURE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v3, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->CYAN:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v4, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->SPRING_GREEN:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v5, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->GREEN:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v6, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->CHARTREUSE_GREEN:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v7, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->YELLOW:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v8, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->ORANGE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v9, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->RED:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v10, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->ROSE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v11, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->MAGENTA:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    sget-object v12, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->VIOLET:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    filled-new-array/range {v0 .. v12}, [Lcom/android/settings/accessibility/ScreenFlashNotificationColor;
...
.method static constructor <clinit>()V
    ...
    sget v2, Lcom/android/settings/R$string;->screen_flash_color_none:I

    const-string v3, "NONE"

    invoke-direct {v0, v3, v1, v1, v2}, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;-><init>(Ljava/lang/String;III)V

    sput-object v0, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;->NONE:Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    .line 28
    new-instance v0, Lcom/android/settings/accessibility/ScreenFlashNotificationColor;

    const v1, 0x4d0000fe    # 1.342218E8f
    ...
    const v1, 0x4d00ffff    # 1.3526629E8f
    ...
    const v1, 0x4dff017e    # 5.34786E8f
    ...
    const v1, 0x4dff00fe    # 5.347819E8f
