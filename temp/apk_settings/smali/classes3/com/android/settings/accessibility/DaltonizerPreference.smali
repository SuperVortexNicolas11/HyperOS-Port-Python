.class public final Lcom/android/settings/accessibility/DaltonizerPreference;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/accessibility/DaltonizerPreference$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/android/settings/accessibility/DaltonizerPreference;",
...
.field public static final Companion:Lcom/android/settings/accessibility/DaltonizerPreference$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/android/settings/accessibility/DaltonizerPreference$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/android/settings/accessibility/DaltonizerPreference$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/android/settings/accessibility/DaltonizerPreference;->Companion:Lcom/android/settings/accessibility/DaltonizerPreference$Companion;

    const/16 v0, 0x8

    sput v0, Lcom/android/settings/accessibility/DaltonizerPreference;->$stable:I
...
.method public getIcon()I
    ...
    .line 41
    sget p0, Lcom/android/settings/R$drawable;->ic_daltonizer:I
...
.method public getKey()Ljava/lang/String;
    ...
    .line 35
    const-string p0, "daltonizer_preference"
...
.method public getKeywords()I
    ...
    .line 44
    sget p0, Lcom/android/settings/R$string;->keywords_color_correction:I
...
.method public getSummary(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    .line 58
    sget p0, Lcom/android/settings/R$string;->daltonizer_state_on:I

    sget v0, Lcom/android/settings/R$string;->daltonizer_state_off:I
...
.method public getTitle()I
    ...
    .line 38
    sget p0, Lcom/android/settingslib/R$string;->accessibility_display_daltonizer_preference_title:I
...
.method public intent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 50
    const-class p1, Lcom/android/settings/accessibility/ToggleDaltonizerPreferenceFragment;
...
.method public onStart(Lcom/android/settingslib/metadata/PreferenceLifecycleContext;)V
    ...
    .line 63
    new-instance v0, Lcom/android/settings/accessibility/DaltonizerPreference$onStart$observer$1;

    invoke-direct {v0, p1}, Lcom/android/settings/accessibility/DaltonizerPreference$onStart$observer$1;-><init>(Lcom/android/settingslib/metadata/PreferenceLifecycleContext;)V

    .line 65
    iput-object v0, p0, Lcom/android/settings/accessibility/DaltonizerPreference;->mSettingsKeyedObserver:Lcom/android/settingslib/datastore/KeyedObserver;
...
.method public onStop(Lcom/android/settingslib/metadata/PreferenceLifecycleContext;)V
    ...
    .line 71
    iget-object v0, p0, Lcom/android/settings/accessibility/DaltonizerPreference;->mSettingsKeyedObserver:Lcom/android/settingslib/datastore/KeyedObserver;
    ...
    .line 74
    iput-object p1, p0, Lcom/android/settings/accessibility/DaltonizerPreference;->mSettingsKeyedObserver:Lcom/android/settingslib/datastore/KeyedObserver;
