.class Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;
    }
.end annotation
...
.field private mOnPageSelectedCallback:Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;
...
.method constructor <init>(Landroid/content/Context;Landroidx/viewpager/widget/ViewPager;Landroid/view/ViewGroup;Landroid/view/ViewGroup;Ljava/util/List;)V
    ...
    .line 662
    iput-object p1, p0, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener;->mOnPageSelectedCallback:Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;
...
.method public onPageSelected(I)V
    ...
    :cond_1
    const v3, 0x10a00b0    # @android:anim/task_fragment_open_enter
    ...
    :cond_2
    const v0, 0x10a00b3    # @android:anim/task_open_enter_cross_profile_apps
    ...
    invoke-virtual {v5}, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPage;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3}, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPage;->getInstruction()Ljava/lang/CharSequence;
    ...
    .line 701
    invoke-virtual {v3}, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPage;->getIndicatorIcon()Landroid/widget/ImageView;
    ...
    invoke-virtual {v0}, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPage;->getIndicatorIcon()Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener;->mContext:Landroid/content/Context;
    ...
    iget-object v4, p0, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener;->mTutorialPages:Ljava/util/List;
    ...
    .line 711
    iget-object p0, p0, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener;->mOnPageSelectedCallback:Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;

    if-eqz p0, :cond_4

    .line 712
    invoke-interface {p0, p1}, Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;->onPageSelected(I)V

    :cond_4
    return-void
.end method

.method public setOnPageSelectedCallback(Lcom/android/settings/accessibility/AccessibilityShortcutsTutorial$TutorialPageChangeListener$OnPageSelectedCallback;)V
    .locals 0
