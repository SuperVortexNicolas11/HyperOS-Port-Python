...
# direct methods
.method public static synthetic $r8$lambda$4d5Hduja-IRazVAdVR3MyRG2tb4(Lcom/android/settings/accessibility/HapticSettingsFragment;)V
    .locals 0
...
.method public static synthetic $r8$lambda$FmglhiNFRX8IxtcxgzWQwGOrfXc(Lcom/android/settings/accessibility/HapticSettingsFragment;)V
    .locals 0
...
.method public static synthetic $r8$lambda$MQ7NQ-AnB3ivBCcqVLE5cYHb9GI(Lcom/android/settings/accessibility/HapticSettingsFragment;)V
    .locals 0
...
.method protected updateServicePreferences()V
    ...
    .line 255
    sget-object v1, Lcom/android/settings/accessibility/HapticSettingsFragment;->COMMON_SERVICES_LIST:Ljava/util/List;
    ...
    check-cast v1, Lcom/android/settings/accessibility/haptic/HapticRadioButtonPreference;

    .line 258
    iget-object v3, v0, Lcom/android/settings/accessibility/HapticSettingsFragment;->mPm:Landroid/content/pm/PackageManager;

    invoke-virtual {v11, v3}, Landroid/content/pm/ResolveInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
    ...
    iget-object v14, v4, Landroid/content/pm/ServiceInfo;->packageName:Ljava/lang/String;
    ...
    invoke-static {v4, v10, v13}, Lcom/android/settings/accessibility/HapticSettingsFragment;->getServiceSummary(Landroid/content/Context;Landroid/accessibilityservice/AccessibilityServiceInfo;Z)Ljava/lang/CharSequence;
    ...
    .line 267
    invoke-virtual {v1, v13}, Lcom/android/settings/accessibility/haptic/HapticRadioButtonPreference;->setPreferenceState(Z)V
    ...
    .line 270
    invoke-static {v10}, Lcom/android/settings/accessibility/AccessibilityServiceUtils;->getAccessibilityServiceFragmentTypeName(Landroid/accessibilityservice/AccessibilityServiceInfo;)Ljava/lang/String;

    move-result-object v4

    .line 271
    invoke-virtual {v10}, Landroid/accessibilityservice/AccessibilityServiceInfo;->getAnimatedImageRes()I
    ...
    invoke-static {v6, v10, v13}, Lcom/android/settings/accessibility/AccessibilityServiceUtils;->getServiceDescription(Landroid/content/Context;Landroid/accessibilityservice/AccessibilityServiceInfo;Z)Ljava/lang/CharSequence;

    move-result-object v6

    .line 273
    iget-object v15, v0, Lcom/android/settings/accessibility/HapticSettingsFragment;->mPm:Landroid/content/pm/PackageManager;

    invoke-virtual {v10, v15}, Landroid/accessibilityservice/AccessibilityServiceInfo;->loadHtmlDescription(Landroid/content/pm/PackageManager;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v11, v3}, Lcom/android/settings/accessibility/HapticSettingsFragment;->putServiceExtras(Landroidx/preference/Preference;Landroid/content/pm/ResolveInfo;Ljava/lang/Boolean;)V

    .line 281
    invoke-direct {v0, v1, v14, v8}, Lcom/android/settings/accessibility/HapticSettingsFragment;->putSettingsExtras(Landroidx/preference/Preference;Ljava/lang/String;Ljava/lang/String;)V
