...
.field private static final KEY_DEVICE_ADMIN_SETTINGS_CATEGORY:Ljava/lang/String; = "device_admin_settings_category"
...
# direct methods
.method public static synthetic $r8$lambda$1jZnfVe9i1O-MsUfy2WoYuLbR-0(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$NQ8AYT5aGQuMgpYRn-swVmuGMfg(Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListItem;Landroidx/preference/Preference;)Z
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mMetricsFeatureProvider:Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;
    ...
    iput-object p1, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mSecurityManager:Lmiui/security/SecurityManager;
...
.method private bindPreference(Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListItem;Lcom/android/settings/widget/RestrictedValuePreference;)V
    .locals 3
    ...
    .line 272
    invoke-virtual {p2, v0}, Lcom/android/settings/widget/RestrictedValuePreference;->setIconSize(I)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/settings/widget/RestrictedValuePreference;->setEnabled(Z)V
    ...
    sget v0, Lcom/android/settings/R$string;->mode_enable:I

    goto :goto_0

    :cond_0
    sget v0, Lcom/android/settings/R$string;->mode_disable:I

    :goto_0
    invoke-virtual {p2, v0}, Lcom/android/settingslib/miuisettings/preference/ValuePreference;->setValue(I)V
    ...
    invoke-direct {v0}, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController$$ExternalSyntheticLambda1;-><init>()V
    ...
    .line 296
    invoke-virtual {p2, v0}, Landroidx/preference/Preference;->setSingleLineTitle(Z)V

    .line 300
    iget-object v0, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mSecurityManager:Lmiui/security/SecurityManager;
    ...
    .line 302
    :try_start_0
    iget-object p0, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mSecurityManager:Lmiui/security/SecurityManager;

    invoke-static {}, Landroid/os/UserHandle;->myUserId()I

    move-result v0

    invoke-virtual {p1}, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListItem;->getPackageName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lmiui/security/SecurityManager;->getEcmTypeForUser(ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 305
    const-string p0, "android:ecm_protected_settings"
    ...
    .line 305
    invoke-virtual {p2, p0, p1}, Lcom/android/settings/widget/RestrictedValuePreference;->checkEcmRestrictionAndSetDisabled(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    .line 309
    const-string p1, "DeviceAdminListPrefCtrl"

    const-string p2, "getEcmTypeForUser error"
    ...
    .line 312
    :cond_2
    const-string p0, "android.permission.BIND_DEVICE_ADMIN"
...
.method private refreshData()V
    ...
    .line 186
    invoke-direct {p0, v1}, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->shouldSkipProfile(Landroid/os/UserHandle;)Z
...
.method private refreshUI()V
    ...
    .line 209
    iget-object v0, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;
    ...
    .line 224
    iget-object v1, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;
    ...
    .line 225
    iget-object v2, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;
    ...
    .line 227
    iget-object v4, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;
    ...
    .line 231
    instance-of v5, v4, Lcom/android/settings/widget/RestrictedValuePreference;

    if-eqz v5, :cond_2

    check-cast v4, Lcom/android/settings/widget/RestrictedValuePreference;
    ...
    .line 244
    new-instance v4, Lcom/android/settings/widget/RestrictedValuePreference;

    invoke-direct {v4, v1}, Lcom/android/settings/widget/RestrictedValuePreference;-><init>(Landroid/content/Context;)V

    .line 247
    sget v5, Lcom/android/settings/R$layout;->miuix_preference_app_layout_print:I

    invoke-virtual {v4, v5}, Landroidx/preference/Preference;->setLayoutResource(I)V

    .line 251
    iget-object v5, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;

    invoke-virtual {v5, v4}, Landroidx/preference/PreferenceGroup;->addPreference(Landroidx/preference/Preference;)Z

    .line 254
    :cond_4
    invoke-direct {p0, v3, v4}, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->bindPreference(Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListItem;Lcom/android/settings/widget/RestrictedValuePreference;)V
    ...
    check-cast v1, Lcom/android/settings/widget/RestrictedValuePreference;
...
.method private shouldSkipProfile(Landroid/os/UserHandle;)Z
    ...
    iget-object p0, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mUm:Landroid/os/UserManager;
...
.method public displayPreference(Landroidx/preference/PreferenceScreen;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mFooterPreference:Lcom/android/settingslib/widget/FooterPreference;

    .line 147
    const-string v0, "device_admin_settings_category"
    ...
    iput-object p1, p0, Lcom/android/settings/applications/specialaccess/deviceadmin/DeviceAdminListPreferenceController;->mPreferenceCategory:Landroidx/preference/PreferenceCategory;
