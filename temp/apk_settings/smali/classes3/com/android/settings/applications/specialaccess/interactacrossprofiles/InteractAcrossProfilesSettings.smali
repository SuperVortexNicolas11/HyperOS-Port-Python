...
# direct methods
.method public static synthetic $r8$lambda$LCvd5fSluued4cSoPSJiq2lD_0c(Landroid/content/Context;Landroid/content/pm/CrossProfileApps;Landroid/util/Pair;)Z
    .locals 1
...
.method public static synthetic $r8$lambda$p_JrT-Ld-8vTamxk0Bq-sN-b6gk(Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;)Z
    .locals 0
...
.method private static getAllInstalledPackages(Landroid/content/pm/PackageManager;Landroid/os/UserHandle;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    new-instance v1, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings$$ExternalSyntheticLambda1;

    invoke-direct {v1, p1}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings$$ExternalSyntheticLambda1;-><init>(Landroid/content/pm/PackageInfo;)V
...
.method static getNumberOfEnabledApps(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/os/UserManager;Landroid/content/pm/CrossProfileApps;)I
    ...
    .line 195
    new-instance p2, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0, p3}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;Landroid/content/pm/CrossProfileApps;)V
...
.method public onResume()V
    ...
    iget-object v2, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings;->mContext:Landroid/content/Context;
    ...
    sget v2, Lcom/android/settings/R$string;->interact_across_profiles_title:I

    invoke-virtual {p0, v0, v2}, Lcom/android/settings/SettingsPreferenceFragment;->replaceEnterprisePreferenceScreenTitle(Ljava/lang/String;I)V

    .line 84
    iget-object v0, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 85
    invoke-static {v0, v2, v3}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesSettings;->collectConfigurableApps(Landroid/content/pm/PackageManager;Landroid/os/UserManager;Landroid/content/pm/CrossProfileApps;)Ljava/util/ArrayList;
    ...
    .line 97
    invoke-static {v2, v5}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->getPreferenceSummary(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
