...
.method static constructor <clinit>()V
    ...
    .line 114
    new-instance v1, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
    ...
    invoke-direct {v1, v7, v5}, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;-><init>([I[Z)V

    sput-object v1, Lcom/android/settings/applications/appops/AppOpsState;->PERSONAL_TEMPLATE:Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;

    move v5, v2

    .line 133
    new-instance v2, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
    ...
    invoke-direct {v2, v9, v6}, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;-><init>([I[Z)V

    sput-object v2, Lcom/android/settings/applications/appops/AppOpsState;->MESSAGING_TEMPLATE:Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;

    move v6, v3

    .line 154
    new-instance v3, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
    ...
    invoke-direct {v3, v8, v7}, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;-><init>([I[Z)V

    sput-object v3, Lcom/android/settings/applications/appops/AppOpsState;->MEDIA_TEMPLATE:Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
    ...
    invoke-direct {v4, v8, v6}, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;-><init>([I[Z)V

    sput-object v4, Lcom/android/settings/applications/appops/AppOpsState;->DEVICE_TEMPLATE:Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
    ...
    invoke-direct {v5, v8, v6}, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;-><init>([I[Z)V

    sput-object v5, Lcom/android/settings/applications/appops/AppOpsState;->RUN_IN_BACKGROUND_TEMPLATE:Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v1, Lcom/android/settings/R$array;->app_ops_summaries:I
    ...
    sget v0, Lcom/android/settings/R$array;->app_ops_labels:I
...
.method public buildState(Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;ILjava/lang/String;Ljava/util/Comparator;)Ljava/util/List;
    ...
    .line 530
    iget-object v8, v0, Lcom/android/settings/applications/appops/AppOpsState;->mContext:Landroid/content/Context;
    ...
    .line 538
    :goto_0
    iget-object v4, v1, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;->ops:[I
    ...
    .line 539
    iget-object v5, v1, Lcom/android/settings/applications/appops/AppOpsState$OpsTemplate;->showPerms:[Z
    ...
    .line 551
    iget-object v1, v0, Lcom/android/settings/applications/appops/AppOpsState;->mAppOps:Landroid/app/AppOpsManager;

    move/from16 v3, p2

    invoke-virtual {v1, v3, v7, v4}, Landroid/app/AppOpsManager;->getOpsForPackage(ILjava/lang/String;[I)Ljava/util/List;
    ...
    invoke-direct {v0, v8, v9, v4, v15}, Lcom/android/settings/applications/appops/AppOpsState;->getAppEntry(Landroid/content/Context;Ljava/util/HashMap;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Lcom/android/settings/applications/appops/AppOpsState$AppEntry;
    ...
    .line 575
    :try_start_0
    iget-object v3, v0, Lcom/android/settings/applications/appops/AppOpsState;->mPm:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v3, v2, v13}, Landroid/content/pm/PackageManager;->getPackagesHoldingPermissions([Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {v0, v8, v9, v4, v5}, Lcom/android/settings/applications/appops/AppOpsState;->getAppEntry(Landroid/content/Context;Ljava/util/HashMap;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Lcom/android/settings/applications/appops/AppOpsState$AppEntry;
    ...
    .line 594
    :goto_b
    iget-object v15, v3, Landroid/content/pm/PackageInfo;->requestedPermissions:[Ljava/lang/String;
    ...
    .line 595
    iget-object v15, v3, Landroid/content/pm/PackageInfo;->requestedPermissionsFlags:[I
    ...
    invoke-virtual {v4, v0}, Lcom/android/settings/applications/appops/AppOpsState$AppEntry;->hasOp(I)Z
    ...
    invoke-direct {v0, v13, v1, v6}, Landroid/app/AppOpsManager$PackageOps;-><init>(Ljava/lang/String;ILjava/util/List;)V
    ...
    invoke-direct {v4, v1, v7, v6}, Landroid/app/AppOpsManager$OpEntry;-><init>(IILjava/util/Map;)V
