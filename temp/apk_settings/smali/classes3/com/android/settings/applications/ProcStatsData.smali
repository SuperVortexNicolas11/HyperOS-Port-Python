...
.method private createOsEntry(Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;J)Lcom/android/settings/applications/ProcStatsPackageEntry;
    ...
    .line 227
    new-instance v7, Lcom/android/settings/applications/ProcStatsEntry;

    iget-object v3, v0, Lcom/android/settings/applications/ProcStatsData;->mContext:Landroid/content/Context;

    sget v4, Lcom/android/settings/R$string;->process_stats_os_native:I
    ...
    .line 231
    invoke-virtual {v2, v7}, Lcom/android/settings/applications/ProcStatsPackageEntry;->addEntry(Lcom/android/settings/applications/ProcStatsEntry;)V
    ...
    .line 234
    new-instance v14, Lcom/android/settings/applications/ProcStatsEntry;

    iget-object v3, v0, Lcom/android/settings/applications/ProcStatsData;->mContext:Landroid/content/Context;

    sget v4, Lcom/android/settings/R$string;->process_stats_os_kernel:I
    ...
    iget-object v1, v0, Lcom/android/settings/applications/ProcStatsData;->mStats:Lcom/android/internal/app/procstats/ProcessStats;

    sget-object v19, Lcom/android/settings/applications/ProcStatsData;->sEntryCompare:Ljava/util/Comparator;

    iget-boolean v3, v0, Lcom/android/settings/applications/ProcStatsData;->mUseUss:Z
    ...
    .line 238
    invoke-virtual {v2, v14}, Lcom/android/settings/applications/ProcStatsPackageEntry;->addEntry(Lcom/android/settings/applications/ProcStatsEntry;)V
    ...
    iget-object v1, v0, Lcom/android/settings/applications/ProcStatsData;->mContext:Landroid/content/Context;

    sget v3, Lcom/android/settings/R$string;->process_stats_os_cache:I
    ...
    iget-wide v7, v0, Lcom/android/settings/applications/ProcStatsData;->memTotalTime:J
...
.method private createPkgMap(Ljava/util/ArrayList;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;)V
    ...
    .line 172
    iget-object p2, v3, Lcom/android/settings/applications/ProcStatsEntry;->mBestTargetPackage:Ljava/lang/String;
    ...
    .line 174
    new-instance p2, Lcom/android/settings/applications/ProcStatsPackageEntry;

    iget-object p3, v3, Lcom/android/settings/applications/ProcStatsEntry;->mBestTargetPackage:Ljava/lang/String;

    iget-wide v4, p0, Lcom/android/settings/applications/ProcStatsData;->memTotalTime:J

    invoke-direct {p2, p3, v4, v5}, Lcom/android/settings/applications/ProcStatsPackageEntry;-><init>(Ljava/lang/String;J)V
    ...
    .line 176
    iget-object p3, p0, Lcom/android/settings/applications/ProcStatsData;->pkgEntries:Ljava/util/ArrayList;

    invoke-virtual {p3, p2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 178
    :cond_0
    invoke-virtual {p2, v3}, Lcom/android/settings/applications/ProcStatsPackageEntry;->addEntry(Lcom/android/settings/applications/ProcStatsEntry;)V
...
.method private distributeZRam(D)V
    ...
    iget-object v10, v0, Lcom/android/settings/applications/ProcStatsData;->mContext:Landroid/content/Context;

    sget v11, Lcom/android/settings/R$string;->process_stats_os_zram:I
    ...
    iget-object v11, v0, Lcom/android/settings/applications/ProcStatsData;->mStats:Lcom/android/internal/app/procstats/ProcessStats;

    sget-object v14, Lcom/android/settings/applications/ProcStatsData;->sEntryCompare:Ljava/util/Comparator;
    ...
    .line 216
    invoke-virtual {v8, v9}, Lcom/android/settings/applications/ProcStatsPackageEntry;->addEntry(Lcom/android/settings/applications/ProcStatsEntry;)V
...
.method private getProcs(Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;)Ljava/util/ArrayList;
    ...
    .line 281
    :cond_0
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/app/procstats/ProcessState;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/app/procstats/ProcessState;->getUid()I
    ...
    iget-boolean v4, v0, Lcom/android/settings/applications/ProcStatsData;->mUseUss:Z
    ...
    .line 285
    iget-wide v14, v3, Lcom/android/settings/applications/ProcStatsEntry;->mRunWeight:D
    ...
    invoke-virtual {v2, v4, v14, v3}, Lcom/android/internal/app/ProcessMap;->put(Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/applications/ProcStatsEntry;->addPackage(Ljava/lang/String;)V
...
.method public refreshStats(Z)V
    ...
    .line 144
    new-instance v10, Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;

    sget-object p1, Lcom/android/internal/app/procstats/ProcessStats;->ALL_SCREEN_ADJ:[I

    iget-object v0, p0, Lcom/android/settings/applications/ProcStatsData;->mMemStates:[I

    invoke-direct {v10, p1, v0}, Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;-><init>([I[I)V

    .line 146
    iget-object v0, p0, Lcom/android/settings/applications/ProcStatsData;->mStats:Lcom/android/internal/app/procstats/ProcessStats;

    invoke-virtual {v0, v10, v6, v7}, Lcom/android/internal/app/procstats/ProcessStats;->computeTotalMemoryUse(Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;J)V

    .line 148
    new-instance v8, Lcom/android/settings/applications/ProcStatsData$MemInfo;

    iget-object v9, p0, Lcom/android/settings/applications/ProcStatsData;->mContext:Landroid/content/Context;

    iget-wide v11, p0, Lcom/android/settings/applications/ProcStatsData;->memTotalTime:J

    const/4 v13, 0x0

    invoke-direct/range {v8 .. v13}, Lcom/android/settings/applications/ProcStatsData$MemInfo;-><init>(Landroid/content/Context;Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;JLcom/android/settings/applications/ProcStatsData-IA;)V

    iput-object v8, p0, Lcom/android/settings/applications/ProcStatsData;->mMemInfo:Lcom/android/settings/applications/ProcStatsData$MemInfo;

    .line 150
    new-instance v9, Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;

    iget-object v0, p0, Lcom/android/settings/applications/ProcStatsData;->mMemStates:[I

    iget-object v1, p0, Lcom/android/settings/applications/ProcStatsData;->mStates:[I

    invoke-direct {v9, p1, v0, v1}, Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;-><init>([I[I[I)V

    move-object v11, v10

    .line 152
    new-instance v10, Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;

    iget-object v0, p0, Lcom/android/settings/applications/ProcStatsData;->mMemStates:[I

    sget-object v1, Lcom/android/internal/app/procstats/ProcessStats;->NON_CACHED_PROC_STATES:[I

    invoke-direct {v10, p1, v0, v1}, Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;-><init>([I[I[I)V

    .line 155
    invoke-direct {p0, v9, v10}, Lcom/android/settings/applications/ProcStatsData;->getProcs(Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;)Ljava/util/ArrayList;

    move-result-object p1

    invoke-direct {p0, p1, v9, v10}, Lcom/android/settings/applications/ProcStatsData;->createPkgMap(Ljava/util/ArrayList;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;)V

    .line 156
    iget-wide v0, v11, Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;->sysMemZRamWeight:D
    ...
    iget-boolean p1, v11, Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;->hasSwappedOutPss:Z
    ...
    .line 160
    :cond_2
    iget-object p1, p0, Lcom/android/settings/applications/ProcStatsData;->mMemInfo:Lcom/android/settings/applications/ProcStatsData$MemInfo;

    iget-wide v12, p1, Lcom/android/settings/applications/ProcStatsData$MemInfo;->baseCacheRam:J

    move-object v8, p0

    invoke-direct/range {v8 .. v13}, Lcom/android/settings/applications/ProcStatsData;->createOsEntry(Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/procstats/ProcessStats$TotalMemoryUseCollection;J)Lcom/android/settings/applications/ProcStatsPackageEntry;

    move-result-object p0

    .line 162
    iget-object p1, v8, Lcom/android/settings/applications/ProcStatsData;->pkgEntries:Ljava/util/ArrayList;
