...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 71
    sget v0, Lcom/android/settings/R$string;->sort_avg_use:I
    ...
    .line 72
    sget v0, Lcom/android/settings/R$string;->sort_max_use:I
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-static {v2, v1, v0, v3}, Lcom/android/settings/applications/ProcessStatsBase;->launchMemoryDetail(Landroid/app/Activity;Lcom/android/settings/applications/ProcStatsData$MemInfo;Lcom/android/settings/applications/ProcStatsPackageEntry;Z)V
...
.method public refreshUi()V
    ...
    .line 175
    new-instance v7, Lcom/android/settings/applications/ProcessStatsPreference;

    invoke-virtual {v0}, Lcom/android/settings/core/InstrumentedPreferenceFragment;->getPrefContext()Landroid/content/Context;

    move-result-object v5

    invoke-direct {v7, v5}, Lcom/android/settings/applications/ProcessStatsPreference;-><init>(Landroid/content/Context;)V

    .line 176
    iget-object v5, v0, Lcom/android/settings/applications/ProcessStatsUi;->mPm:Landroid/content/pm/PackageManager;

    invoke-virtual {v8, v1, v5}, Lcom/android/settings/applications/ProcStatsPackageEntry;->retrieveUiData(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    .line 179
    invoke-virtual {v7, v2}, Landroidx/preference/Preference;->setOrder(I)V

    .line 180
    iget-object v5, v0, Lcom/android/settings/applications/ProcessStatsUi;->mAppListGroup:Landroidx/preference/PreferenceGroup;
