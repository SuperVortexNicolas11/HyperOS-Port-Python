...
.method public static synthetic $r8$lambda$SqguxwrzfAeyJXyyYdtbvf0on44(Ljava/lang/String;)Ljava/util/HashSet;
    .locals 2
...
.method private enableInteractAcrossProfiles(Z)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/content/pm/CrossProfileApps;->setInteractAcrossProfilesAppOp(Ljava/lang/String;I)V

    .line 434
    iget-object v0, p0, Lcom/android/settings/applications/AppInfoBase;->mPackageName:Ljava/lang/String;

    invoke-direct {p0, p1, v0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->setUserPreferenceForPackage(ZLjava/lang/String;)V
...
.method private getSetFromString(Ljava/lang/String;)Ljava/util/HashSet;
    .locals 0
    ...
    new-instance p1, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda0;

    invoke-direct {p1}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda0;-><init>()V
    ...
    new-instance p1, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda1;

    invoke-direct {p1}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda1;-><init>()V
...
.method private isInstallableInProfile(Landroid/content/Intent;Landroid/os/UserHandle;)Z
    .locals 1
    ...
    .line 577
    invoke-virtual {p0, p1, v0, p2}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;ILandroid/os/UserHandle;)Ljava/util/List;
...
.method private refreshUiForNonConfigurableApps()Z
    ...
    new-instance v3, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda6;

    invoke-direct {v3, p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda6;-><init>(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
    ...
    iget-object v1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mPersonalProfile:Landroid/os/UserHandle;

    .line 530
    invoke-direct {p0, v0, v1}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->isInstallableInProfile(Landroid/content/Intent;Landroid/os/UserHandle;)Z
    ...
    new-instance v3, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda7;

    invoke-direct {v3, p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda7;-><init>(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
...
.method private setUserPreferenceForPackage(ZLjava/lang/String;)V
    .locals 4
    ...
    const-string v1, "connected_apps_allowed_packages"
    ...
    const-string v3, "connected_apps_disallowed_packages"
    ...
    .line 646
    invoke-direct {p0, v0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->getSetFromString(Ljava/lang/String;)Ljava/util/HashSet;

    move-result-object v0

    .line 647
    invoke-direct {p0, v2}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->getSetFromString(Ljava/lang/String;)Ljava/util/HashSet;
    ...
    .line 664
    invoke-static {p2, v2}, Ljava/lang/String;->join(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;

    move-result-object p1

    .line 662
    invoke-static {p0, v3, p1}, Landroid/provider/Settings$Global;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
