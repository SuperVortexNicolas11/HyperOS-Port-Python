...
.field private final mSystemConfigManager:Landroid/os/SystemConfigManager;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/IPackageManager;Landroid/app/admin/DevicePolicyManager;)V
    ...
    .line 70
    new-instance v5, Lcom/android/settings/webview/WebViewUpdateServiceWrapper;

    invoke-direct {v5}, Lcom/android/settings/webview/WebViewUpdateServiceWrapper;-><init>()V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/applications/ApplicationFeatureProviderImpl;-><init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/IPackageManager;Landroid/app/admin/DevicePolicyManager;Lcom/android/settings/webview/WebViewUpdateServiceWrapper;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/IPackageManager;Landroid/app/admin/DevicePolicyManager;Lcom/android/settings/webview/WebViewUpdateServiceWrapper;)V
    .locals 1
    ...
    .line 79
    iput-object p5, p0, Lcom/android/settings/applications/ApplicationFeatureProviderImpl;->mWebViewUpdateServiceWrapper:Lcom/android/settings/webview/WebViewUpdateServiceWrapper;
...
.method public getKeepEnabledPackages()Ljava/util/Set;
    ...
    invoke-virtual {v1}, Lcom/android/settings/webview/WebViewUpdateServiceWrapper;->getDefaultWebViewPackageName()Ljava/lang/String;
    ...
    .line 188
    :cond_4
    iget-object v1, p0, Lcom/android/settings/applications/ApplicationFeatureProviderImpl;->mSystemConfigManager:Landroid/os/SystemConfigManager;

    invoke-virtual {v1}, Landroid/os/SystemConfigManager;->getPreventUserDisablePackages()Ljava/util/List;
    ...
    const-string v1, "com.google.android.feature.JP_CHOICE_SCREEN"
    ...
    :cond_6
    :goto_0
    const-string p0, "AppFeatureProviderImpl"

    const-string v1, "Adding package: com.google.android.apps.setupwizard.searchselector"
