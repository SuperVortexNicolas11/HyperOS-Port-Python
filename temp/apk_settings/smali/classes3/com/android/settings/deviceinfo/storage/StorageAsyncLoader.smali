...
# direct methods
.method public static synthetic $r8$lambda$WZBVPPuljWStgIC9q_a5vTr-Md0(Landroid/content/pm/UserInfo;Landroid/content/pm/UserInfo;)I
    .locals 0
...
.method private getStorageResultsForUsers()Landroid/util/SparseArray;
    ...
    .line 91
    const-string/jumbo v5, "volume_name= \'external_primary\'"
    ...
    .line 99
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader;->getSystemSize()J

    move-result-wide v4

    iput-wide v4, v3, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$StorageResult;->systemSize:J
    ...
    .line 102
    const-string/jumbo v5, "media_type=6"
    ...
    .line 104
    invoke-direct {p0, v5, v8, v4}, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader;->getFilesSize(ILandroid/net/Uri;Landroid/os/Bundle;)J

    move-result-wide v4

    iput-wide v4, v3, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$StorageResult;->documentsSize:J
    ...
    .line 109
    const-string/jumbo v5, "media_type!=1 AND media_type!=3 AND media_type!=2 AND media_type!=6 AND mime_type IS NOT NULL"
    ...
    iput-wide v4, v3, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader$StorageResult;->otherSize:J
...
.method private getSystemSize()J
    .locals 4

    .line 157
    :try_start_0
    iget-object p0, p0, Lcom/android/settings/deviceinfo/storage/StorageAsyncLoader;->mStatsManager:Lcom/android/settingslib/applications/StorageStatsSource;

    sget-object v0, Landroid/os/storage/StorageManager;->UUID_DEFAULT:Ljava/util/UUID;

    invoke-virtual {p0, v0}, Lcom/android/settingslib/applications/StorageStatsSource;->getTotalBytes(Ljava/util/UUID;)J
    ...
    const-string v1, "Exception in calculating System category size"
