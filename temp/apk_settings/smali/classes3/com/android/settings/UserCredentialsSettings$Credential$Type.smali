...
.field public static final enum WAPI_AS_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;

.field public static final enum WAPI_USER_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;
...
.method private static synthetic $values()[Lcom/android/settings/UserCredentialsSettings$Credential$Type;
    ...
    sget-object v3, Lcom/android/settings/UserCredentialsSettings$Credential$Type;->WAPI_AS_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;

    sget-object v4, Lcom/android/settings/UserCredentialsSettings$Credential$Type;->WAPI_USER_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/android/settings/UserCredentialsSettings$Credential$Type;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "WAPI_AS_CERTIFICATE"

    const/4 v3, 0x3

    invoke-direct {v0, v2, v3, v1}, Lcom/android/settings/UserCredentialsSettings$Credential$Type;-><init>(Ljava/lang/String;I[Ljava/lang/String;)V

    sput-object v0, Lcom/android/settings/UserCredentialsSettings$Credential$Type;->WAPI_AS_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;
    ...
    const-string v2, "WAPI_USER_CERTIFICATE"

    const/4 v3, 0x4

    invoke-direct {v0, v2, v3, v1}, Lcom/android/settings/UserCredentialsSettings$Credential$Type;-><init>(Ljava/lang/String;I[Ljava/lang/String;)V

    sput-object v0, Lcom/android/settings/UserCredentialsSettings$Credential$Type;->WAPI_USER_CERTIFICATE:Lcom/android/settings/UserCredentialsSettings$Credential$Type;
