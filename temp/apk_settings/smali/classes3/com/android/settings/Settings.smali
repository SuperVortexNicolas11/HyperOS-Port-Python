...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/Settings$MiuiMasterClearActivity;,
        Lcom/android/settings/Settings$FlashNotificationsActivity;,
        Lcom/android/settings/Settings$MagnificationActivity;,
        Lcom/android/settings/Settings$ContentProtectionSettingsActivity;,
        Lcom/android/settings/Settings$ContactsStorageSettingsActivity;,
        Lcom/android/settings/Settings$HearingDevicesPairingActivity;,
        Lcom/android/settings/Settings$HearingDevicesActivity;,
        Lcom/android/settings/Settings$ResetMobileNetworkSettingsActivity;,
        Lcom/android/settings/Settings$ScreenTimeoutActivity;,
        Lcom/android/settings/Settings$PreviouslyConnectedDeviceActivity;,
        Lcom/android/settings/Settings$DoubleTapPowerSettingsActivity;,
        Lcom/android/settings/Settings$OneHandedSettingsActivity;,
        Lcom/android/settings/Settings$AdaptiveBrightnessActivity;,
        Lcom/android/settings/Settings$ScreenProjectionActivity;,
        Lcom/android/settings/Settings$WifiAssistantSettingsActivity;,
        Lcom/android/settings/Settings$ManageVoiceActivity;,
        Lcom/android/settings/Settings$DeviceNameEditActivity;,
        Lcom/android/settings/Settings$ManageAccountsSettingsActivity;,
        Lcom/android/settings/Settings$WirelessSettingsActivity;,
        Lcom/android/settings/Settings$MiuiApnEditorActivity;,
        Lcom/android/settings/Settings$EdgeSettingsActivity;,
        Lcom/android/settings/Settings$MiuiSilentModeAcivity;,
        Lcom/android/settings/Settings$PadStatusActivity;,
        Lcom/android/settings/Settings$PageLayoutActivity;,
        Lcom/android/settings/Settings$FontSettingsActivity;,
        Lcom/android/settings/Settings$ZonePickerActivity;,
        Lcom/android/settings/Settings$NotificationAppListSettingsActivity;,
        Lcom/android/settings/Settings$NotificationFilterActivity;,
        Lcom/android/settings/Settings$MiracastSettingsActivity;,
        Lcom/android/settings/Settings$TetherWifiSettingsActivity;,
        Lcom/android/settings/Settings$BatterySettingsActivity;,
        Lcom/android/settings/Settings$SimListEntranceActivity;,
        Lcom/android/settings/Settings$SimGprsSettings;,
        Lcom/android/settings/Settings$DualWifiSettingsActivity;,
        ...
        Lcom/android/settings/Settings$SatelliteSettingActivity;,
        Lcom/android/settings/Settings$CellularSecuritySettingsActivity;,
        ...
        Lcom/android/settings/Settings$NotificationExcludeClassificationActivity;,
        Lcom/android/settings/Settings$NotificationExcludeSummarizationActivity;,
        ...
        Lcom/android/settings/Settings$ModesSettingsActivity;,
        Lcom/android/settings/Settings$ModeSettingsActivity;,
        ...
        Lcom/android/settings/Settings$MiuiNfcActivity;,
        ...
        Lcom/android/settings/Settings$ManageAdaptiveNotificationsActivity;,
        ...
        Lcom/android/settings/Settings$ColorContrastActivity;,
        ...
        Lcom/android/settings/Settings$LockScreenNotificationsSettingsActivity;,
        ...
        Lcom/android/settings/Settings$AccessibilityEditShortcutsActivity;,
        ...
        Lcom/android/settings/Settings$AppStorageSettingsActivity;,
        ...
        Lcom/android/settings/Settings$NumberingSystemSettingsActivity;,
        Lcom/android/settings/Settings$MeasurementSystemSettingsActivity;,
        Lcom/android/settings/Settings$FirstDayOfWeekSettingsActivity;,
        Lcom/android/settings/Settings$TemperatureUnitSettingsActivity;,
        Lcom/android/settings/Settings$RegionalPreferencesActivity;,
        Lcom/android/settings/Settings$RegionSettingsActivity;,
        ...
        Lcom/android/settings/Settings$PhysicalKeyboardLayoutPickerActivity;,
        Lcom/android/settings/Settings$PhysicalKeyboardActivity;,
        Lcom/android/settings/Settings$KeyboardLayoutPickerActivity;,
        Lcom/android/settings/Settings$AddNetworkActivity;,
        Lcom/android/settings/Settings$DualWifiP2pSettingsActivity;,
        ...
        Lcom/android/settings/Settings$PrivateSpaceBiometricSettingsActivity;,
        ...
        Lcom/android/settings/Settings$BluetoothDashboardActivity;,
