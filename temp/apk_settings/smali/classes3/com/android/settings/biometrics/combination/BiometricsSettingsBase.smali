...
# static fields
.field static final BIOMETRIC_AUTH_REQUEST:I = 0x7d4
...
.method private synthetic lambda$onRetryPreferenceTreeClick$0(Landroid/content/Context;Landroidx/preference/Preference;ZIIJ)V
    ...
    :cond_1
    :try_start_0
    iget-wide v3, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mGkPwHandle:J

    iget v5, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mUserId:I
    :try_end_0
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v7}, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->requestGatekeeperHat(Landroid/content/Context;JIJ)[B
    ...
    invoke-virtual {p1, p5, p0}, Landroid/os/Bundle;->putByteArray(Ljava/lang/String;[B)V

    .line 185
    const-string/jumbo p0, "sensor_id"

    invoke-virtual {p1, p0, p4}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 186
    const-string p0, "challenge"

    invoke-virtual {p1, p0, v6, v7}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V

    .line 187
    invoke-direct {v1, p2}, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->onFaceOrFingerprintPreferenceTreeClick(Landroidx/preference/Preference;)V
    :try_end_1
    ...
    iput-object p0, v1, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mRetryPreferenceKey:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mRetryPreferenceExtra:Landroid/os/Bundle;

    const/4 p0, 0x1

    .line 192
    iput-boolean p0, v1, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mConfirmCredential:Z

    .line 193
    invoke-virtual {v1}, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->launchChooseOrConfirmLock()V

    goto :goto_2

    .line 195
    :cond_2
    invoke-virtual {v1}, Lcom/android/settings/dashboard/DashboardFragment;->getLogTag()Ljava/lang/String;

    move-result-object p1

    const-string p2, "face generateChallenge fail"
    ...
    .line 196
    iput-boolean p0, v1, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mDoNotFinishActivity:Z
...
.method private synthetic lambda$onRetryPreferenceTreeClick$1(Landroid/content/Context;Landroidx/preference/Preference;ZIIJ)V
    ...
    invoke-virtual {p1, p4, p0}, Landroid/os/Bundle;->putByteArray(Ljava/lang/String;[B)V
    ...
    const-string p2, "fingerprint generateChallenge fail"
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 344
    iput-boolean v3, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mBiometricsAuthenticationRequested:Z
    ...
    :cond_3
    :goto_0
    iput-boolean v3, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mConfirmCredential:Z
    ...
    sget p3, Lcom/google/android/setupdesign/R$anim;->sud_slide_next_in:I
    ...
    invoke-direct {p0, p2, p3}, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->retryPreferenceKey(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-boolean p3, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mBiometricsAuthenticationRequested:Z
    ...
    .line 323
    iput-boolean p1, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mBiometricsAuthenticationRequested:Z

    .line 324
    iget p2, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mUserId:I

    invoke-static {p0, v2, p2, p1}, Lcom/android/settings/Utils;->launchBiometricPromptForMandatoryBiometrics(Landroidx/fragment/app/Fragment;IIZ)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 132
    :cond_1
    const-string v0, "biometrics_auth_requested"
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mRetryPreferenceExtra:Landroid/os/Bundle;
    ...
    iget-boolean p0, p0, Lcom/android/settings/biometrics/combination/BiometricsSettingsBase;->mBiometricsAuthenticationRequested:Z
