...
# direct methods
.method public static synthetic $r8$lambda$YNGHJEANIoTtqjKE85JQNffnAa8(Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$bPicldYtp3_kxCxPhFk77EzPTMg(Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$hHt1zTiCBzP59l1BdfjiOptTZO0(Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method onEnrollmentProgress(II)V
    ...
    .line 161
    iget-object v1, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mEnrollHelper:Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollHelper;
    ...
    .line 166
    iget-object v1, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mTargetAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v1}, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollHelper;->getNextGuidedEnrollmentPoint()Landroid/graphics/PointF;

    move-result-object v1

    .line 171
    iget v2, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mCurrentX:F
    ...
    .line 173
    new-instance v3, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable$$ExternalSyntheticLambda0;

    invoke-direct {v3, p0}, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;)V

    invoke-virtual {v2, v3}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    .line 178
    iget v3, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mCurrentY:F
    ...
    .line 191
    new-instance v6, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable$$ExternalSyntheticLambda2;

    invoke-direct {v6, p0}, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable$$ExternalSyntheticLambda2;-><init>(Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;)V
    ...
    iput-object v6, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mTargetAnimatorSet:Landroid/animation/AnimatorSet;
    ...
    .line 201
    iget-object v6, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mTargetAnimatorSet:Landroid/animation/AnimatorSet;

    invoke-virtual {v6, v4, v5}, Landroid/animation/AnimatorSet;->setDuration(J)Landroid/animation/AnimatorSet;

    .line 202
    iget-object v4, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mTargetAnimatorSet:Landroid/animation/AnimatorSet;

    iget-object v5, p0, Lcom/android/settings/biometrics/fingerprint/UdfpsEnrollDrawable;->mTargetAnimListener:Landroid/animation/Animator$AnimatorListener;
