...
.method public static getImageBitmap(Landroid/content/Context;Ljava/io/File;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static saveUserAvatarByUrl(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    ...
    :goto_0
    :try_start_2
    invoke-static {v1}, Lcom/xiaomi/accountsdk/account/utils/BitmapUtils;->closeQuietly(Ljava/io/OutputStream;)V
    :try_end_2
    ...
    :goto_1
    :try_start_3
    const-string p2, "Save file exception"

    invoke-static {v0, p2, p0}, Lcom/xiaomi/accountsdk/utils/AccountLogger;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_4
    const-string p1, "Get data exception"

    invoke-static {v0, p1, p0}, Lcom/xiaomi/accountsdk/utils/AccountLogger;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
