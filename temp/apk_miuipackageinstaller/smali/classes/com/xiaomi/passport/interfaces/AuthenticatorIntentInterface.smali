...
# static fields
.field private static volatile sImpl:Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;
...
.method public static getAccountHomActivityIntent(Landroid/content/Context;)Landroid/content/Intent;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;->getAccountHomActivityIntentImpl(Landroid/content/Context;)Landroid/content/Intent;
...
.method public static getJsbWebViewActivityIntent(Landroid/content/Context;Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig;)Landroid/content/Intent;
    .locals 1

    sget-object v0, Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;->sImpl:Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;

    invoke-virtual {v0, p0, p1}, Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;->getJsbWebViewActivityIntentImpl(Landroid/content/Context;Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig;)Landroid/content/Intent;
...
.method public static getQRCodeAuthActivityIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    .locals 1

    sget-object v0, Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;->sImpl:Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;

    invoke-virtual {v0, p0, p1}, Lcom/xiaomi/passport/interfaces/AuthenticatorIntentInterface;->getQRCodeAuthActivityIntentImpl(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
...
# virtual methods
.method public abstract getAccountHomActivityIntentImpl(Landroid/content/Context;)Landroid/content/Intent;
.end method
...
.method public abstract getJsbWebViewActivityIntentImpl(Landroid/content/Context;Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig;)Landroid/content/Intent;
.end method

.method public abstract getQRCodeAuthActivityIntentImpl(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
.end method
