...
.method public static getAccountFamilyWebPageIntent(Landroid/content/Context;Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;)Landroid/content/Intent;
    .locals 4
    ...
    new-array v1, v3, [Lcom/xiaomi/passport/webview/UrlInterceptor;

    new-array v2, v3, [Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;

    filled-new-array {p1}, [Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;

    move-result-object p1

    invoke-static {v1, v2, p1}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;->create([Lcom/xiaomi/passport/webview/UrlInterceptor;[Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;[Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;
    ...
    const-string p1, "jsb method: getServiceData can not be null"
...
.method public static getAccountHomePageIntent(Landroid/content/Context;)Landroid/content/Intent;
    .locals 0
    ...
    invoke-virtual {p0}, Lcom/xiaomi/passport/accountmanager/XiaomiAccountManager;->getAccountHomeActivityIntent()Landroid/content/Intent;
...
.method public static getAccountLoginPageIntent(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Parcelable;)Landroid/content/Intent;
    .locals 0
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/xiaomi/passport/accountmanager/XiaomiAccountManager;->getAccountLoginActivityIntent(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Parcelable;)Landroid/content/Intent;
...
.method public static getFindPasswordPageIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v1, v0}, Lcom/xiaomi/passport/utils/AnyUrl;->make(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
...
.method private static getModifySafeInfoWebPageIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    .locals 4
    ...
    invoke-static {v0, v1}, Lcom/xiaomi/passport/utils/AnyUrl;->make(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
...
.method public static getRegisterPageIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2, v0}, Lcom/xiaomi/passport/utils/AnyUrl;->make(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
...
.method public static getSNSBindPageIntent(Landroid/content/Context;Lcom/xiaomi/passport/snscorelib/internal/entity/SNSBindParameter;)Landroid/content/Intent;
    ...
    new-instance v2, Lcom/xiaomi/passport/ui/webview/SNSCookieBindUrlInterceptor;

    iget-object v3, p1, Lcom/xiaomi/passport/snscorelib/internal/entity/SNSBindParameter;->hasLocalChannel:Ljava/lang/Boolean;

    invoke-direct {v2, v3}, Lcom/xiaomi/passport/ui/webview/SNSCookieBindUrlInterceptor;-><init>(Ljava/lang/Boolean;)V

    new-array v3, v1, [Lcom/xiaomi/passport/webview/UrlInterceptor;

    const/4 v4, 0x0

    aput-object v2, v3, v4

    new-instance v2, Lcom/xiaomi/passport/ui/webview/SNSCookieBindULPT;
    ...
    invoke-direct {v2, v5, p1}, Lcom/xiaomi/passport/ui/webview/SNSCookieBindULPT;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    new-array p1, v1, [Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;

    aput-object v2, p1, v4

    new-array v1, v4, [Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;

    .line 5
    invoke-static {v3, p1, v1}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;->create([Lcom/xiaomi/passport/webview/UrlInterceptor;[Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;[Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;
...
.method public static getSNSBindPageIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    .locals 3
    ...
    .line 11
    invoke-static {v1, v2}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$ActionBarConfig;->create(Ljava/lang/String;Ljava/lang/String;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$ActionBarConfig;
    ...
    new-instance v1, Lcom/xiaomi/passport/ui/webview/SNSCodeUrlInterceptor;

    invoke-direct {v1}, Lcom/xiaomi/passport/ui/webview/SNSCodeUrlInterceptor;-><init>()V

    new-array v0, v0, [Lcom/xiaomi/passport/webview/UrlInterceptor;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    new-array v1, v2, [Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;

    new-array v2, v2, [Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;

    .line 12
    invoke-static {v0, v1, v2}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;->create([Lcom/xiaomi/passport/webview/UrlInterceptor;[Lcom/xiaomi/passport/webview/UrlLoadPrepareTask;[Lcom/xiaomi/passport/jsb/ParcelablePassportJsbMethod;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$UrlInteractionStrategy;
...
.method public static getUserMainWebPageIntent(Landroid/content/Context;)Landroid/content/Intent;
    .locals 4
    ...
    new-instance v1, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$Builder;

    invoke-direct {v1}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$Builder;-><init>()V

    invoke-virtual {v1, v0}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$Builder;->url(Ljava/lang/String;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$Builder;
    ...
    invoke-static {v1, v2, v3}, Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$CookieFillConfig;->create(Ljava/lang/String;ZLjava/lang/String;)Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig$CookieFillConfig;
    ...
    invoke-static {p0, v0}, Lcom/xiaomi/passport/ui/internal/PassportJsbWebViewActivity;->makeIntent(Landroid/content/Context;Lcom/xiaomi/passport/jsb/PassportJsbWebViewPageConfig;)Landroid/content/Intent;
