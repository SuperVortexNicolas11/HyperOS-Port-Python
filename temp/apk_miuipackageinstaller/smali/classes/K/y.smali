...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILO/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LK/y;->a:Landroid/content/Context;

    iput-object p2, p0, LK/y;->b:Ljava/lang/String;

    iput-object p3, p0, LK/y;->c:Ljava/io/File;

    iput-object p4, p0, LK/y;->d:Ljava/util/concurrent/Callable;

    iput p5, p0, LK/y;->e:I

    iput-object p6, p0, LK/y;->f:LO/h;
...
.method private final C(Z)V
    ...
    invoke-virtual {p0}, LK/y;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_6

    iget-object v2, p0, LK/y;->a:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getDatabasePath(Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    iget-object v3, p0, LK/y;->g:LK/f;
    ...
    :cond_0
    iget-boolean v3, v3, LK/f;->s:Z

    new-instance v6, LQ/a;

    iget-object v7, p0, LK/y;->a:Landroid/content/Context;
    ...
    invoke-direct {v6, v1, v7, v3}, LQ/a;-><init>(Ljava/lang/String;Ljava/io/File;Z)V
    ...
    :try_start_0
    invoke-static {v6, v3, v7, v5}, LQ/a;->c(LQ/a;ZILjava/lang/Object;)V
    ...
    :try_start_1
    invoke-static {v2, v8}, LL3/k;->e(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0, v2, p1}, LK/y;->f(Ljava/io/File;Z)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-virtual {v6}, LQ/a;->d()V
    ...
    invoke-static {v2}, LM/b;->c(Ljava/io/File;)I
    ...
    invoke-virtual {v5, v3, v4}, LK/f;->a(II)Z
    ...
    :cond_4
    :try_start_6
    iget-object v3, p0, LK/y;->a:Landroid/content/Context;
...
.method private final f(Ljava/io/File;Z)V
    ...
    iget-object v0, p0, LK/y;->b:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, LK/y;->a:Landroid/content/Context;
    ...
    :cond_0
    iget-object v0, p0, LK/y;->c:Ljava/io/File;

    if-eqz v0, :cond_1

    new-instance v0, Ljava/io/FileInputStream;

    iget-object v1, p0, LK/y;->c:Ljava/io/File;
    ...
    :cond_1
    iget-object v0, p0, LK/y;->d:Ljava/util/concurrent/Callable;
    ...
    :goto_0
    iget-object v1, p0, LK/y;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v2}, LM/c;->a(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/channels/FileChannel;)V
    ...
    invoke-direct {p0, v1, p2}, LK/y;->g(Ljava/io/File;Z)V
...
.method public declared-synchronized close()V
    ...
    :try_start_0
    invoke-virtual {p0}, LK/y;->e()LO/h;

    move-result-object v0

    invoke-interface {v0}, LO/h;->close()V

    const/4 v0, 0x0

    iput-boolean v0, p0, LK/y;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public w0()LO/g;
    ...
    invoke-direct {p0, v0}, LK/y;->C(Z)V
