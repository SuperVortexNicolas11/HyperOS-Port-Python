...
.method bridge synthetic i(Lr0/a;F)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lh0/d;->r(Lr0/a;F)Ljava/lang/Float;
...
.method public p()F
    ...
    invoke-virtual {p0, v0, v1}, Lh0/d;->q(Lr0/a;F)F
...
.method q(Lr0/a;F)F
    ...
    :cond_0
    invoke-virtual {p1}, Lr0/a;->f()F

    move-result v0

    invoke-virtual {p1}, Lr0/a;->c()F

    move-result p1

    invoke-static {v0, p1, p2}, Lq0/g;->i(FFF)F
...
.method r(Lr0/a;F)Ljava/lang/Float;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lh0/d;->q(Lr0/a;F)F
