...
# instance fields
.field private q:Landroidx/preference/DialogPreference;
...
.field private w:Landroid/graphics/drawable/BitmapDrawable;
...
.method private q0(Landroid/app/Dialog;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/preference/f;->r0()V
...
.method public d0(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iput p1, p0, Landroidx/preference/f;->x:I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/a$a;->p(Ljava/lang/CharSequence;)Landroidx/appcompat/app/a$a;

    move-result-object p1

    iget-object v0, p0, Landroidx/preference/f;->w:Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-virtual {p1, v0, p0}, Landroidx/appcompat/app/a$a;->m(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/a$a;

    move-result-object p1

    iget-object v0, p0, Landroidx/preference/f;->t:Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, p0}, Landroidx/appcompat/app/a$a;->j(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/a$a;
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/f;->n0(Landroid/content/Context;)Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Landroidx/preference/f;->m0(Landroid/view/View;)V

    invoke-virtual {p1, v0}, Landroidx/appcompat/app/a$a;->q(Landroid/view/View;)Landroidx/appcompat/app/a$a;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/a$a;->g(Ljava/lang/CharSequence;)Landroidx/appcompat/app/a$a;

    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/f;->p0(Landroidx/appcompat/app/a$a;)V

    invoke-virtual {p1}, Landroidx/appcompat/app/a$a;->a()Landroidx/appcompat/app/a;

    move-result-object p1

    invoke-virtual {p0}, Landroidx/preference/f;->l0()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1}, Landroidx/preference/f;->q0(Landroid/app/Dialog;)V

    :cond_1
    return-object p1
.end method

.method public k0()Landroidx/preference/DialogPreference;
    .locals 2

    iget-object v0, p0, Landroidx/preference/f;->q:Landroidx/preference/DialogPreference;
    ...
    invoke-interface {v1, v0}, Landroidx/preference/DialogPreference$a;->v(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Landroidx/preference/DialogPreference;

    iput-object v0, p0, Landroidx/preference/f;->q:Landroidx/preference/DialogPreference;
...
.method protected n0(Landroid/content/Context;)Landroid/view/View;
    .locals 2
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iput p2, p0, Landroidx/preference/f;->x:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, v1}, Landroidx/preference/DialogPreference$a;->v(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object p1

    check-cast p1, Landroidx/preference/DialogPreference;

    iput-object p1, p0, Landroidx/preference/f;->q:Landroidx/preference/DialogPreference;
    ...
    iget-object p1, p0, Landroidx/preference/f;->q:Landroidx/preference/DialogPreference;
    ...
    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->P0()I
    ...
    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->O0()Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroidx/preference/f;->w:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iput v0, p0, Landroidx/preference/f;->v:I
    ...
    iput-object v0, p0, Landroidx/preference/f;->w:Landroid/graphics/drawable/BitmapDrawable;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget p1, p0, Landroidx/preference/f;->x:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/f;->o0(Z)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroidx/preference/f;->v:I
