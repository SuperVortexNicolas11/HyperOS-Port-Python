...
.method protected static d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/s;->h(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/s;->h(Ljava/util/List;Landroid/view/View;I)Z

    move-result v5

    if-nez v5, :cond_2

    invoke-static {v4}, Landroidx/core/view/P;->I(Landroid/view/View;)Ljava/lang/String;
...
.method f(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroidx/core/view/T;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/s;->f(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method j(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/s;->j(Ljava/util/Map;Landroid/view/View;)V
...
.method o(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroidx/core/view/P;->I(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Landroidx/core/view/P;->I0(Landroid/view/View;Ljava/lang/String;)V
...
.method s(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/s$c;-><init>(Landroidx/fragment/app/s;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method x(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/s$b;-><init>(Landroidx/fragment/app/s;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method y(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Landroidx/core/view/P;->I0(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroidx/fragment/app/s$a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/fragment/app/s$a;-><init>(Landroidx/fragment/app/s;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroidx/core/view/D;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/core/view/D;
