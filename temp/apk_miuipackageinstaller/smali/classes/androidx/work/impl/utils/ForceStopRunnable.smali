...
.field private final b:Landroidx/work/impl/P;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/P;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {p2}, Landroidx/work/impl/P;->l()Lb0/q;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lb0/q;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {v1}, Landroidx/work/impl/P;->p()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/b;->i(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;)Z
    ...
    sget-object v9, LV/z$c;->a:LV/z$c;

    iget-object v10, v8, La0/u;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, La0/v;->r(LV/z$c;Ljava/lang/String;)I

    iget-object v9, v8, La0/u;->a:Ljava/lang/String;

    const/16 v10, -0x200

    invoke-interface {v2, v9, v10}, La0/v;->p(Ljava/lang/String;I)V

    iget-object v8, v8, La0/u;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, La0/v;->g(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, La0/r;->b()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {v0}, Landroidx/work/impl/P;->s()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {v0}, Landroidx/work/impl/P;->l()Lb0/q;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lb0/q;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lb0/q;

    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {v1}, Landroidx/work/impl/P;->i()Landroidx/work/a;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/work/a;->a()LV/b;
    ...
    invoke-virtual {v0, v1, v2}, Lb0/q;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/P;

    invoke-virtual {v2}, Landroidx/work/impl/P;->n()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, Lb0/e;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lb0/q;

    invoke-virtual {v2}, Lb0/q;->a()J
    ...
    invoke-static {v6}, Lb0/f;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, Lb0/g;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, Lb0/h;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, LV/n;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    invoke-static {v1, v0}, Lb0/r;->b(Landroid/content/Context;Landroidx/work/a;)Z
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/P;->r()V
    ...
    invoke-static {v1}, Landroidx/core/os/k;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v1, v0}, LV/n;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, v3, v4, v2}, LV/n;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, LV/n;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, LV/n;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/P;->r()V
