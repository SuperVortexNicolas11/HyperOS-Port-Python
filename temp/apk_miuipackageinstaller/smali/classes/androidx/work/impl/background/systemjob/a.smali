...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/work/impl/background/systemjob/a;->c:Ljava/lang/String;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;LV/b;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Landroidx/work/impl/background/systemjob/a;->b:LV/b;
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemjob/a;->a:Landroid/content/ComponentName;

    return-void
.end method

.method private static b(LV/d$c;)Landroid/app/job/JobInfo$TriggerContentUri;
    .locals 2

    invoke-virtual {p0}, LV/d$c;->b()Z

    move-result v0

    new-instance v1, Landroid/app/job/JobInfo$TriggerContentUri;

    invoke-virtual {p0}, LV/d$c;->a()Landroid/net/Uri;
...
.method static c(LV/o;)I
    ...
    sget-object v2, Landroidx/work/impl/background/systemjob/a;->c:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, p0}, LV/n;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method static d(Landroid/app/job/JobInfo$Builder;LV/o;)V
    .locals 2
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/a;->c(LV/o;)I
...
# virtual methods
.method a(La0/u;I)Landroid/app/job/JobInfo;
    .locals 10

    iget-object v0, p1, La0/u;->j:LV/d;
    ...
    invoke-static {p2, v1}, Landroidx/work/impl/background/systemjob/a;->d(Landroid/app/job/JobInfo$Builder;LV/o;)V
    ...
    iget-object v1, p1, La0/u;->l:LV/a;

    sget-object v4, LV/a;->b:LV/a;
    ...
    :goto_0
    iget-wide v4, p1, La0/u;->m:J

    invoke-virtual {p2, v4, v5, v1}, Landroid/app/job/JobInfo$Builder;->setBackoffCriteria(JI)Landroid/app/job/JobInfo$Builder;

    :cond_1
    invoke-virtual {p1}, La0/u;->c()J

    move-result-wide v4

    iget-object v1, p0, Landroidx/work/impl/background/systemjob/a;->b:LV/b;
    ...
    check-cast v8, LV/d$c;

    invoke-static {v8}, Landroidx/work/impl/background/systemjob/a;->b(LV/d$c;)Landroid/app/job/JobInfo$TriggerContentUri;
