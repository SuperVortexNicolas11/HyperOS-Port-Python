...
.field private final k:Landroidx/work/impl/N;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0, v0}, Landroidx/work/impl/background/systemalarm/g;-><init>(Landroid/content/Context;Landroidx/work/impl/u;Landroidx/work/impl/P;Landroidx/work/impl/N;)V

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Landroidx/work/impl/u;Landroidx/work/impl/P;Landroidx/work/impl/N;)V
    .locals 3
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/g;->e:Landroidx/work/impl/P;

    .line 6
    new-instance p1, Landroidx/work/impl/background/systemalarm/b;

    .line 7
    invoke-virtual {p3}, Landroidx/work/impl/P;->i()Landroidx/work/a;
    ...
    invoke-direct {p1, v0, v1, v2}, Landroidx/work/impl/background/systemalarm/b;-><init>(Landroid/content/Context;LV/b;Landroidx/work/impl/B;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->k()LV/w;

    move-result-object v0

    invoke-direct {p1, v0}, Lb0/C;-><init>(LV/w;)V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->c:Lb0/C;
    ...
    .line 9
    :cond_1
    invoke-virtual {p3}, Landroidx/work/impl/P;->m()Landroidx/work/impl/u;
    ...
    .line 10
    invoke-virtual {p3}, Landroidx/work/impl/P;->q()Lc0/b;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->b:Lc0/b;
    ...
    .line 11
    :cond_2
    new-instance p4, Landroidx/work/impl/O;

    invoke-direct {p4, p2, p1}, Landroidx/work/impl/O;-><init>(Landroidx/work/impl/u;Lc0/b;)V

    :goto_2
    iput-object p4, p0, Landroidx/work/impl/background/systemalarm/g;->k:Landroidx/work/impl/N;
...
.method private l()V
    ...
    invoke-static {v0, v1}, Lb0/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->e:Landroidx/work/impl/P;
    ...
    invoke-interface {v1, v2}, Lc0/b;->c(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public a(Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p1, v1, p2}, LV/n;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public c(La0/m;Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->b:Lc0/b;
    ...
    invoke-static {v2, p1, p2}, Landroidx/work/impl/background/systemalarm/b;->d(Landroid/content/Context;La0/m;Z)Landroid/content/Intent;
...
.method d()V
    ...
    invoke-virtual {v2, v1, v3}, LV/n;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->b:Lc0/b;

    invoke-interface {v2}, Lc0/b;->b()Lc0/a;
    ...
    invoke-interface {v2}, Lc0/a;->u0()Z
...
.method g()Landroidx/work/impl/P;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->e:Landroidx/work/impl/P;
...
.method h()Lb0/C;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->c:Lb0/C;

    return-object v0
.end method

.method i()Landroidx/work/impl/N;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->k:Landroidx/work/impl/N;
