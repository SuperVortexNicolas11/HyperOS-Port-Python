.class Landroidx/core/widget/i$f;
...
.method private b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-direct {p0}, Landroidx/core/widget/i$f;->a()Landroid/content/Intent;

    move-result-object v0

    invoke-direct {p0, p2}, Landroidx/core/widget/i$f;->e(Landroid/widget/TextView;)Z
...
.method private c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-direct {p0, v1, p1}, Landroidx/core/widget/i$f;->f(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private g(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Landroidx/core/widget/i$f;->b:Landroid/widget/TextView;
    ...
    iget-boolean v2, p0, Landroidx/core/widget/i$f;->f:Z
    ...
    iput-boolean v5, p0, Landroidx/core/widget/i$f;->f:Z
    ...
    iput-object v2, p0, Landroidx/core/widget/i$f;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Landroidx/core/widget/i$f;->d:Ljava/lang/reflect/Method;

    iput-boolean v5, p0, Landroidx/core/widget/i$f;->e:Z
    :try_end_0
    ...
    iput-boolean v4, p0, Landroidx/core/widget/i$f;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Landroidx/core/widget/i$f;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroidx/core/widget/i$f;->c:Ljava/lang/Class;
    ...
    iget-object v2, p0, Landroidx/core/widget/i$f;->d:Ljava/lang/reflect/Method;
    ...
    :cond_3
    invoke-direct {p0, v0, v1}, Landroidx/core/widget/i$f;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Landroidx/core/widget/i$f;->b:Landroid/widget/TextView;

    invoke-direct {p0, v3, v7}, Landroidx/core/widget/i$f;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method d()Landroid/view/ActionMode$Callback;
    ...
    iget-object v0, p0, Landroidx/core/widget/i$f;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-direct {p0, p2}, Landroidx/core/widget/i$f;->g(Landroid/view/Menu;)V
