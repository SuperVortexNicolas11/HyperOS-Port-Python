...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/P;->p0(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/P;->r0(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, p3}, Landroidx/core/view/P;->F0(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/P;->N(Landroid/view/View;)Z
...
.method private static u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/c;->getThemeResId()I
...
.method protected h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    .locals 1
...
.method protected j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    .locals 1
...
.method protected l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    .locals 1
...
.method protected m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    .locals 1
...
.method protected n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    .locals 1
...
.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    .locals 1
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/Q;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/n;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
