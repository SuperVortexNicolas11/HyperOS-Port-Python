...
.field final i:Landroidx/appcompat/widget/I;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/p;->c:Landroidx/appcompat/view/menu/g;
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/p;->d:Landroidx/appcompat/view/menu/f;
    ...
    new-instance p3, Landroidx/appcompat/widget/I;

    const/4 p6, 0x0

    invoke-direct {p3, p1, p6, p4, p5}, Landroidx/appcompat/widget/I;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;
...
.method private w()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/G;->A(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;

    iget v3, p0, Landroidx/appcompat/view/menu/p;->t:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/G;->D(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->d:Landroidx/appcompat/view/menu/f;
    ...
    invoke-static {v0, v3, v4, v5}, Landroidx/appcompat/view/menu/k;->k(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/G;->C(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/G;->F(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/G;->E(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/G;->m()Landroid/widget/ListView;
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/p;->c:Landroidx/appcompat/view/menu/g;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/p;->c:Landroidx/appcompat/view/menu/g;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/p;->d:Landroidx/appcompat/view/menu/f;

    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/G;->j(Landroid/widget/ListAdapter;)V
...
.method public a()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/p;->w()Z
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->c:Landroidx/appcompat/view/menu/g;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/p;->o:Landroidx/appcompat/view/menu/m$a;
...
.method public d(Landroidx/appcompat/view/menu/q;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/p;->o:Landroidx/appcompat/view/menu/m$a;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/p;->c:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/g;->e(Z)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/p;->i:Landroidx/appcompat/widget/I;

    invoke-virtual {v2}, Landroidx/appcompat/widget/G;->b()I
    ...
    invoke-static {v5}, Landroidx/core/view/P;->A(Landroid/view/View;)I
...
.method public g(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/p;->o:Landroidx/appcompat/view/menu/m$a;
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/G;->d(I)V
...
.method public updateMenuView(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/p;->d:Landroidx/appcompat/view/menu/f;
