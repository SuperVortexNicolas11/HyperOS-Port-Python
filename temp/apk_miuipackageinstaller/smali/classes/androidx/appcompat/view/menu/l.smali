...
.method private a()Landroidx/appcompat/view/menu/k;
    ...
    invoke-direct/range {v8 .. v14}, Landroidx/appcompat/view/menu/p;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V

    :goto_0
    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->b:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->h(Landroidx/appcompat/view/menu/g;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->r(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->l(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->o(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/l;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->p(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->s(Z)V
    ...
    invoke-static {p4}, Landroidx/core/view/P;->A(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Landroidx/core/view/m;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/k;->q(I)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/k;->t(I)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->n(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Landroidx/appcompat/view/menu/o;->a()V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/k;->o(Z)V
