...
.field private final l:Landroidx/appcompat/widget/H;
...
.field private x:Landroidx/appcompat/view/menu/m$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/H;
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->A()I
...
.method private C(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-static {v1, v5, v2, v4}, Landroidx/appcompat/view/menu/k;->k(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->w()Landroidx/appcompat/widget/I;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/G;->j(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/G;->C(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/G;->D(I)V
    ...
    invoke-direct {p0, v1, p1}, Landroidx/appcompat/view/menu/d;->z(Landroidx/appcompat/view/menu/d$d;Landroidx/appcompat/view/menu/g;)Landroid/view/View;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/I;->S(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/I;->P(Ljava/lang/Object;)V

    invoke-direct {p0, v2}, Landroidx/appcompat/view/menu/d;->B(I)I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/G;->A(Landroid/view/View;)V
    ...
    :goto_3
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/G;->f(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/G;->K(Z)V

    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/G;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/G;->d(I)V

    :cond_9
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/k;->j()Landroid/graphics/Rect;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/G;->E(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/I;Landroidx/appcompat/view/menu/g;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->i:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/G;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/G;->m()Landroid/widget/ListView;
...
.method private w()Landroidx/appcompat/widget/I;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/I;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/H;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/I;->R(Landroidx/appcompat/widget/H;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/G;->I(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/G;->H(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/G;->A(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/G;->D(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/G;->G(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/G;->F(I)V

    return-object v0
.end method

.method private x(Landroidx/appcompat/view/menu/g;)I
    .locals 3
...
.method private y(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
    .locals 4
...
.method private z(Landroidx/appcompat/view/menu/d$d;Landroidx/appcompat/view/menu/g;)Landroid/view/View;
    .locals 7

    iget-object v0, p1, Landroidx/appcompat/view/menu/d$d;->b:Landroidx/appcompat/view/menu/g;

    invoke-direct {p0, v0, p2}, Landroidx/appcompat/view/menu/d;->y(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/view/menu/d;->x(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/I;->Q(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/G;->B(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;
...
.method public d(Landroidx/appcompat/view/menu/q;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->h(Landroidx/appcompat/view/menu/g;)V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;

    invoke-virtual {v3}, Landroidx/appcompat/widget/G;->isShowing()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;
...
.method public l(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/P;->A(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Landroidx/core/view/m;->b(II)I
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/I;

    invoke-virtual {v4}, Landroidx/appcompat/widget/G;->isShowing()Z
...
.method public p(I)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/m;->b(II)I
...
.method public updateMenuView(Z)V
    ...
    invoke-static {v0}, Landroidx/appcompat/view/menu/k;->v(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/f;
