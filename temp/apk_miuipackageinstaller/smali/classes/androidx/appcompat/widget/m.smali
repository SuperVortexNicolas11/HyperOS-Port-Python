...
.method private e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/appcompat/widget/m;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/m;->b:Landroid/graphics/Bitmap;
...
.method c(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/U;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/m;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/U;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Landroidx/appcompat/widget/m;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/m;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/m;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v1, v2}, Landroidx/appcompat/widget/m$a;->a(Landroid/graphics/drawable/LayerDrawable;Landroid/graphics/drawable/LayerDrawable;I)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/m;->a()Landroid/graphics/drawable/shapes/Shape;
