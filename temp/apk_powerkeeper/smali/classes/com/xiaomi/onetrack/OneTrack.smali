...
# instance fields
.field private c:Lcom/xiaomi/onetrack/api/j;
...
.method private constructor <init>(Landroid/content/Context;Lcom/xiaomi/onetrack/Configuration;)V
    ...
    .line 12
    invoke-direct {v0, p1, p2}, Lcom/xiaomi/onetrack/api/j;-><init>(Landroid/content/Context;Lcom/xiaomi/onetrack/Configuration;)V

    .line 14
    iput-object v0, p0, Lcom/xiaomi/onetrack/OneTrack;->c:Lcom/xiaomi/onetrack/api/j;
...
.method public adTrack(Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 1
    iget-object p0, p0, Lcom/xiaomi/onetrack/OneTrack;->c:Lcom/xiaomi/onetrack/api/j;

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/util/Map;Ljava/util/List;)V
...
.method public adTrack(Ljava/lang/String;Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/util/Map;Ljava/util/List;)V
...
.method public clearCommonProperty()V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/xiaomi/onetrack/api/j;->a()V
...
.method public getInstanceId()Ljava/lang/String;
    ...
    .line 2
    invoke-virtual {p0}, Lcom/xiaomi/onetrack/api/j;->b()Ljava/lang/String;
...
.method public getOAID(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method public login(Ljava/lang/String;Lcom/xiaomi/onetrack/OneTrack$UserIdType;Ljava/util/Map;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Lcom/xiaomi/onetrack/OneTrack$UserIdType;Ljava/util/Map;Z)V
...
.method public logout(Ljava/util/Map;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/util/Map;Z)V
...
.method public removeCommonProperty(Ljava/lang/String;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->b(Ljava/lang/String;)V
...
.method public setBasicModeEnable(Z)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->c(Z)V
...
.method public setCommonProperty(Ljava/util/Map;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->c(Ljava/util/Map;)V
...
.method public setCustomPrivacyPolicyAccepted(Z)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->b(Z)V
...
.method public setDynamicCommonProperty(Lcom/xiaomi/onetrack/OneTrack$ICommonPropertyProvider;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Lcom/xiaomi/onetrack/OneTrack$ICommonPropertyProvider;)V
...
.method public setEventHook(Lcom/xiaomi/onetrack/OneTrack$IEventHook;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Lcom/xiaomi/onetrack/OneTrack$IEventHook;)V
...
.method public setInstanceId(Ljava/lang/String;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->c(Ljava/lang/String;)V
...
.method public setUserProfile(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public setUserProfile(Ljava/util/Map;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/util/Map;)V
...
.method public track(Ljava/lang/String;Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/util/Map;)V
...
.method public track(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/util/Map;)V
...
.method public trackEventFromH5(Ljava/lang/String;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;)V
...
.method public trackPluginEvent(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
...
.method public trackServiceQualityEvent(Lcom/xiaomi/onetrack/ServiceQualityEvent;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->a(Lcom/xiaomi/onetrack/ServiceQualityEvent;)V
...
.method public userProfileIncrement(Ljava/lang/String;Ljava/lang/Number;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/api/j;->a(Ljava/lang/String;Ljava/lang/Number;)V
...
.method public userProfileIncrement(Ljava/util/Map;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/onetrack/api/j;->b(Ljava/util/Map;)V
