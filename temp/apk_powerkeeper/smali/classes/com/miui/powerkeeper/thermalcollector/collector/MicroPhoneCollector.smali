.class public Lcom/miui/powerkeeper/thermalcollector/collector/MicroPhoneCollector;
.super Lcom/miui/powerkeeper/thermalcollector/collector/BaseCollector;
.source "MicroPhoneCollector.java"
...
.method protected collect()V
    ...
    .line 5
    :try_start_0
    const-string v0, "micro_phone_state"
    ...
    .line 11
    invoke-virtual {v1}, Lcom/miui/powerkeeper/thermalcollector/collector/ScenarioCollectorUtils;->getMicroPhoneState()Ljava/lang/String;
