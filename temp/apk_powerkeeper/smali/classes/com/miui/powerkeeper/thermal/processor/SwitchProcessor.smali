.class public Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;
    }
.end annotation


# static fields
.field private static final NORMAL_SCENARIO:I = 0x0

.field private static final TAG:Ljava/lang/String; = "SwitchProcessor"
...
.field private final mPolicy:Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;
...
.method public constructor <init>()V
    ...
    .line 6
    iput v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentScenario:I

    .line 8
    new-instance v0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;

    .line 10
    const/4 v1, 0x0

    .line 12
    invoke-direct {v0, v1}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;-><init>(Lcom/miui/powerkeeper/thermal/processor/h;)V

    .line 13
    iput-object v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mPolicy:Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;
    ...
    .line 20
    iput-object v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;
    ...
    .line 28
    iput-object v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mDBObserver:Lcom/miui/powerkeeper/thermal/resource/DBObserver;
...
.method private getDefaultNeedOptimize()V
    ...
    .line 18
    iget-object p0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mPolicy:Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;

    .line 20
    const/4 v0, 0x0

    .line 22
    invoke-static {p0, v0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;->c(Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;Ljava/lang/Boolean;)V
...
.method private getEnableOptimize()V
    ...
    .line 22
    invoke-static {p0, v0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;->b(Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;Ljava/lang/Boolean;)V
...
.method private getVideoChatConfig()V
    ...
    .line 7
    invoke-static {p0, v0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;->d(Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;Z)V
...
.method protected calculateThermalId(I)V
    ...
    .line 5
    iget v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentThermalId:I

    .line 6
    if-eq v0, p1, :cond_0

    .line 8
    iput p1, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentThermalId:I
...
.method public execute(I)V
    ...
    .line 1
    iput p1, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentScenario:I

    .line 2
    invoke-virtual {p0, p1}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->calculateThermalId(I)V
...
.method public init(Ljava/util/Map;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;
    ...
    .line 12
    invoke-virtual {p0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->updateCloudData()V

    .line 15
    iget-object p1, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mDBObserver:Lcom/miui/powerkeeper/thermal/resource/DBObserver;
...
.method protected mapToThermalId(I)I
    ...
    .line 8
    iget-object v2, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;
    ...
    .line 53
    invoke-virtual {p0, p1}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;->getConfigMode(I)Z
    ...
    .line 136
    :cond_7
    iget-object p1, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;
    ...
    .line 157
    invoke-static {p0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;->a(Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor$Policy;)Z
    ...
    .line 170
    :cond_9
    iget-object p0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    .line 4
    const-string v1, "--- SwitchProcessor ---"
    ...
    .line 19
    iget v2, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentThermalId:I
    ...
    .line 35
    iget-object v1, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mGroups:Ljava/util/Map;

    .line 38
    new-instance v2, Lcom/miui/powerkeeper/thermal/processor/g;

    .line 40
    invoke-direct {v2, v0}, Lcom/miui/powerkeeper/thermal/processor/g;-><init>(Ljava/lang/StringBuilder;)V
...
.method public uninstall()V
    ...
    .line 1
    iget-object v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mDBObserver:Lcom/miui/powerkeeper/thermal/resource/DBObserver;
...
.method public updateCloudData()V
    ...
    .line 1
    invoke-direct {p0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->getVideoChatConfig()V

    .line 2
    invoke-direct {p0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->getDefaultNeedOptimize()V

    .line 5
    invoke-direct {p0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->getEnableOptimize()V

    .line 8
    iget v0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentScenario:I

    .line 11
    invoke-virtual {p0, v0}, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->calculateThermalId(I)V
...
.method protected writeThermalId(I)V
    ...
    .line 55
    iget p0, p0, Lcom/miui/powerkeeper/thermal/processor/SwitchProcessor;->mCurrentThermalId:I
    ...
    .line 66
    const-string p1, "SwitchProcessor"
